...
#include        "clisysdef.h"
		 ...
		 * created by cdu :  19-Jan-1998 13:14:45
		 ********************************************************/
...
static struct cduQualifier v01qualifiers[2] = {
        "IMAGE",0x0000,0,&ACTIVATE_IMAGE,&v01q01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v02params[2] = {
        "P1",0x0000,"PROCESS","Process",&v02p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v02qualifiers[2] = {
        "IDENTIFICATION",0x0000,0,&ATTACH_PID,&v02q01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  CREATE_LIBRARY_params[3] = {
        "P1",0x0000,0,0,&CREATE_LIBRARY_p01value,0
       ,"P2",0x0000,"LIBRARY","Library",&CREATE_LIBRARY_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  CREATE_KEYWORDS[2] = {	/* "Type" def	*/
        "LIBRARY",0x0000,0,&CREATE_LIBRARY,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v03params[2] = {
        "P1",0x0000,0,"What",&v03p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v04qualifiers[13] = {
        "TABLES",0x0000,0,0,&v04q01value,0
       ,"HELPLIB",0x0000,0,0,&v04q02value,0
       ,"AUXHELPLIB",0x0000,0,0,&v04q03value,0
       ,"PROMPT",0x0000,0,0,&v04q04value,0
       ,"DEF_FILE",0x0000,0,0,&v04q05value,0
       ,"KEY_DEFS",0x0000,0,0,&v04q06value,0
       ,"DEF_LIBRARIES",0x0000,0,0,&v04q07value,0
       ,"COMMAND",0x0000,0,0,&v04q08value,0
       ,"INI_DEF_FILE",0x0000,0,0,&v04q09value,0
       ,"LIBRARY",0x0000,0,0,&v04q10value,0
...
static struct cduParam  v06params[2] = {
        "P1",0x0000,0,"Macro",&v06p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DEFINE_KEY_params[3] = {
        "P1",0x0000,"KEY","Key name",&DEFINE_KEY_p01value,0
       ,"P2",0x0000,0,"equivalence-name",&DEFINE_KEY_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DEFINE_KEY_qualifiers[8] = {
        "ECHO",0x0001,0,0,0,0
       ,"ERASE",0x0000,0,0,0,0
       ,"IF_STATE",0x0000,0,0,&DEFINE_KEY_q03value,0
       ,"LOCK_STATE",0x0000,0,0,0,0
       ,"LOG",0x0001,0,0,0,0
       ,"SET_STATE",0x0000,0,0,&DEFINE_KEY_q06value,0
       ,"TERMINATE",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DEFINE_SYMBOL_params[3] = {
        "P1",0x0000,"SYMBOL","Symbol name",&DEFINE_SYMBOL_p01value,0
       ,"P2",0x0000,"VALUE","Value",&DEFINE_SYMBOL_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DEFINE_SYMBOL_REST_params[3] = {
        "P1",0x0000,"SYMBOL","Symbol name",&DEFINE_SYMBOL_REST_p01value,0
       ,"P2",0x0000,"VALUE","Value",&DEFINE_SYMBOL_REST_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DEFINE_SYMBOL_qualifiers[2] = {
        "REST_OF_LINE",0x0000,0,&DEFINE_SYMBOL_REST,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v06qualifiers[4] = {
        "KEY",0x0000,0,&DEFINE_KEY,0,0
       ,"SYMBOL",0x0000,0,&DEFINE_SYMBOL,0,0
       ,"EDIT",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DELETE_KEY_params[2] = {
        "P1",0x0000,"KEY","Key",&DELETE_KEY_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DELETE_KEY_ALL_qualifiers[4] = {
        "ALL",0x0001,0,0,0,0
       ,"LOG",0x0001,0,0,0,0
       ,"STATE",0x0000,0,0,&DELETE_KEY_ALL_q03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DELETE_KEY_qualifiers[4] = {
        "ALL",0x0000,0,&DELETE_KEY_ALL,0,0
       ,"LOG",0x0001,0,0,0,0
       ,"STATE",0x0000,0,0,&DELETE_KEY_q03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v08params[9] = {
        "P1",0x0000,"NAME","Macro",&v08p01value,0
       ,"P2",0x0000,"P1",0,&v08p02value,0
       ,"P3",0x0000,"P2",0,&v08p03value,0
       ,"P4",0x0000,"P3",0,&v08p04value,0
       ,"P5",0x0000,"P4",0,&v08p05value,0
       ,"P6",0x0000,"P5",0,&v08p06value,0
       ,"P7",0x0000,"P6",0,&v08p07value,0
       ,"P8",0x0000,"P7",0,&v08p08value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v08qualifiers[4] = {
        "MACRO",0x0001,0,0,0,0
       ,"INDIRECT",0x0000,0,0,0,0
       ,"REPEAT",0x0000,0,0,&v08q03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  INIT_TIMER_params[2] = {
        "P1",0x0000,0,"What",&INIT_TIMER_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v12params[2] = {
        "P1",0x0000,0,"What",&v12p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v13params[2] = {
        "P1",0x0000,0,"Macro",&v13p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v14params[2] = {
        "P1",0x0000,0,"Macro",&v14p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v14qualifiers[3] = {
        "NAME",0x0000,0,0,&v14q01value,0
       ,"LIBRARY",0x0000,0,0,&v14q02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_COMMAND_params[3] = {
        "P1",0x0000,0,0,&SET_COMMAND_p01value,0
       ,"P2",0x0000,"TABLE",0,&SET_COMMAND_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_COMMAND_qualifiers[4] = {
        "HELPLIB",0x0000,0,0,&SET_COMMAND_q01value,0
       ,"PROMPT",0x0000,0,0,&SET_COMMAND_q02value,0
       ,"DEF_FILE",0x0000,0,0,&SET_COMMAND_q03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_KEY_params[2] = {
        "P1",0x0000,0,0,&SET_KEY_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_KEY_qualifiers[5] = {
        "LOG",0x0001,0,0,0,0
       ,"STATE",0x0000,0,0,&SET_KEY_q02value,0
       ,"APPLICATION",0x0004,0,&SET_KEY_APPLICATION,0,0
       ,"NUMERIC",0x0004,0,&SET_KEY_NOAPPLICATION,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_INTERRUPT_params[2] = {
        "P1",0x0000,0,0,&SET_INTERRUPT_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_LIBRARY_params[3] = {
        "P1",0x0000,0,0,&SET_LIBRARY_p01value,0
       ,"P2",0x0000,"LIBRARY","Library",&SET_LIBRARY_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_LIBRARY_CLOSE_params[2] = {
        "P1",0x0000,0,0,&SET_LIBRARY_CLOSE_p01value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier SET_LIBRARY_CLOSE_qualifiers[2] = {
        "CLOSE",0x0001,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_LIBRARY_qualifiers[2] = {
        "CLOSE",0x0000,0,&SET_LIBRARY_CLOSE,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_PROMPT_params[3] = {
        "P1",0x0000,0,0,&SET_PROMPT_p01value,0
       ,"P2",0x0000,"PROMPT","Prompt",&SET_PROMPT_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_VERIFY_params[2] = {
        "P1",0x0000,0,0,&SET_VERIFY_p01value,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  MDSDCL_SET_KEYWORDS[7] = {	/* "Type" def	*/
        "COMMAND",0x0000,0,&SET_COMMAND,0,0
       ,"KEY",0x0000,0,&SET_KEY,0,0
       ,"INTERRUPT",0x0002,0,&SET_INTERRUPT,0,0
       ,"LIBRARY",0x0000,0,&SET_LIBRARY,0,0
       ,"PROMPT",0x0000,0,&SET_PROMPT,0,0
       ,"VERIFY",0x0002,0,&SET_VERIFY,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v15params[2] = {
        "P1",0x0000,0,"What",&v15p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_KEY_params[3] = {
        "P1",0x0000,0,0,&SHOW_KEY_p01value,0
       ,"P2",0x0000,"KEY","Key",&SHOW_KEY_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_KEY_ALL_params[2] = {
        "P1",0x0000,0,0,&SHOW_KEY_ALL_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SHOW_KEY_ALL_qualifiers[5] = {
        "ALL",0x0001,0,0,0,0
       ,"BRIEF",0x0000,0,0,0,0
       ,"FULL",0x0000,0,0,0,0
       ,"STATE",0x0000,0,0,&SHOW_KEY_ALL_q04value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_KEY_DIRECTORY_params[2] = {
        "P1",0x0000,0,0,&SHOW_KEY_DIRECTORY_p01value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier SHOW_KEY_DIRECTORY_qualifiers[3] = {
        "ALL",0x0000,0,0,0,0
       ,"DIRECTORY",0x0001,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SHOW_KEY_qualifiers[6] = {
        "ALL",0x0000,0,&SHOW_KEY_ALL,0,0
       ,"BRIEF",0x0000,0,0,0,0
       ,"DIRECTORY",0x0000,0,&SHOW_KEY_DIRECTORY,0,0
       ,"FULL",0x0000,0,0,0,0
       ,"STATE",0x0000,0,0,&SHOW_KEY_q05value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_LIBRARY_params[2] = {
        "P1",0x0000,0,0,&SHOW_LIBRARY_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_MACRO_params[3] = {
        "P1",0x0000,0,0,&SHOW_MACRO_p01value,0
       ,"P2",0x0000,"MACRO",0,&SHOW_MACRO_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_VM_params[2] = {
        "P1",0x0000,0,0,&SHOW_VM_p01value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier SHOW_VM_qualifiers[3] = {
        "FULL",0x0000,0,0,0,0
       ,"CHECK",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  SHOW_KEYWORDS[6] = {	/* "Type" def	*/
        "KEY",0x0000,0,&SHOW_KEY,0,0
       ,"LIBRARY",0x0000,0,&SHOW_LIBRARY,0,0
       ,"MACRO",0x0000,0,&SHOW_MACRO,0,0
       ,"TIMER",0x0000,0,&SHOW_TIMER,0,0
       ,"VM",0x0000,0,&SHOW_VM,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v16params[2] = {
        "P1",0x0000,0,"What",&v16p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v17params[2] = {
        "P1",0x0000,"COMMAND",0,&v17p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v17qualifiers[12] = {
        "CARRIAGE_CONTROL",0x0001,0,0,0,0
       ,"CLI",0x0000,0,0,&v17q02value,0
       ,"INPUT",0x0000,0,0,&v17q03value,0
       ,"KEYPAD",0x0001,0,0,0,0
       ,"LOGICAL_NAMES",0x0001,0,0,0,0
       ,"NOTIFY",0x0000,0,0,0,0
       ,"OUTPUT",0x0000,0,0,&v17q07value,0
       ,"PROCESS",0x0000,0,0,&v17q08value,0
       ,"PROMPT",0x0000,0,0,&v17q09value,0
       ,"SYMBOLS",0x0001,0,0,0,0
       ,"WAIT",0x0001,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v19params[2] = {
        "P1",0x0000,"DELTA_TIME","Deltatime",&v19p01value,0
       ,0				/* null entry at end	*/
       };
