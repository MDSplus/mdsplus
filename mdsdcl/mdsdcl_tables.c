...
static struct cduParam  DO_INDIRECT_params[2] = {
        "P1",0x1000,"NAME","Filename",&DO_INDIRECT_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v08qualifiers[4] = {
       ...
       ,"INDIRECT",0x2000,0,&DO_INDIRECT,0,0
...
static struct cduParam  v13params[2] = {
        "P1",0x1000,0,"What",&v13p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v15params[2] = {
        "P1",0x1000,0,"Macro",&v15p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v15qualifiers[3] = {
        "NAME",0x2000,0,0,&v15q01value,0
       ,"LIBRARY",0x2000,0,0,&v15q02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_HYPHEN_params[2] = {
        "P1",0x1000,0,0,&SET_HYPHEN_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  SET_KEYWORDS[8] = {	/* "Type" def	*/
       ...
       ,"HYPHEN",0x4002,0,&SET_HYPHEN,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v18params[2] = {
        "P1",0x1000,"COMMAND",0,&v18p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v18qualifiers[12] = {
       ...
       ,"CLI",0x2000,0,0,&v18q02value,0
       ,"INPUT",0x2000,0,0,&v18q03value,0
       ,"KEYPAD",0x2001,0,0,0,0
       ,"LOGICAL_NAMES",0x2001,0,0,0,0
       ,"NOTIFY",0x2000,0,0,0,0
       ,"OUTPUT",0x2000,0,0,&v18q07value,0
       ,"PROCESS",0x2000,0,0,&v18q08value,0
       ,"PROMPT",0x2000,0,0,&v18q09value,0
...
static struct cduParam  v20params[2] = {
        "P1",0x1000,"DELTA_TIME","Deltatime",&v20p01value,0
       ,0				/* null entry at end	*/
       };
...
struct cduVerb  mdsdcl_tables[21] = {
       ...
       ,"QUIT",0x0000,0,0,mdsdcl_exit,0,0
       ,"FINISH",0x0000,0,0,MDSDCL_FINISH,0,0
       ,"HELP",0x0000,0,0,MDSDCL_HELP,v12params,0
       ,"INIT",0x0000,0,0,0,v13params,0
       ,"MODIFY",0x0000,0,0,MDSDCL_MODIFY,v14params,0
       ,"SAVE",0x0000,0,0,MDSDCL_SAVE_MACRO,v15params,v15qualifiers
       ,"SET",0x0000,0,0,0,v16params,0
       ,"SHOW",0x0000,0,0,0,v17params,0
       ,"SPAWN",0x0000,0,0,mdsdcl_spawn,v18params,v18qualifiers
       ,"TYPE",0x0000,0,0,mdsdcl_type,v19params,0
       ,"WAIT",0x0000,0,0,mdsdcl_wait,v20params,0
       ,0				/* null entry at end	*/
       };
