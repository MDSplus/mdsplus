...
#line 66 "cmdParse.y"		/* yacc.c:1646  */
	...
	(yyval.cmd)->qualifiers =
	    realloc((yyval.cmd)->qualifiers,
		    sizeof(dclQualifierPtr) * ((yyval.cmd)->qualifier_count + 1));
...
#line 75 "cmdParse.y"		/* yacc.c:1646  */
	...
	(yyval.cmd)->parameters =
	    realloc((yyval.cmd)->parameters,
		    sizeof(dclParameterPtr) * ((yyval.cmd)->parameter_count + 1));
...
int mdsdcl_do_command_extra_args(char const *command, char **prompt, char **error, char **output,
