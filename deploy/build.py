...
def do_package():
    ...
    if args.platform == 'alpine':
        ...
        # TODO: Retrieve a list of debs generated by debian_build_debs.py
        deb_files = glob.glob(os.path.join(dist_dir, f'**/*_{args.version}*.deb'), recursive=True)
        ...
        # TODO: Retrieve a list of rpms generated by redhat_build_rpms.py
        rpm_files = glob.glob(os.path.join(dist_dir, f'**/*-{redhat_package_version}*.rpm'), recursive=True)
        ...
        # TODO: Retrieve the exe name from create_installer.sh
        exe_list = glob.glob(os.path.join(dist_dir, f'**/*-{exe_version}*.exe'), recursive=True)
