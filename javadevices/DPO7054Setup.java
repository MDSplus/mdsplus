...
public class DPO7054Setup extends DeviceSetup {
    ...
    private void initComponents() {
        ...
        deviceChoice4.setChoiceFloatValues(new float[] {(float)5.0E8,(float)2.5E8,(float)2.0E8,(float)1.25E8,(float)1.0E8,(float)6.25E7,(float)5.0E7,(float)2.5E7,(float)2.0E7,(float)1.25E7,(float)1.0E7,(float)6250000.0,(float)5000000.0,(float)2500000.0,(float)2000000.0,(float)1000000.0});
        deviceChoice4.setChoiceItems(new String[] {"500E6", "250E6", "200E6", "125E6", "100E6", "62.5E6", "50E6", "25E6", "20E6", "12.5E6", "10E6", "6.25E6", "5E6", "2.5E6", "2E6", "1E6"});
        ...
        deviceChoice1.setChoiceItems(new String[] {"AUX", "CH1", "CH2", "CH3", "CH4"});
        ...
        deviceChoice2.setChoiceItems(new String[] {"AC", "DC", "HF RJ", "LF RJ", "NOISE RJ"});
        ...
        deviceChoice3.setChoiceItems(new String[] {"RISE", "FALL", "EITHER"});
        ...
        deviceChoice6.setChoiceItems(new String[] {"AC", "DC", "GND"});
        ...
        deviceChoice7.setChoiceFloatValues(new float[] {(float)1000000.0,(float)50.0});
        deviceChoice7.setChoiceItems(new String[] {"1E6", "50"});
        ...
        deviceChoice34.setChoiceItems(new String[] {"FULL", "20MHz", "250MHz", "500MHz"});
        ...
        deviceChoice12.setChoiceItems(new String[] {"AC", "DC", "GND"});
        ...
        deviceChoice13.setChoiceFloatValues(new float[] {(float)1000000.0,(float)50.0});
        deviceChoice13.setChoiceItems(new String[] {"1E6", "50"});
        ...
        deviceChoice35.setChoiceItems(new String[] {"FULL", "20MHz", "250MHz", "500MHz"});
        ...
        deviceChoice15.setChoiceItems(new String[] {"AC", "DC", "GND"});
        ...
        deviceChoice16.setChoiceFloatValues(new float[] {(float)1000000.0,(float)50.0});
        deviceChoice16.setChoiceItems(new String[] {"1E6", "50"});
        ...
        deviceChoice36.setChoiceItems(new String[] {"FULL", "20MHz", "250MHz", "500MHz"});
        ...
        deviceChoice18.setChoiceItems(new String[] {"AC", "DC", "GND"});
        ...
        deviceChoice19.setChoiceFloatValues(new float[] {(float)1000000.0,(float)50.0});
        deviceChoice19.setChoiceItems(new String[] {"1E6", "50"});
        ...
        deviceChoice37.setChoiceItems(new String[] {"FULL", "20MHz", "250MHz", "500MHz"});
        ...
        deviceChoice48.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice48.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice52.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice52.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice56.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice56.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice60.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice60.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice21.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice21.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice24.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice24.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice27.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice27.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceChoice30.setChoiceFloatValues(new float[] {(float)10.0,(float)5.0,(float)2.0,(float)1.0,(float)0.5,(float)0.2,(float)0.1,(float)0.05,(float)0.01,(float)0.0050,(float)0.0010});
        deviceChoice30.setChoiceItems(new String[] {"10", "5", "2", "1", ".5", ".2", ".1", ".05", ".01", ".005", ".001"});
        ...
        deviceButtons2.setMethods(new String[] {"INIT", "ARM", "STORE", "FORCE_TRIGGER", "RESET"});
