...
static struct cduParam  v09params[2] = {
        "P1",0x1000,"MODULE",0,&v09p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v09qualifiers[11] = {
        "ADDRESS",0x2005,0,0,&v09q01value,0
       ,"FUNCTION",0x2005,0,0,&v09q02value,0
       ,"COUNT",0x2004,0,0,&v09q03value,0
       ,"DATA",0x2004,0,0,&v09q04value,0
       ,"HEX",0x2004,0,0,0,0
       ,"BINARY",0x2004,0,0,0,0
       ,"OCTAL",0x2004,0,0,0,0
       ,"DECIMAL",0x2005,0,0,0,0
       ,"MEMORY",0x2004,0,0,&v09q09value,0
...
static struct cduQualifier v10qualifiers[11] = {
        "ADDRESS",0x2005,0,0,&v10q01value,0
       ,"FUNCTION",0x2005,0,0,&v10q02value,0
       ,"COUNT",0x2004,0,0,&v10q03value,0
       ,"DATA",0x2004,0,0,&v10q04value,0
       ,"HEX",0x2004,0,0,0,0
       ,"BINARY",0x2004,0,0,0,0
       ,"OCTAL",0x2004,0,0,0,0
       ,"DECIMAL",0x2005,0,0,0,0
       ,"MEMORY",0x2004,0,0,&v10q09value,0
...
static struct cduParam  v13params[2] = {
        "P1",0x1000,"MODULE",0,&v13p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v13qualifiers[11] = {
        "STEP",0x2004,0,0,&v13q01value,0
       ,"ADDRESS",0x2005,0,0,&v13q02value,0
       ,"FUNCTION",0x2005,0,0,&v13q03value,0
       ,"COUNT",0x2004,0,0,&v13q04value,0
       ,"DATA",0x2004,0,0,&v13q05value,0
       ,"HEX",0x2004,0,0,0,0
       ,"BINARY",0x2004,0,0,0,0
       ,"OCTAL",0x2004,0,0,0,0
       ,"DECIMAL",0x2005,0,0,0,0
       ,"MEMORY",0x2005,0,0,&v13q10value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v14params[2] = {
        "P1",0x1000,"MODULE",0,&v14p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v14qualifiers[11] = {
        "STEP",0x2004,0,0,&v14q01value,0
       ,"ADDRESS",0x2005,0,0,&v14q02value,0
       ,"FUNCTION",0x2005,0,0,&v14q03value,0
       ,"COUNT",0x2004,0,0,&v14q04value,0
       ,"DATA",0x2004,0,0,&v14q05value,0
       ,"HEX",0x2004,0,0,0,0
       ,"BINARY",0x2004,0,0,0,0
       ,"OCTAL",0x2004,0,0,0,0
       ,"DECIMAL",0x2005,0,0,0,0
       ,"MEMORY",0x2005,0,0,&v14q10value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v16qualifiers[5] = {
        "STEP",0x2005,0,0,&v16q01value,0
       ,"COUNT",0x2005,0,0,&v16q02value,0
       ,"MEMORY",0x2004,0,0,&v16q03value,0
       ,"DATA",0x2000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v17qualifiers[9] = {
        "STEP",0x2004,0,0,&v17q01value,0
       ,"COUNT",0x2005,0,0,&v17q02value,0
       ,"MEMORY",0x2004,0,0,&v17q03value,0
       ,"DATA",0x2004,0,0,&v17q04value,0
       ,"HEX",0x2004,0,0,0,0
       ,"BINARY",0x2004,0,0,0,0
       ,"OCTAL",0x2004,0,0,0,0
       ,"DECIMAL",0x2005,0,0,0,0
...
static struct cduParam  v18params[2] = {
        "P1",0x1000,"MODULE",0,&v18p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v18qualifiers[2] = {
        "TIMEOUT",0x2005,0,0,&v18q01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  SET_KEYWORDS[6] = {	/* "Type" def	*/
       ...
       ,"NOVERBOSE",0x4000,0,&SET_NOVERBOSE,0,0
       ,"VERBOSE",0x4000,0,&SET_VERBOSE,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v19params[2] = {
        "P1",0x1000,0,"What",&v19p01value,0
       ,0				/* null entry at end	*/
       };
...
struct cduVerb  ccl_commands[22] = {
       ...
       ,"FQREP",0x0000,0,0,ccl_fqrep,v05params,v05qualifiers
       ,"QSCAN",0x0000,0,0,ccl_qscan,v06params,v06qualifiers
       ,"QSTOP",0x0000,0,0,ccl_qstop,v07params,v07qualifiers
       ,"FQSTOP",0x0000,0,0,ccl_fqstop,v08params,v08qualifiers
       ,"STOP",0x0000,0,0,ccl_stop,v09params,v09qualifiers
       ,"FSTOP",0x0000,0,0,ccl_fstop,v10params,v10qualifiers
       ,"DCLST",0x0000,0,0,ccl_dclst,0,0
       ,"LPIO",0x0000,0,0,ccl_lpio,v12params,v12qualifiers
       ,"LQSCAN",0x0000,0,0,ccl_lqscan,v13params,v13qualifiers
       ,"LSTOP",0x0000,0,0,ccl_lstop,v14params,v14qualifiers
       ,"EXECUTE",0x0000,0,0,ccl_execute,0,0
       ,"RDATA",0x0000,0,0,ccl_rdata,0,v16qualifiers
       ,"WDATA",0x0000,0,0,ccl_wdata,0,v17qualifiers
       ,"LAMWAIT",0x0000,0,0,ccl_lamwait,v18params,v18qualifiers
       ,"SET",0x0000,0,0,0,v19params,0
       ,"SHOW",0x0000,0,0,0,v20params,0
       ,"PLOT",0x0000,0,0,ccl_plot_data,0,v21qualifiers
       ,0				/* null entry at end	*/
       };
