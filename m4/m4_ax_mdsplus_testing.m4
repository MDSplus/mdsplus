 ...
 [
   ...
   AS_VAR_IF([HAVE_WINE],[yes],
     [
      ...
      AS_VAR_APPEND([TESTS_ENVIRONMENT],["MDS_PYDEVICE_PATH='TS_U2WPATH([$(pwd)/pydevices])' "])
      ...
      AS_VAR_IF([WINEARCH],[win64],
		[# WINEARCH win64
		 ...
		 AS_VAR_APPEND([TESTS_ENVIRONMENT],
		   ["PYTHONPATH='%PYTHONHOME%\\Lib;%PYTHONHOME%\\Lib\\site-packages;TS_U2WPATH([$(pwd)/pythonpath])' "])
