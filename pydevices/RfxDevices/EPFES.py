...
class EPFES(Device):
     ...
     parts = [
          {'path': ':COMMENT', 'type': 'text', 'value': 'Electrostatic probes front end slave'},
     ...
     for i in range(8):
          ...
          parts.append({'path': '.CH_%02d:SOURCE'%(i + 1), 'type': 'text', 'value': 'INT'})
          parts.append({'path': '.CH_%02d:IRANGE'%(i + 1), 'type': 'text', 'value': 'LOW'})
     del i



     parts.append({'path': ':INIT_ACTION', 'type': 'action', 'valueExpr': "Action(Dispatch('ELBP_PROBE_SERVER', 'INIT', 50, None), Method(None, 'init', head))", 'options': ('no_write_shot',)})
     parts.append({'path': ':STORE_ACTION', 'type': 'action', 'valueExpr': "Action(Dispatch('ELBP_PROBE_SERVER', 'POST_PULSE_CHECK', 50, None), Method(None, 'store', head))", 'options': ('no_write_shot',)})
          ...
          class Job(threading.Thread):
               ...
               def doAllOn(self):
                    ...
                    try:
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid IP')   
                    ...
                    try:
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid PORT')   
               ...
               def doProgram(self):
                    ...
                    try:
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid IP %s'%(str(ex)))   
                    ...
                    try:                
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid PORT %s'%(str(ex)))   
                    ...
                    try:                
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid T_ON')   
                    ...
                    try:                
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid T_OFF')   
                    ...
                    try:                
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid N_CYCL')   
                    ...
                    try:
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Invalid WD_TMT')   
                    ...
                    for i in range(8):
                         ...
                         ch.append(self.device.getNode('CH_%02d:IRANGE'%(i + 1)).data())

                         ch.append(self.device.getNode('CH_%02d:SOURCE'%(i + 1)).data())
                    ...
                    if ('???' != rData) and (str(rData) == str(float(self.device.getNode('WD_TMT').data()))):
                         ...
                         Data.execute('DevLogErr($1, $2)', self.device.getNid(), 'Command failed ' + cmd)
