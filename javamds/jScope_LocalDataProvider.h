 ...
 */
JNIEXPORT jstring JNICALL Java_jScope_LocalDataProvider_GetString
 ...
 */
JNIEXPORT jintArray JNICALL Java_jScope_LocalDataProvider_GetIntArray
  (JNIEnv *, jobject, jstring);
 ...
 */
JNIEXPORT jstring JNICALL Java_jScope_LocalDataProvider_ErrorString
  (JNIEnv *, jobject);
