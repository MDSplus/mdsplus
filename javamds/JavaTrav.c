...
JNIEXPORT void JNICALL Java_Database_write(JNIEnv * env, jobject obj, jint context) {
  int status;
  jfieldID name_fid, shot_fid;
  jclass cls = (*env)->GetObjectClass(env, obj);
  const char *name;
...
JNIEXPORT jstring JNICALL Java_Database_getOriginalPartName(JNIEnv * env, jobject obj, jobject jnid) {
...
JNIEXPORT void JNICALL Java_Database_executeDelete(JNIEnv * env, jobject obj, jint context) {
...
JNIEXPORT jboolean JNICALL Java_Database_isOn(JNIEnv * env, jobject obj, jobject jnid, jint context) {
  int nid, status;
  jfieldID nid_fid;
  jclass cls = (*env)->GetObjectClass(env, jnid);
...
JNIEXPORT jobject JNICALL Java_Database_getDefault(JNIEnv * env, jobject obj, jint context) {
  jclass cls;
  jmethodID constr;
  jvalue args[1];
  int status, nid;
...
JNIEXPORT jint JNICALL Java_Database_doAction(JNIEnv * env, jobject obj, jobject jnid, jint context) {
  int nid, status;
  jfieldID nid_fid;
  jclass cls = (*env)->GetObjectClass(env, jnid);
...
JNIEXPORT jlong JNICALL Java_Database_saveContext(JNIEnv * env, jobject obj) {
...
JNIEXPORT jint JNICALL Java_Database_getCurrentShot(JNIEnv * env, jobject obj, jstring jname) {
  const char *name = (*env)->GetStringUTFChars(env, jname, 0);
...
JNIEXPORT void JNICALL Java_Database_setEvent(JNIEnv * env, jobject obj, jstring jname) {
  const char *name = (*env)->GetStringUTFChars(env, jname, 0);
  MDSEvent((char *)name, 0, 0);
  (*env)->ReleaseStringUTFChars(env, jname, name);
}

JNIEXPORT jstring JNICALL Java_Database_getMdsMessage(JNIEnv * env, jobject obj, jint status) {
