...
*/
int Tdi1DateTime(int opcode, int narg, struct descriptor *list[],
...
*/
int Tdi1Fclose(int opcode, int narg, struct descriptor *list[],
               struct descriptor_xd *out_ptr)
{
    int status = 1;
    FILE *unit;
...
*/
int Tdi1Fseek(int opcode, int narg, struct descriptor *list[],
              struct descriptor_xd *out_ptr)
{
    int status = 1;
    FILE *unit;
...
/*----------------------------------------------
        ...
        offset = FTELL(unit)
*/
int Tdi1Ftell(int opcode, int narg, struct descriptor *list[],
              struct descriptor_xd *out_ptr)
{
    int status = 1;
    FILE *unit;
...
*/
int Tdi1Fopen(int opcode, int narg, struct descriptor *list[],
              struct descriptor_xd *out_ptr)
{
    int status = 1;
    FILE *unit;
...
*/
int Tdi1Spawn(int opcode, int narg, struct descriptor *list[],
              struct descriptor_xd *out_ptr)
{
    int status = 1;
    int stat1;
...
*/
int Tdi1Wait(int opcode, int narg, struct descriptor *list[],
             struct descriptor_xd *out_ptr)
{
    int status = 1;
    float time;
...
*/
int Tdi1Write(int opcode, int narg, struct descriptor *list[],
              struct descriptor_xd *out_ptr)
{
    int status = 1;
...
*/
int Tdi1Read(int opcode, int narg, struct descriptor *list[],
             struct descriptor_xd *out_ptr)
{
    int status = 1;
    int bytes = 0;
