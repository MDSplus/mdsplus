...
CVT_STATUS CvtConvertFloat(void *input_value,
                           U_Int_32 input_type,
                           void *output_value, U_Int_32 output_type)
...
*/
{
     ...
     */
        ...
        round_bit_position =
            intermediate_value[U_R_EXP] - ((U_R_BIAS - 126) - 23);
        ...
        if (intermediate_value[U_R_EXP] < (U_R_BIAS - 125)) {
             ...
             */
                ...
                i = 32 - (intermediate_value[U_R_EXP] -
                          ((U_R_BIAS - 126) - 23));
                ...
                if (options & CVT_M_BIG_ENDIAN) {
                    ...
                    intermediate_value[0] |=
                        ((intermediate_value[1] << 8) & 0x00FF0000L);
                    intermediate_value[0] |=
                        ((intermediate_value[1] >> 8) & 0x0000FF00L);
...
*/
{
     ...
     */
        ...
        round_bit_position =
            intermediate_value[U_R_EXP] - ((U_R_BIAS - 1022) - 52);
        if (round_bit_position < 0)
            round_bit_position = 0;
        ...
        if (intermediate_value[U_R_EXP] < (U_R_BIAS - 1021)) {
             ...
             */
                ...
                i = 64 - (intermediate_value[U_R_EXP] -
                          ((U_R_BIAS - 1022) - 52));
                if (i > 31) {
                    i -= 32;
                ...
                if (options & CVT_M_BIG_ENDIAN) {
                    ...
                    intermediate_value[1] =
                        ((intermediate_value[2] << 24) |
                         (intermediate_value[2] >> 24));
                    intermediate_value[1] |=
                        ((intermediate_value[2] << 8) & 0x00FF0000L);
                    intermediate_value[1] |=
                        ((intermediate_value[2] >> 8) & 0x0000FF00L);
                } else {
     ...
     */
        ...
        if (intermediate_value[U_R_EXP] < (U_R_BIAS - 16381)) {
             ...
             */
                ...
                i = 128 - (intermediate_value[U_R_EXP] -
                           ((U_R_BIAS - 16382) - 112));
                if (i > 95) {
                    i -= 96;
                ...
                if (options & CVT_M_BIG_ENDIAN) {
                    ...
                    intermediate_value[2] |=
                        ((intermediate_value[3] << 8) & 0x00FF0000L);
                    intermediate_value[2] |=
                        ((intermediate_value[3] >> 8) & 0x0000FF00L);

                    intermediate_value[3] = ((intermediate_value[4] << 24) |
                                             (intermediate_value[4] >> 24));
                    intermediate_value[3] |=
                        ((intermediate_value[4] << 8) & 0x00FF0000L);
                    intermediate_value[3] |=
                        ((intermediate_value[4] >> 8) & 0x0000FF00L);
                } else {
         ...
         */
            ...
            default:
                 ...
                 */
                    ...
                    if (!(intermediate_value[U_R_FLAGS] & U_R_NEGATIVE))
                        roundup =
                            (intermediate_value[i] & bit_mask) | more_bits;
                }
...
*/
{
     ...
     */
        ...
        if (output_value[1] | output_value[2] | output_value[3] |
            output_value[4])
            output_value[U_R_FLAGS] |= U_R_INVALID;
        else
            output_value[U_R_FLAGS] |= U_R_INFINITY;
