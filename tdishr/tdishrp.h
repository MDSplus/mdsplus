...
int CvtConvertFloat(void const *input_value, const int input_type, void *output_value, const int output_type);
...
int TdiBinary(struct descriptor *in1_ptr, struct descriptor *in2_ptr, struct descriptor *out_ptr, unsigned int *out_count);
...
int TdiMasterData(int nsig, struct descriptor_xd sig[1], struct descriptor_xd uni[1], int *cmode_ptr,
