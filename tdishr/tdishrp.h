...
int CvtConvertFloat(void const *input_value, const int input_type,
                    void *output_value, const int output_type);
int TdiAddOctaword(unsigned const int *a, unsigned const int *b,
                   unsigned int *ans);
...
int TdiGetShape(int narg, struct descriptor_xd dat[1], unsigned short length,
                unsigned char dtype, int *cmode_ptr,
