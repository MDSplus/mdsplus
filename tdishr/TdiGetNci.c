...
{"USAGE_ACTION",	0xffff,		TreeUSAGE_ACTION,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_ANY",		0xffff,		TreeUSAGE_ANY,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_AXIS",		0xffff,		TreeUSAGE_AXIS,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_COMPOUND_DATA",	0xffff,		TreeUSAGE_COMPOUND_DATA,	NciUSAGE,		DTYPE_BU,	1},
{"USAGE_DEVICE",	0xffff,		TreeUSAGE_DEVICE,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_DISPATCH",	0xffff,		TreeUSAGE_DISPATCH,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_NONE",		0xffff,		TreeUSAGE_NONE,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_NUMERIC",	0xffff,		TreeUSAGE_NUMERIC,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_SIGNAL",	0xffff,		TreeUSAGE_SIGNAL,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_STRUCTURE",	0xffff,		TreeUSAGE_STRUCTURE,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_SUBTREE",	0xffff,		TreeUSAGE_SUBTREE,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_TASK",		0xffff,		TreeUSAGE_TASK,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_TEXT",		0xffff,		TreeUSAGE_TEXT,		NciUSAGE,		DTYPE_BU,	1},
{"USAGE_WINDOW",	0xffff,		TreeUSAGE_WINDOW,		NciUSAGE,		DTYPE_BU,	1},
