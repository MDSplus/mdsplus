...
OPC (	MaxLoc,	MAXLOC ,		Trans,	Mask1,		MaxLoc,	T,HC,SUBSCRIPT,SUBSCRIPT,1,3,	OK	)/*;f9	(x,[dim],[mask])		*/
...
OPC (	MinLoc,	MINLOC ,		Trans,	Mask1,		MinLoc,	T,HC,SUBSCRIPT,SUBSCRIPT,1,3,	OK	)/*;f9	(x,[dim], [mask])		*/
...
OPC (	Transpose,	TRANSPOSE ,	Matrix, undef,		Transpose,	XX,YY,	XX,YY,	1,1,	OK	)/*;f9	(matrix) 2D		*/
