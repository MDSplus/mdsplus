...
****************************************/
  ...
  if (ncis)
    memcpy(edit_ptr->nci + header_ptr->nodes - edit_ptr->first_in_mem, empty_nci_array,
	   empty_nci_size);
/******************************************
