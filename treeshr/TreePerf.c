...
#else
int TreeGetPerf() { return TreeFAILURE;}
int TreePerfRead(int bytes) { return TreeFAILURE;}
int TreePerfWrite(int bytes) { return TreeFAILURE;}
int TreePerfZero() { return TreeFAILURE;}
#endif
