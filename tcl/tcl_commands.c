...
static struct cduParam  STOP_SERVER_params[3] = {
       ...
       ,"P2",0x1000,"SERVNAM","Server",&STOP_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  ABORT_SERVER_params[3] = {
       ...
       ,"P2",0x1000,"SERVER_NAME","Server",&ABORT_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  ADD_NODE_params[3] = {
       ...
       ,"P2",0x1000,"NODENAME","Node",&ADD_NODE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  ADD_TAG_params[4] = {
       ...
       ,"P3",0x1000,"TAGNAME","Tag",&ADD_TAG_p03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DELETE_NODE_params[3] = {
       ...
       ,"P2",0x1000,"NODENAME","Node",&DELETE_NODE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  REMOVE_TAG_params[3] = {
       ...
       ,"P2",0x1000,"TAGNAME","Tag",&REMOVE_TAG_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_ATTRIBUTE_params[4] = {
        "P1",0x1000,0,"What",&SET_ATTRIBUTE_p01value,0
       ,"P2",0x1000,"NODE","Node",&SET_ATTRIBUTE_p02value,0
       ,"P3",0x1000,"VALUE","Value",&SET_ATTRIBUTE_p03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_ATTRIBUTE_EXTENDED_params[3] = {
        "P1",0x1000,0,"What",&SET_ATTRIBUTE_EXTENDED_p01value,0
       ,"P2",0x1000,"NODE","Node",&SET_ATTRIBUTE_EXTENDED_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_ATTRIBUTE_EXTENDED_qualifiers[6] = {
       ...
       ,"SYMBOLS",0x2000,0,0,0,0
       ,"LF",0x2001,0,0,0,0
       ,"EOF",0x2000,0,0,&SET_ATTRIBUTE_EXTENDED_q04value,0
       ,"NAME",0x2004,0,0,&SET_ATTRIBUTE_EXTENDED_q05value,0
       ,0				/* null entry at end	*/
       };

static struct cduVerb  SET_ATTRIBUTE_EXTENDED = {	/* Syntax def	*/
        "SET_ATTRIBUTE_EXTENDED",0x0000,0,0,TclSetAttribute,SET_ATTRIBUTE_EXTENDED_params,SET_ATTRIBUTE_EXTENDED_qualifiers
       };

static struct cduQualifier SET_ATTRIBUTE_qualifiers[3] = {
        "NAME",0x2004,0,0,&SET_ATTRIBUTE_q01value,0
       ,"EXTENDED",0x2000,0,&SET_ATTRIBUTE_EXTENDED,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_NODE_params[3] = {
       ...
       ,"P2",0x1000,"NODENAME","Node",&SET_NODE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_NODE_qualifiers[15] = {
       ...
       ,"CACHED",0x2000,0,0,0,0
       ,"COMPRESS_ON_PUT",0x2000,0,0,0,0
       ,"COMPRESS_SEGMENTS",0x2000,0,0,0,0
       ...
       ,"STATUS",0x2000,0,0,&SET_NODE_q14value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_VIEW_params[3] = {
        "P1",0x1000,0,"What",&SET_VIEW_p01value,0
       ,"P2",0x1000,"DATE","Date",&SET_VIEW_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  SET_TYPE[9] = {	/* "Type" def	*/
        "ATTRIBUTE",0x4000,0,&SET_ATTRIBUTE,0,0
       ...
       ,"VIEW",0x4000,0,&SET_VIEW,0,0
       ,"VERSIONS",0x4000,0,&SET_VERSIONS,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_ATTRIBUTE_params[3] = {
        "P1",0x1000,0,"What",&SHOW_ATTRIBUTE_p01value,0
       ,"P2",0x1000,"NODE","Node",&SHOW_ATTRIBUTE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SHOW_ATTRIBUTE_qualifiers[2] = {
        "NAME",0x2004,0,0,&SHOW_ATTRIBUTE_q01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_SERVER_params[3] = {
       ...
       ,"P2",0x1000,"SERVER_NAME","Server",&SHOW_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_VERSION_params[2] = {
        "P1",0x1000,0,"What",&SHOW_VERSION_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_VERSIONS_params[2] = {
        "P1",0x1000,0,"What",&SHOW_VERSIONS_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  SHOW_TYPE[9] = {	/* "Type" def	*/
        "ATTRIBUTE",0x4000,0,&SHOW_ATTRIBUTE,0,0
       ...
       ,"VERSION",0x4000,0,&SHOW_VERSION,0,0
       ,"VERSIONS",0x4000,0,&SHOW_VERSIONS,0,0
       ,0				/* null entry at end	*/
       };
