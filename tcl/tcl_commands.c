#include        "clisysdef.h"
		 ...
		 * created by cdu :  02-Jun-2014 15:59:14
		 ********************************************************/
...
static struct cduParam STOP_SERVER_params[3] = {
  "P1", 0x1000, 0, "What", &STOP_SERVER_p01value, 0, "P2", 0x1000, "SERVNAM", "Server", &STOP_SERVER_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword STOP_TYPE[2] = {	/* "Type" def   */
  "SERVER", 0x4000, 0, &STOP_SERVER, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam ABORT_SERVER_params[3] = {
  "P1", 0x1000, 0, "What", &ABORT_SERVER_p01value, 0, "P2", 0x1000, "SERVER_NAME", "Server", &ABORT_SERVER_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword ABORT_TYPE[2] = {	/* "Type" def   */
  "SERVER", 0x4000, 0, &ABORT_SERVER, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v01params[2] = {
  "P1", 0x1000, 0, "What", &v01p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam ADD_NODE_params[3] = {
  "P1", 0x1000, 0, "What", &ADD_NODE_p01value, 0, "P2", 0x1000, "NODENAME", "Node", &ADD_NODE_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword USAGE_TYPE[14] = {	/* "Type" def   */
  "ANY", 0x4000, 0, 0, &t04k01value, 0, "STRUCTURE", 0x4000, 0, 0, &t04k02value, 0, "ACTION", 0x4000, 0, 0, &t04k03value, 0, "DEVICE", 0x4000, 0, 0, &t04k04value, 0, "DISPATCH", 0x4000, 0, 0, &t04k05value, 0, "NUMERIC", 0x4000, 0, 0, &t04k06value, 0, "SIGNAL", 0x4000, 0, 0, &t04k07value, 0, "TASK", 0x4000, 0, 0, &t04k08value, 0, "TEXT", 0x4000, 0, 0, &t04k09value, 0, "WINDOW", 0x4000, 0, 0, &t04k10value, 0, "AXIS", 0x4000, 0, 0, &t04k11value, 0, "SUBTREE", 0x4000, 0, 0, &t04k12value, 0, "COMPOUND_DATA", 0x4000, 0, 0, &t04k13value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier ADD_NODE_qualifiers[4] = {
  "MODEL", 0x2000, 0, 0, &ADD_NODE_q01value, 0, "USAGE", 0x2001, 0, 0, &ADD_NODE_q02value, 0, "QUALIFIERS", 0x2000, 0, 0, &ADD_NODE_q03value, 0, 0	/* null entry at end    */
};
...
static struct cduParam ADD_TAG_params[4] = {
  "P1", 0x1000, 0, "What", &ADD_TAG_p01value, 0, "P2", 0x1000, "NODE", "Node", &ADD_TAG_p02value, 0, "P3", 0x1000, "TAGNAME", "Tag", &ADD_TAG_p03value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword ADD_TYPE[3] = {	/* "Type" def   */
  "NODE", 0x4000, 0, &ADD_NODE, 0, 0, "TAG", 0x4000, 0, &ADD_TAG, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v02params[2] = {
  "P1", 0x1000, 0, "What", &v02p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v03params[2] = {
  "P1", 0x1000, "FILE", "File", &v03p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v03qualifiers[3] = {
  "SHOTID", 0x2005, 0, 0, &v03q01value, 0, "OVERRIDE", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v04params[2] = {
  "P1", 0x1000, "FILE", 0, &v04p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v04qualifiers[4] = {
  "SHOTID", 0x2005, 0, 0, &v04q01value, 0, "CONFIRM", 0x2001, 0, 0, 0, 0, "ALL", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v05params[2] = {
  "P1", 0x1000, "FILE", "File", &v05p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v05qualifiers[3] = {
  "SHOTID", 0x2005, 0, 0, &v05q01value, 0, "OVERRIDE", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam CREATE_PULSE_params[3] = {
  "P1", 0x1000, 0, "What", &CREATE_PULSE_p01value, 0, "P2", 0x1000, "SHOT", "Shot number", &CREATE_PULSE_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier CREATE_PULSE_qualifiers[6] = {
  "INCLUDE", 0x2000, 0, 0, &CREATE_PULSE_q01value, 0, "EXCLUDE", 0x2000, 0, 0, &CREATE_PULSE_q02value, 0, "CONDITIONAL", 0x2000, 0, 0, 0, 0, "NOMAIN", 0x2004, 0, 0, 0, 0, "DISPATCH", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword CREATE_TYPE[2] = {	/* "Type" def   */
  "PULSE", 0x4000, 0, &CREATE_PULSE, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v06params[2] = {
  "P1", 0x1000, 0, "What", &v06p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v07params[2] = {
  "P1", 0x1000, "PATH", 0, &v07p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam DEFINE_SERVER_params[3] = {
  "P1", 0x1000, 0, "WHAT", &DEFINE_SERVER_p01value, 0, "P2", 0x1000, 0, 0, &DEFINE_SERVER_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier DEFINE_SERVER_qualifiers[2] = {
  "TREE", 0x2000, 0, 0, &DEFINE_SERVER_q01value, 0, 0	/* null entry at end    */
};

static struct cduVerb DEFINE_SERVER = {	/* Syntax def   */
  "DEFINE_SERVER", 0x0000, 0, 0, TclCreatePulse_server, DEFINE_SERVER_params,
      DEFINE_SERVER_qualifiers
};

static struct cduKeyword DEFINE_TYPE[2] = {	/* "Type" def   */
  "SERVER", 0x4000, 0, &DEFINE_SERVER, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v08params[2] = {
  "P1", 0x1000, 0, "WHAT", &v08p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam DELETE_NODE_params[3] = {
  "P1", 0x1000, 0, "What", &DELETE_NODE_p01value, 0, "P2", 0x1000, "NODENAME", "Node", &DELETE_NODE_p02value, 0, 0	/* null entry at end    */
};

static struct cduQualifier DELETE_NODE_qualifiers[3] = {
  "LOG", 0x2000, 0, 0, 0, 0, "CONFIRM", 0x2001, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam DELETE_PULSE_params[3] = {
  "P1", 0x1000, 0, "What", &DELETE_PULSE_p01value, 0, "P2", 0x1000, "SHOT", "Shot number", &DELETE_PULSE_p02value, 0, 0	/* null entry at end    */
};

static struct cduQualifier DELETE_PULSE_qualifiers[2] = {
  "ALL", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword DELETE_TYPE[3] = {	/* "Type" def   */
  "NODE", 0x4000, 0, &DELETE_NODE, 0, 0, "PULSE", 0x4000, 0, &DELETE_PULSE, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v09params[2] = {
  "P1", 0x1000, 0, "What", &v09p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v10params[2] = {
  "P1", 0x1000, "NODE", 0, &v10p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam DIR_TAG_SYNTAX_params[2] = {
  "P1", 0x1000, "TAG", 0, &DIR_TAG_SYNTAX_p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v10qualifiers[5] = {
  "FULL", 0x2000, 0, 0, 0, 0, "PATH", 0x2000, 0, 0, 0, 0, "USAGE", 0x2000, 0, 0, &v10q03value, 0, "TAG", 0x2000, 0, &DIR_TAG_SYNTAX, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v11params[2] = {
  "P1", 0x1000, "NODE", 0, &v11p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier DISPATCH_BUILD_qualifiers[2] = {
  "MONITOR", 0x2000, 0, 0, &DISPATCH_BUILD_q01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier DISPATCH_CHECK_qualifiers[2] = {
  "RESET", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam DISPATCH_PHASE_params[2] = {
  "P1", 0x1000, "PHASE_NAME", "Phase", &DISPATCH_PHASE_p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier DISPATCH_PHASE_qualifiers[6] = {
  "PHASE", 0x2000, 0, 0, 0, 0, "NOACTION", 0x2000, 0, 0, 0, 0, "SYNCH", 0x2005, 0, 0, &DISPATCH_PHASE_q03value, 0, "LOG", 0x2001, 0, 0, 0, 0, "MONITOR", 0x2000, 0, 0, &DISPATCH_PHASE_q05value, 0, 0	/* null entry at end    */
};

static struct cduVerb DISPATCH_PHASE = {	/* Syntax def   */
  "DISPATCH_PHASE", 0x0000, 0, 0, TclDispatch_phase, DISPATCH_PHASE_params,
      DISPATCH_PHASE_qualifiers
};
...
static struct cduQualifier DISPATCH_CLOSE_qualifiers[3] = {
  "CLOSE", 0x2000, 0, 0, 0, 0, "SERVER", 0x2000, 0, 0, &DISPATCH_CLOSE_q02value, 0, 0	/* null entry at end    */
};
...
static struct cduParam DISPATCH_COMMAND_params[2] = {
  "P1", 0x1000, 0, 0, &DISPATCH_COMMAND_p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier DISPATCH_COMMAND_qualifiers[5] = {
  "COMMAND", 0x2000, 0, 0, 0, 0, "SERVER", 0x2000, 0, 0, &DISPATCH_COMMAND_q02value, 0, "WAIT", 0x2000, 0, 0, 0, 0, "TABLE", 0x2005, 0, 0, &DISPATCH_COMMAND_q04value, 0, 0	/* null entry at end    */
};

static struct cduVerb DISPATCH_COMMAND = {	/* Syntax def   */
  "DISPATCH_COMMAND", 0x0000, 0, 0, TclDispatch_command, DISPATCH_COMMAND_params,
      DISPATCH_COMMAND_qualifiers
};

static struct cduQualifier v11qualifiers[7] = {
  "WAIT", 0x2001, 0, 0, 0, 0, "BUILD", 0x2000, 0, &DISPATCH_BUILD, 0, 0, "CHECK", 0x2000, 0, &DISPATCH_CHECK, 0, 0, "PHASE", 0x2000, 0, &DISPATCH_PHASE, 0, 0, "CLOSE", 0x2000, 0, &DISPATCH_CLOSE, 0, 0, "COMMAND", 0x2000, 0, &DISPATCH_COMMAND, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v12params[2] = {
  "P1", 0x1000, "NODE", "Node", &v12p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam DO_METHOD_params[3] = {
  "P1", 0x1000, "OBJECT", "Object", &DO_METHOD_p01value, 0, "P2", 0x1000, "METHOD", "Method", &DO_METHOD_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier DO_METHOD_qualifiers[4] = {
  "ARGUMENT", 0x2000, 0, 0, &DO_METHOD_q01value, 0, "IF", 0x2000, 0, 0, &DO_METHOD_q02value, 0, "OVERRIDE", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v12qualifiers[2] = {
  "METHOD", 0x2000, 0, &DO_METHOD, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v13params[2] = {
  "P1", 0x1000, "FILE", "File", &v13p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v13qualifiers[3] = {
  "SHOTID", 0x2005, 0, 0, &v13q01value, 0, "NEW", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v14params[3] = {
  "P1", 0x1000, "SOURCE", "Source experiment", &v14p01value, 0, "P2", 0x1000, "DESTINATION", "Destination experiment", &v14p02value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v16params[3] = {
  "P1", 0x1000, "NODE", "Node", &v16p01value, 0, "P2", 0x1000, "VALUE", "Value", &v16p02value, 0, 0	/* null entry at end    */
};
...
static struct cduParam PUT_EXTENDED_params[2] = {
  "P1", 0x1000, "NODE", "Node", &PUT_EXTENDED_p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier PUT_EXTENDED_qualifiers[5] = {
  "EXTENDED", 0x2001, 0, 0, 0, 0, "SYMBOLS", 0x2000, 0, 0, 0, 0, "LF", 0x2001, 0, 0, 0, 0, "EOF", 0x2000, 0, 0, &PUT_EXTENDED_q04value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v16qualifiers[2] = {
  "EXTENDED", 0x2000, 0, &PUT_EXTENDED, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v17params[2] = {
  "P1", 0x1000, 0, 0, &v17p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v17qualifiers[12] = {
  "TABLES", 0x2001, 0, 0, &v17q01value, 0, "HELPLIB", 0x2001, 0, 0, &v17q02value, 0, "AUXHELPLIB", 0x2001, 0, 0, &v17q03value, 0, "PROMPT", 0x2001, 0, 0, &v17q04value, 0, "DEF_FILE", 0x2001, 0, 0, &v17q05value, 0, "KEY_DEFS", 0x2001, 0, 0, &v17q06value, 0, "DEF_LIBRARIES", 0x2001, 0, 0, &v17q07value, 0, "COMMAND", 0x2001, 0, 0, &v17q08value, 0, "INI_DEF_FILE", 0x2001, 0, 0, &v17q09value, 0, "LIBRARY", 0x2000, 0, 0, &v17q10value, 0, "DEBUG", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam REMOVE_TAG_params[3] = {
  "P1", 0x1000, 0, "What", &REMOVE_TAG_p01value, 0, "P2", 0x1000, "TAGNAME", "Tag", &REMOVE_TAG_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword REMOVE_TYPE[2] = {	/* "Type" def   */
  "TAG", 0x4000, 0, &REMOVE_TAG, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v18params[2] = {
  "P1", 0x1000, 0, "What", &v18p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v19params[3] = {
  "P1", 0x1000, "SOURCE", 0, &v19p01value, 0, "P2", 0x1000, "DEST", 0, &v19p02value, 0, 0	/* null entry at end    */
};

static struct cduQualifier v19qualifiers[2] = {
  "LOG", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam RUNDOWN_TREE_params[3] = {
  "P1", 0x1000, 0, "What", &RUNDOWN_TREE_p01value, 0, "P2", 0x1000, "FILE", "File", &RUNDOWN_TREE_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier RUNDOWN_TREE_qualifiers[4] = {
  "SHOTID", 0x2005, 0, 0, &RUNDOWN_TREE_q01value, 0, "FORCE_EXIT", 0x2000, 0, 0, 0, 0, "SUBTREES", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword RUNDOWN_TYPE[2] = {	/* "Type" def   */
  "TREE", 0x4000, 0, &RUNDOWN_TREE, 0, 0, 0	/* null entry at end    */
};
...
extern int TclSetAttribute();
static struct cduKeyword SET_TYPE[9];	/* Prototype only       */

static struct cduValue SET_ATTRIBUTE_p01value = {
  0x2001, 0, SET_TYPE, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SET_ATTRIBUTE_p02value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SET_ATTRIBUTE_p03value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduParam SET_ATTRIBUTE_params[4] = {
  "P1", 0x1000, 0, "What", &SET_ATTRIBUTE_p01value, 0, "P2", 0x1000, "NODE", "Node", &SET_ATTRIBUTE_p02value, 0, "P3", 0x1000, "VALUE", "Value", &SET_ATTRIBUTE_p03value, 0, 0	/* null entry at end    */
};

static struct cduValue SET_ATTRIBUTE_q01value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SET_ATTRIBUTE_EXTENDED_p01value = {
  0x2001, 0, SET_TYPE, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SET_ATTRIBUTE_EXTENDED_p02value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduParam SET_ATTRIBUTE_EXTENDED_params[3] = {
  "P1", 0x1000, 0, "What", &SET_ATTRIBUTE_EXTENDED_p01value, 0, "P2", 0x1000, "NODE", "Node", &SET_ATTRIBUTE_EXTENDED_p02value, 0, 0	/* null entry at end    */
};

static struct cduValue SET_ATTRIBUTE_EXTENDED_q04value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SET_ATTRIBUTE_EXTENDED_q05value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduQualifier SET_ATTRIBUTE_EXTENDED_qualifiers[6] = {
  "EXTENDED", 0x2001, 0, 0, 0, 0, "SYMBOLS", 0x2000, 0, 0, 0, 0, "LF", 0x2001, 0, 0, 0, 0, "EOF", 0x2000, 0, 0, &SET_ATTRIBUTE_EXTENDED_q04value, 0, "NAME", 0x2004, 0, 0, &SET_ATTRIBUTE_EXTENDED_q05value, 0, 0	/* null entry at end    */
};

static struct cduVerb SET_ATTRIBUTE_EXTENDED = {	/* Syntax def   */
  "SET_ATTRIBUTE_EXTENDED", 0x0000, 0, 0, TclSetAttribute, SET_ATTRIBUTE_EXTENDED_params,
      SET_ATTRIBUTE_EXTENDED_qualifiers
};

static struct cduQualifier SET_ATTRIBUTE_qualifiers[3] = {
  "NAME", 0x2004, 0, 0, &SET_ATTRIBUTE_q01value, 0, "EXTENDED", 0x2000, 0, &SET_ATTRIBUTE_EXTENDED, 0, 0, 0	/* null entry at end    */
};

static struct cduVerb SET_ATTRIBUTE = {	/* Syntax def   */
  "SET_ATTRIBUTE", 0x0000, 0, 0, TclSetAttribute, SET_ATTRIBUTE_params, SET_ATTRIBUTE_qualifiers
};
...
static struct cduParam SET_CURRENT_params[4] = {
  "P1", 0x1000, 0, "What", &SET_CURRENT_p01value, 0, "P2", 0x1000, "EXPERIMENT", "Experiment", &SET_CURRENT_p02value, 0, "P3", 0x1000, "SHOT", 0, &SET_CURRENT_p03value, 0, 0	/* null entry at end    */
};

static struct cduQualifier SET_CURRENT_qualifiers[2] = {
  "INCREMENT", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam SET_DEFAULT_params[3] = {
  "P1", 0x1000, 0, "What", &SET_DEFAULT_p01value, 0, "P2", 0x1000, "NODE", "Node", &SET_DEFAULT_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduParam SET_NODE_params[3] = {
  "P1", 0x1000, 0, "What", &SET_NODE_p01value, 0, "P2", 0x1000, "NODENAME", "Node", &SET_NODE_p02value, 0, 0	/* null entry at end    */
};

static struct cduValue SET_NODE_q14value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduQualifier SET_NODE_qualifiers[15] = {
  "SUBTREE", 0x2000, 0, 0, 0, 0, "ON", 0x2000, 0, 0, 0, 0, "OFF", 0x2000, 0, 0, 0, 0, "WRITE_ONCE", 0x2000, 0, 0, 0, 0, "CACHED", 0x2000, 0, 0, 0, 0, "COMPRESS_ON_PUT", 0x2000, 0, 0, 0, 0, "COMPRESS_SEGMENTS", 0x2000, 0, 0, 0, 0, "DO_NOT_COMPRESS", 0x2000, 0, 0, 0, 0, "SHOT_WRITE", 0x2000, 0, 0, 0, 0, "MODEL_WRITE", 0x2000, 0, 0, 0, 0, "INCLUDED", 0x2000, 0, 0, 0, 0, "LOG", 0x2000, 0, 0, 0, 0, "ESSENTIAL", 0x2000, 0, 0, 0, 0, "STATUS", 0x2000, 0, 0, &SET_NODE_q14value, 0, 0	/* null entry at end    */
};
...
static struct cduParam SET_SERVER_params[3] = {
  "P1", 0x1000, 0, "What", &SET_SERVER_p01value, 0, "P2", 0x1000, "SERVER", "Server", &SET_SERVER_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword LOGGING_TYPE[4] = {	/* "Type" def   */
  "NONE", 0x4000, 0, 0, &t11k01value, 0, "ACTIONS", 0x4001, 0, 0, &t11k02value, 0, "STATISTICS", 0x4000, 0, 0, &t11k03value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier SET_SERVER_qualifiers[2] = {
  "LOG", 0x2004, 0, 0, &SET_SERVER_q01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam SET_TREE_params[3] = {
  "P1", 0x1000, 0, "What", &SET_TREE_p01value, 0, "P2", 0x1000, "FILE", "File", &SET_TREE_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier SET_TREE_qualifiers[3] = {
  "SHOTID", 0x2005, 0, 0, &SET_TREE_q01value, 0, "READONLY", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
extern int TclSetView();

static struct cduValue SET_VIEW_p01value = {
  0x2001, 0, SET_TYPE, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SET_VIEW_p02value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduParam SET_VIEW_params[3] = {
  "P1", 0x1000, 0, "What", &SET_VIEW_p01value, 0, "P2", 0x1000, "DATE", "Date", &SET_VIEW_p02value, 0, 0	/* null entry at end    */
};

static struct cduVerb SET_VIEW = {	/* Syntax def   */
  "SET_VIEW", 0x0000, 0, 0, TclSetView, SET_VIEW_params, 0
};

extern int TclSetVersions();

static struct cduQualifier SET_VERSIONS_qualifiers[3] = {
  "MODEL", 0x2000, 0, 0, 0, 0, "SHOT", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};

static struct cduVerb SET_VERSIONS = {	/* Syntax def   */
  "SET_VERSIONS", 0x0000, 0, 0, TclSetVersions, 0, SET_VERSIONS_qualifiers
};

static struct cduKeyword SET_TYPE[9] = {	/* "Type" def   */
  "ATTRIBUTE", 0x4000, 0, &SET_ATTRIBUTE, 0, 0, "CURRENT", 0x4000, 0, &SET_CURRENT, 0, 0, "DEFAULT", 0x4000, 0, &SET_DEFAULT, 0, 0, "NODE", 0x4000, 0, &SET_NODE, 0, 0, "SERVER", 0x4000, 0, &SET_SERVER, 0, 0, "TREE", 0x4000, 0, &SET_TREE, 0, 0, "VIEW", 0x4000, 0, &SET_VIEW, 0, 0, "VERSIONS", 0x4000, 0, &SET_VERSIONS, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v21params[2] = {
  "P1", 0x1000, 0, "What", &v21p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v22params[2] = {
  "P1", 0x1000, "EVENT", "Event", &v22p01value, 0, 0	/* null entry at end    */
};

extern int TclShowAttribute();

static struct cduValue SHOW_ATTRIBUTE_p01value = {
  0x2001, 0, SET_TYPE, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduValue SHOW_ATTRIBUTE_p02value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduParam SHOW_ATTRIBUTE_params[3] = {
  "P1", 0x1000, 0, "What", &SHOW_ATTRIBUTE_p01value, 0, "P2", 0x1000, "NODE", "Node", &SHOW_ATTRIBUTE_p02value, 0, 0	/* null entry at end    */
};

static struct cduValue SHOW_ATTRIBUTE_q01value = {
  0x2000, 0, 0, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduQualifier SHOW_ATTRIBUTE_qualifiers[2] = {
  "NAME", 0x2004, 0, 0, &SHOW_ATTRIBUTE_q01value, 0, 0	/* null entry at end    */
};

static struct cduVerb SHOW_ATTRIBUTE = {	/* Syntax def   */
  "SHOW_ATTRIBUTE", 0x0000, 0, 0, TclShowAttribute, SHOW_ATTRIBUTE_params, SHOW_ATTRIBUTE_qualifiers
};
...
static struct cduParam SHOW_CURRENT_params[3] = {
  "P1", 0x1000, 0, "What", &SHOW_CURRENT_p01value, 0, "P2", 0x1000, "EXPERIMENT", "Experiment", &SHOW_CURRENT_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword SHOW_TYPE[9];	/* Prototype only       */
...
static struct cduParam SHOW_DATA_params[3] = {
  "P1", 0x1000, 0, "What", &SHOW_DATA_p01value, 0, "P2", 0x1000, "NODE", "Node", &SHOW_DATA_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduParam SHOW_DB_params[2] = {
  "P1", 0x1000, 0, "What", &SHOW_DB_p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam SHOW_DEFAULT_params[2] = {
  "P1", 0x1000, 0, "What", &SHOW_DEFAULT_p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam SHOW_SERVER_params[3] = {
  "P1", 0x1000, 0, "What", &SHOW_SERVER_p01value, 0, "P2", 0x1000, "SERVER_NAME", "Server", &SHOW_SERVER_p02value, 0, 0	/* null entry at end    */
};

static struct cduQualifier SHOW_SERVER_qualifiers[3] = {
  "OUTPUT", 0x2001, 0, 0, 0, 0, "FULL", 0x2000, 0, 0, 0, 0, 0	/* null entry at end    */
};
...
extern int TclShowVersion();

static struct cduValue SHOW_VERSION_p01value = {
  0x2001, 0, SHOW_TYPE, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduParam SHOW_VERSION_params[2] = {
  "P1", 0x1000, 0, "What", &SHOW_VERSION_p01value, 0, 0	/* null entry at end    */
};

static struct cduVerb SHOW_VERSION = {	/* Syntax def   */
  "SHOW_VERSION", 0x0000, 0, 0, TclShowVersion, SHOW_VERSION_params, 0
};

extern int TclShowVersions();

static struct cduValue SHOW_VERSIONS_p01value = {
  0x2001, 0, SHOW_TYPE, {0, DSC_K_DTYPE_T, DSC_K_CLASS_D, 0}, 0
};

static struct cduParam SHOW_VERSIONS_params[2] = {
  "P1", 0x1000, 0, "What", &SHOW_VERSIONS_p01value, 0, 0	/* null entry at end    */
};

static struct cduVerb SHOW_VERSIONS = {	/* Syntax def   */
  "SHOW_VERSIONS", 0x0000, 0, 0, TclShowVersions, SHOW_VERSIONS_params, 0
};

static struct cduKeyword SHOW_TYPE[9] = {	/* "Type" def   */
  "ATTRIBUTE", 0x4000, 0, &SHOW_ATTRIBUTE, 0, 0, "CURRENT", 0x4000, 0, &SHOW_CURRENT, 0, 0, "DATA", 0x4000, 0, &SHOW_DATA, 0, 0, "DB", 0x4000, 0, &SHOW_DB, 0, 0, "DEFAULT", 0x4000, 0, &SHOW_DEFAULT, 0, 0, "SERVER", 0x4000, 0, &SHOW_SERVER, 0, 0, "VERSION", 0x4000, 0, &SHOW_VERSION, 0, 0, "VERSIONS", 0x4000, 0, &SHOW_VERSIONS, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v23params[2] = {
  "P1", 0x1000, 0, "What", &v23p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam START_SERVER_params[3] = {
  "P1", 0x1000, 0, "What", &START_SERVER_p01value, 0, "P2", 0x1000, "SERVER", "Server", &START_SERVER_p02value, 0, 0	/* null entry at end    */
};
...
static struct cduKeyword START_TYPE[2] = {	/* "Type" def   */
  "SERVER", 0x4000, 0, &START_SERVER, 0, 0, 0	/* null entry at end    */
};
...
static struct cduParam v24params[2] = {
  "P1", 0x1000, 0, "What", &v24p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v25params[2] = {
  "P1", 0x1000, 0, "What", &v25p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v27params[2] = {
  "P1", 0x1000, "EVENT", "Event", &v27p01value, 0, 0	/* null entry at end    */
};
...
static struct cduParam v28params[2] = {
  "P1", 0x1000, "FILE", 0, &v28p01value, 0, 0	/* null entry at end    */
};
...
static struct cduQualifier v28qualifiers[2] = {
  "SHOTID", 0x2005, 0, 0, &v28q01value, 0, 0	/* null entry at end    */
};

struct cduVerb tcl_commands[29] = {
  "ABORT", 0x0000, 0, 0, 0, v01params, 0, "ADD", 0x0000, 0, 0, 0, v02params, 0, "CLEAN", 0x0000, 0, 0, TclCleanDatafile, v03params, v03qualifiers, "CLOSE", 0x0000, 0, 0, TclClose, v04params, v04qualifiers, "COMPRESS", 0x0000, 0, 0, TclCompressDatafile, v05params, v05qualifiers, "CREATE", 0x0000, 0, 0, 0, v06params, 0, "DECOMPILE", 0x0000, 0, 0, TclDecompile, v07params, 0, "DEFINE", 0x0000, 0, 0, 0, v08params, 0, "DELETE", 0x0000, 0, 0, 0, v09params, 0, "DIRECTORY", 0x0000, 0, 0, TclDirectory, v10params, v10qualifiers, "DISPATCH", 0x0000, 0, 0, TclDispatch, v11params, v11qualifiers, "DO", 0x0000, 0, 0, TclDoNode, v12params, v12qualifiers, "EDIT", 0x0000, 0, 0, TclEdit, v13params, v13qualifiers, "LINK", 0x0000, 0, 0, TclLink, v14params, 0, "MARK", 0x0000, 0, 0, TreeMarkIncludes, 0, 0, "PUT", 0x0000, 0, 0, TclPutExpression, v16params, v16qualifiers, "TCL", 0x0000, 0, 0, TclCommand, v17params, v17qualifiers, "REMOVE", 0x0000, 0, 0, 0, v18params, 0, "RENAME", 0x0000, 0, 0, TclRename, v19params, v19qualifiers, "RUNDOWN", 0x0000, 0, 0, 0, v20params, 0, "SET", 0x0000, 0, 0, 0, v21params, 0, "SETEVENT", 0x0000, 0, 0, TclSetEvent, v22params, 0, "SHOW", 0x0000, 0, 0, 0, v23params, 0, "START", 0x0000, 0, 0, 0, v24params, 0, "STOP", 0x0000, 0, 0, 0, v25params, 0, "VERIFY", 0x0000, 0, 0, TclVerifyTree, 0, 0, "WFEVENT", 0x0000, 0, 0, TclWfevent, v27params, 0, "WRITE", 0x0000, 0, 0, TclWrite, v28params, v28qualifiers, 0	/* null entry at end    */
};
