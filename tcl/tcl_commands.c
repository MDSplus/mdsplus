...
#include        "clisysdef.h"
		...
		/* Filename: tclcommands.hh
		 * created by cdu :  16-Jan-1998 17:45:54
		 ********************************************************/
...
static struct cduParam  STOP_SERVER_params[3] = {
        "P1",0x0000,0,"What",&STOP_SERVER_p01value,0
       ,"P2",0x0000,"SERVER","Server",&STOP_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_STOP_TYPE[2] = {	/* "Type" def	*/
        "SERVER",0x0000,0,&STOP_SERVER,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  ABORT_SERVER_params[3] = {
        "P1",0x0000,0,"What",&ABORT_SERVER_p01value,0
       ,"P2",0x0000,"SERVER","Server",&ABORT_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  abort_type[2] = {	/* "Type" def	*/
        "SERVER",0x0000,0,&ABORT_SERVER,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v01params[2] = {
        "P1",0x0000,0,"What",&v01p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  ADD_NODE_params[3] = {
        "P1",0x0000,0,"What",&ADD_NODE_p01value,0
       ,"P2",0x0000,"NODE","Node",&ADD_NODE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  USAGE_TYPE[14] = {	/* "Type" def	*/
        "ANY",0x0000,0,0,&t04k01value,0
       ,"STRUCTURE",0x0000,0,0,&t04k02value,0
       ,"ACTION",0x0000,0,0,&t04k03value,0
       ,"DEVICE",0x0000,0,0,&t04k04value,0
       ,"DISPATCH",0x0000,0,0,&t04k05value,0
       ,"NUMERIC",0x0000,0,0,&t04k06value,0
       ,"SIGNAL",0x0000,0,0,&t04k07value,0
       ,"TASK",0x0000,0,0,&t04k08value,0
       ,"TEXT",0x0000,0,0,&t04k09value,0
       ,"WINDOW",0x0000,0,0,&t04k10value,0
       ,"AXIS",0x0000,0,0,&t04k11value,0
       ,"SUBTREE",0x0000,0,0,&t04k12value,0
       ,"COMPOUND_DATA",0x0000,0,0,&t04k13value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier ADD_NODE_qualifiers[4] = {
        "MODEL",0x0000,0,0,&ADD_NODE_q01value,0
       ,"USAGE",0x0001,0,0,&ADD_NODE_q02value,0
       ,"QUALIFIERS",0x0000,0,0,&ADD_NODE_q03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  ADD_TAG_params[4] = {
        "P1",0x0000,0,"What",&ADD_TAG_p01value,0
       ,"P2",0x0000,"NODE","Node",&ADD_TAG_p02value,0
       ,"P3",0x0000,"TAG","Tag",&ADD_TAG_p03value,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_ADD_TYPE[3] = {	/* "Type" def	*/
        "NODE",0x0000,0,&ADD_NODE,0,0
       ,"TAG",0x0000,0,&ADD_TAG,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v02params[2] = {
        "P1",0x0000,0,"What",&v02p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v03params[2] = {
        "P1",0x0000,"FILE","File",&v03p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v03qualifiers[3] = {
        "SHOTID",0x0005,0,0,&v03q01value,0
       ,"OVERRIDE",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
extern int   TclClose();
...
static struct cduParam  v04params[2] = {
        "P1",0x0000,"FILE",0,&v04p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v04qualifiers[3] = {
        "SHOTID",0x0005,0,0,&v04q01value,0
       ,"ALL",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v05params[2] = {
        "P1",0x0000,"FILE","File",&v05p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v05qualifiers[3] = {
        "SHOTID",0x0005,0,0,&v05q01value,0
       ,"OVERRIDE",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  CREATE_PULSE_params[3] = {
        "P1",0x0000,0,"What",&CREATE_PULSE_p01value,0
       ,"P2",0x0000,"SHOT","Shot number",&CREATE_PULSE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier CREATE_PULSE_qualifiers[6] = {
        "INCLUDE",0x0000,0,0,&CREATE_PULSE_q01value,0
       ,"EXCLUDE",0x0000,0,0,&CREATE_PULSE_q02value,0
       ,"CONDITIONAL",0x0000,0,0,0,0
       ,"NOMAIN",0x0004,0,0,0,0
       ,"DISPATCH",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_CREATE_TYPE[2] = {	/* "Type" def	*/
        "PULSE",0x0000,0,&CREATE_PULSE,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v06params[2] = {
        "P1",0x0000,0,"What",&v06p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v07params[2] = {
        "P1",0x0000,"PATH",0,&v07p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DEFINE_SERVER_params[3] = {
        "P1",0x0000,0,"WHAT",&DEFINE_SERVER_p01value,0
       ,"P2",0x0000,0,0,&DEFINE_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DEFINE_SERVER_qualifiers[2] = {
        "TREE",0x0000,0,0,&DEFINE_SERVER_q01value,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_DEFINE_TYPE[2] = {	/* "Type" def	*/
        "SERVER",0x0000,0,&DEFINE_SERVER,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v08params[2] = {
        "P1",0x0000,0,"WHAT",&v08p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DELETE_NODE_params[3] = {
        "P1",0x0000,0,"What",&DELETE_NODE_p01value,0
       ,"P2",0x0000,"NODE","Node",&DELETE_NODE_p02value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier DELETE_NODE_qualifiers[3] = {
        "LOG",0x0000,0,0,0,0
       ,"CONFIRM",0x0001,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DELETE_PULSE_params[3] = {
        "P1",0x0000,0,"What",&DELETE_PULSE_p01value,0
       ,"P2",0x0000,"SHOT","Shot number",&DELETE_PULSE_p02value,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_DELETE_TYPE[3] = {	/* "Type" def	*/
        "NODE",0x0000,0,&DELETE_NODE,0,0
       ,"PULSE",0x0000,0,&DELETE_PULSE,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v09params[2] = {
        "P1",0x0000,0,"What",&v09p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v10params[2] = {
        "P1",0x0000,"NODE",0,&v10p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DIR_TAG_SYNTAX_params[2] = {
        "P1",0x0000,"TAG",0,&DIR_TAG_SYNTAX_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v10qualifiers[5] = {
        "FULL",0x0000,0,0,0,0
       ,"PATH",0x0000,0,0,0,0
       ,"USAGE",0x0000,0,0,&v10q03value,0
       ,"TAG",0x0000,0,&DIR_TAG_SYNTAX,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v11params[2] = {
        "P1",0x0000,"NODE",0,&v11p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DISPATCH_BUILD_qualifiers[2] = {
        "MONITOR",0x0000,0,0,&DISPATCH_BUILD_q01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DISPATCH_PHASE_params[2] = {
        "P1",0x0000,"PHASE_NAME","Phase",&DISPATCH_PHASE_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DISPATCH_PHASE_qualifiers[6] = {
        "PHASE",0x0000,0,0,0,0
       ,"NOACTION",0x0000,0,0,0,0
       ,"SYNCH",0x0005,0,0,&DISPATCH_PHASE_q03value,0
       ,"LOG",0x0001,0,0,0,0
       ,"MONITOR",0x0000,0,0,&DISPATCH_PHASE_q05value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DISPATCH_CLOSE_qualifiers[3] = {
       ...
       ,"SERVER",0x0000,0,0,&DISPATCH_CLOSE_q02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DISPATCH_COMMAND_params[2] = {
        "P1",0x0000,0,0,&DISPATCH_COMMAND_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DISPATCH_COMMAND_qualifiers[5] = {
        "COMMAND",0x0000,0,0,0,0
       ,"SERVER",0x0000,0,0,&DISPATCH_COMMAND_q02value,0
       ,"WAIT",0x0000,0,0,0,0
       ,"TABLE",0x0005,0,0,&DISPATCH_COMMAND_q04value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v11qualifiers[7] = {
        "WAIT",0x0001,0,0,0,0
       ,"BUILD",0x0000,0,&DISPATCH_BUILD,0,0
       ,"CHECK",0x0000,0,&DISPATCH_CHECK,0,0
       ,"PHASE",0x0000,0,&DISPATCH_PHASE,0,0
       ,"CLOSE",0x0000,0,&DISPATCH_CLOSE,0,0
       ,"COMMAND",0x0000,0,&DISPATCH_COMMAND,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v12params[2] = {
        "P1",0x0000,"NODE","Node",&v12p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  DO_METHOD_params[3] = {
        "P1",0x0000,"OBJECT","Object",&DO_METHOD_p01value,0
       ,"P2",0x0000,"METHOD","Method",&DO_METHOD_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier DO_METHOD_qualifiers[4] = {
        "ARGUMENT",0x0000,0,0,&DO_METHOD_q01value,0
       ,"IF",0x0000,0,0,&DO_METHOD_q02value,0
       ,"OVERRIDE",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v13params[2] = {
        "P1",0x0000,"FILE","File",&v13p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v13qualifiers[3] = {
        "SHOTID",0x0005,0,0,&v13q01value,0
       ,"NEW",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
extern int   TclLink();
...
static struct cduParam  v14params[3] = {
        "P1",0x0000,"SOURCE","Source experiment",&v14p01value,0
       ,"P2",0x0000,"DESTINATION","Destination experiment",&v14p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v16params[3] = {
        "P1",0x0000,"NODE","Node",&v16p01value,0
       ,"P2",0x0000,"VALUE","Value",&v16p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  PUT_EXTENDED_params[2] = {
        "P1",0x0000,"NODE","Node",&PUT_EXTENDED_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier PUT_EXTENDED_qualifiers[5] = {
        "EXTENDED",0x0001,0,0,0,0
       ,"SYMBOLS",0x0000,0,0,0,0
       ,"LF",0x0001,0,0,0,0
       ,"EOF",0x0000,0,0,&PUT_EXTENDED_q04value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v16qualifiers[2] = {
        "EXTENDED",0x0000,0,&PUT_EXTENDED,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v17qualifiers[12] = {
        "TABLES",0x0001,0,0,&v17q01value,0
       ,"HELPLIB",0x0001,0,0,&v17q02value,0
       ,"AUXHELPLIB",0x0001,0,0,&v17q03value,0
       ,"PROMPT",0x0001,0,0,&v17q04value,0
       ,"DEF_FILE",0x0001,0,0,&v17q05value,0
       ,"KEY_DEFS",0x0001,0,0,&v17q06value,0
       ,"DEF_LIBRARIES",0x0001,0,0,&v17q07value,0
       ,"COMMAND",0x0001,0,0,&v17q08value,0
       ,"INI_DEF_FILE",0x0001,0,0,&v17q09value,0
       ,"LIBRARY",0x0000,0,0,&v17q10value,0
...
static struct cduParam  REMOVE_TAG_params[3] = {
        "P1",0x0000,0,"What",&REMOVE_TAG_p01value,0
       ,"P2",0x0000,"TAG","Tag",&REMOVE_TAG_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v19params[3] = {
        "P1",0x0000,"SOURCE",0,&v19p01value,0
       ,"P2",0x0000,"DEST",0,&v19p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  RUNDOWN_TREE_params[3] = {
        "P1",0x0000,0,"What",&RUNDOWN_TREE_p01value,0
       ,"P2",0x0000,"FILE","File",&RUNDOWN_TREE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier RUNDOWN_TREE_qualifiers[4] = {
        "SHOTID",0x0005,0,0,&RUNDOWN_TREE_q01value,0
       ,"FORCE_EXIT",0x0000,0,0,0,0
       ,"SUBTREES",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_RUNDOWN_TYPE[2] = {	/* "Type" def	*/
        "TREE",0x0000,0,&RUNDOWN_TREE,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v20params[2] = {
        "P1",0x0000,0,"What",&v20p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_CURRENT_params[4] = {
        "P1",0x0000,0,"What",&SET_CURRENT_p01value,0
       ,"P2",0x0000,"EXPERIMENT","Experiment",&SET_CURRENT_p02value,0
       ,"P3",0x0000,"SHOT",0,&SET_CURRENT_p03value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier SET_CURRENT_qualifiers[2] = {
        "INCREMENT",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_DEFAULT_params[3] = {
        "P1",0x0000,0,"What",&SET_DEFAULT_p01value,0
       ,"P2",0x0000,"NODE","Node",&SET_DEFAULT_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_NODE_params[3] = {
        "P1",0x0000,0,"What",&SET_NODE_p01value,0
       ,"P2",0x0000,"NODE","Node",&SET_NODE_p02value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier SET_NODE_qualifiers[12] = {
        "SUBTREE",0x0000,0,0,0,0
       ,"ON",0x0000,0,0,0,0
       ,"OFF",0x0000,0,0,0,0
       ,"WRITE_ONCE",0x0000,0,0,0,0
       ,"COMPRESS_ON_PUT",0x0000,0,0,0,0
       ,"DO_NOT_COMPRESS",0x0000,0,0,0,0
       ,"SHOT_WRITE",0x0000,0,0,0,0
       ,"MODEL_WRITE",0x0000,0,0,0,0
       ,"INCLUDED",0x0000,0,0,0,0
       ,"LOG",0x0000,0,0,0,0
       ,"ESSENTIAL",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_SERVER_params[3] = {
        "P1",0x0000,0,"What",&SET_SERVER_p01value,0
       ,"P2",0x0000,"SERVER","Server",&SET_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduKeyword  logging_type[4] = {	/* "Type" def	*/
        "NONE",0x0000,0,0,&t11k01value,0
       ,"ACTIONS",0x0001,0,0,&t11k02value,0
       ,"STATISTICS",0x0000,0,0,&t11k03value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_SERVER_qualifiers[2] = {
        "LOG",0x0004,0,0,&SET_SERVER_q01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SET_TREE_params[3] = {
        "P1",0x0000,0,"What",&SET_TREE_p01value,0
       ,"P2",0x0000,"FILE","File",&SET_TREE_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier SET_TREE_qualifiers[3] = {
        "SHOTID",0x0005,0,0,&SET_TREE_q01value,0
       ,"READONLY",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_SET_TYPE[6] = {	/* "Type" def	*/
        "CURRENT",0x0000,0,&SET_CURRENT,0,0
       ,"DEFAULT",0x0000,0,&SET_DEFAULT,0,0
       ,"NODE",0x0000,0,&SET_NODE,0,0
       ,"SERVER",0x0000,0,&SET_SERVER,0,0
       ,"TREE",0x0000,0,&SET_TREE,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v21params[2] = {
        "P1",0x0000,0,"What",&v21p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v22params[2] = {
        "P1",0x0000,"EVENT","Event",&v22p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_CURRENT_params[3] = {
        "P1",0x0000,0,"What",&SHOW_CURRENT_p01value,0
       ,"P2",0x0000,"EXPERIMENT","Experiment",&SHOW_CURRENT_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_DATA_params[3] = {
        "P1",0x0000,0,"What",&SHOW_DATA_p01value,0
       ,"P2",0x0000,"NODE","Node",&SHOW_DATA_p02value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_DB_params[2] = {
        "P1",0x0000,0,"What",&SHOW_DB_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_DEFAULT_params[2] = {
        "P1",0x0000,0,"What",&SHOW_DEFAULT_p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  SHOW_SERVER_params[3] = {
        "P1",0x0000,0,"What",&SHOW_SERVER_p01value,0
       ,"P2",0x0000,"SERVER","Server",&SHOW_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };

static struct cduQualifier SHOW_SERVER_qualifiers[3] = {
        "OUTPUT",0x0001,0,0,0,0
       ,"FULL",0x0000,0,0,0,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_SHOW_TYPE[6] = {	/* "Type" def	*/
        "CURRENT",0x0000,0,&SHOW_CURRENT,0,0
       ,"DATA",0x0000,0,&SHOW_DATA,0,0
       ,"DB",0x0000,0,&SHOW_DB,0,0
       ,"DEFAULT",0x0000,0,&SHOW_DEFAULT,0,0
       ,"SERVER",0x0000,0,&SHOW_SERVER,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v23params[2] = {
        "P1",0x0000,0,"What",&v23p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  START_SERVER_params[3] = {
        "P1",0x0000,0,"What",&START_SERVER_p01value,0
       ,"P2",0x0000,"SERVER","Server",&START_SERVER_p02value,0
       ,0				/* null entry at end	*/
       };
...
struct cduKeyword  TCL_START_TYPE[2] = {	/* "Type" def	*/
        "SERVER",0x0000,0,&START_SERVER,0,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v24params[2] = {
        "P1",0x0000,0,"What",&v24p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v25params[2] = {
        "P1",0x0000,0,"What",&v25p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduParam  v27params[2] = {
        "P1",0x0000,"EVENT","Event",&v27p01value,0
       ,0				/* null entry at end	*/
       };
extern int   TclWrite();
...
static struct cduParam  v28params[2] = {
        "P1",0x0000,"FILE",0,&v28p01value,0
       ,0				/* null entry at end	*/
       };
...
static struct cduQualifier v28qualifiers[2] = {
        "SHOTID",0x0005,0,0,&v28q01value,0
       ,0				/* null entry at end	*/
       };
