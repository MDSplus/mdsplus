...
#        need_to_tag=True
    ...
    if need_to_build:
       ...
       shell(mdsplusdir,'cd ../build/mdsplus/mdsobjects/python; env MDSPLUS_PYTHON_VERSION=mdsplus%s%s-%s python setup.py bdist_egg' % (pkgflavor,VERSION.replace('.','-')),'python bdist_egg failed')
