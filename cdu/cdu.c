...
static struct cmd_struct cmd0[4] = {
  ...
  , CMD_DEFINE, "DEFINE", CMD_IDENT, "IDENT", CMD_MODULE, "MODULE"
};

static struct cmd_struct cmdDefine[4] = {
  0, (void *)(sizeof(cmdDefine) / sizeof(cmdDefine[0]))
  , DEFINE_VERB, "VERB", DEFINE_SYNTAX, "SYNTAX", DEFINE_TYPE, "TYPE"
};

static struct cmd_struct cmdDefineVerb[10] = {
  0, (void *)(sizeof(cmdDefineVerb) / sizeof(cmdDefineVerb[0]))
  , VERB_DISALLOW, "DISALLOW", VERB_NODISALLOWS, "NODISALLOWS", VERB_IMAGE, "IMAGE",
      VERB_PARAMETER, "PARAMETER", VERB_NOPARAMETERS, "NOPARAMETERS", VERB_QUALIFIER,
      "QUALIFIER", VERB_NOQUALIFIERS, "NOQUALIFIERS", VERB_ROUTINE, "ROUTINE", VERB_SYNONYM,
      "SYNONYM"
};

static struct cmd_struct cmdParam[5] = {
  0, (void *)(sizeof(cmdParam) / sizeof(cmdParam[0]))
  , PARAM_DEFAULT, "DEFAULT", PARAM_LABEL, "LABEL", PARAM_PROMPT, "PROMPT", PARAM_VALUE, "VALUE"
};

static struct cmd_struct cmdValue[8] = {
  0, (void *)(sizeof(cmdValue) / sizeof(cmdValue[0]))
  , VAL_CONCATENATE, "CONCATENATE", VAL_DEFAULT, "DEFAULT", VAL_LIST, "LIST", VAL_NOCONCATENATE,
      "NOCONCATENATE", VAL_REQUIRED, "REQUIRED", VAL_TYPE, "TYPE"
};

static struct cmd_struct cmdVerbQual[9] = {
  0, (void *)(sizeof(cmdVerbQual) / sizeof(cmdVerbQual[0]))
  , QUAL_BATCH, "BATCH", QUAL_DEFAULT, "DEFAULT", QUAL_LABEL, "LABEL", QUAL_NEGATABLE,
      "NEGATABLE", QUAL_NONNEGATABLE, "NONNEGATABLE", QUAL_PLACEMENT, "PLACEMENT", QUAL_SYNTAX,
      "SYNTAX", QUAL_VALUE, "VALUE"
};
...
static struct cmd_struct cmdKeyword[7] = {
  ...
  , KEY_DEFAULT, "DEFAULT", KEY_LABEL, "LABEL", KEY_NEGATABLE, "NEGATABLE", KEY_NONNEGATABLE,
      "NONNEGATABLE", KEY_SYNTAX, "SYNTAX", KEY_VALUE, "VALUE"
};
...
static struct cmd_struct built_in_types[10] = {
  ...
  , VAL_M_DATETIME, "$DATETIME", VAL_M_DELTATIME, "$DELTATIME", VAL_M_FILE, "$FILE",
      VAL_M_NUMBER, "$NUMBER", VAL_M_QUOTED_STRING, "$QUOTED_STRING", VAL_M_REST_OF_LINE,
      "$REST_OF_LINE"
};
...
static int cduGetString(void *prompt	/* <r> string or descr: prompt string   */
...
static int cduGetCmd(void *prompt	/* <r> prompt string: char or dsc       */
...
*/
  ...
  return (0);
	 ...
	 ****************************************************************/
static void show_value(struct valueClause *val	/* <r> valueClause struct for display   */
    )
{
  int i, k;
  int mask;
  static char *maskText[] = {
    "USER_DEFINED_TYPE", "FILE", "NUMBER", "QUOTED_STRING", "DATETIME", "REST_OF_LINE",
	"DELTATIME<notSupported>", 0, 0, 0, 0, 0, "LIST", "REQUIRED"
  };
    ...
    )
{
  ...
  return;
	 ...
	 * show_type:
	 ****************************************************************/
static void show_type(char typeName[]	/* <r> typeName to display          */
    )
{
  int i;
  int idx;
    ...
    )
{
  ...
  printf("\n%s %s", (callerOpt == DEFINE_VERB) ? "Verb" : "Syntax", v->vrbA_name);
  ...
  return;
	 ...
	 * cmd_value:
	 ***************************************************************/
static struct valueClause *cmd_value()
{				/* Return: addr of structure      */
  int mask;
  int opt;
  char cmd[32];
  char *p;
    ...
    )
{
  ...
  if (!prm->prmA_value) {	/* parameter MUST have a value struct!  */
  ...
  return (sts);
	 ...
	 **************************************************************/
static int cmd_defineVerb(int callerOpt	/* <r> DEFINE_VERB or DEFINE_SYNTAX     */
    )
{
  int sts;
  int opt;
  ...
  return 1;
	 ...
	 *****************************************************************/
static int cmd_parseKeywordClauses(struct keyword *key	/* <m> keyword struct to fill in        */
    )
{
  int opt;
  char cmd[32];
