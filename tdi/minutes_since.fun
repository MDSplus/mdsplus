/*      MINUTES_SINCE.FUN
; PURPOSE:      Return a floating point number of minutes
;               given an input quadword time.
; CATEGORY:     Data Conversion
; CALLING SEQUENCE: minutes = MINUTES_SINCE(quadword-time [,_since-time-string])
; INPUTS:
...
*/
FUN     PUBLIC MINUTES_SINCE(IN _time, OPTIONAL IN _since) {
  _DELTA = 0Q;
  _ANS = 0.0;
