 ...
 */
  ...
  DevCamChk(_name,CamPiow(_name,0wu,9wu,_d=0wu,16wu),1,1);  /* master reset */
  DevCamChk(_name,CamPiow(_name,0wu,10wu,_d=0wu,16wu),1,1);   /* clear LAM */
  ...
  DevCamChk(_name,CamPiow(_name,1wu,16wu,_control_register_code,16wu),1,1);
  ...
  DevCamChk(_name,CamPiow(_name,3wu,16wu,_post_trig_samp,16wu),1,1);
  
  /* set pre trigger samples */
  DevCamChk(_name,CamPiow(_name,4wu,16wu,_pre_trig_samp,16wu),1,1);
  ...
  DevCamChk(_name,CamPiow(_name,2wu,16wu,_samp_interval_code,16wu),1,1); /* set sampling clock interval */

  DevCamChk(_name,CamPiow(_name,0wu,25wu,_d=0wu,16wu),1,1);   /* start recording */

  DevCamChk(_name,CamPiow(_name,0wu,26wu,_d=0wu,16wu),1,1);   /* enable LAM */
