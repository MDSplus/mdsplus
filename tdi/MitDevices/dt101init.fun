public fun DT101Init(in _board, in _active_chans, in _mode, in _samples, in _pre, in _freq)
{
  ...
  Dt100WriteMaster(_board, "setSyncRoute DI0 MI0");
  Dt100WriteMaster(_board, "setSyncRoute DI1 MI1");
  Dt100WriteMaster(_board, "setSyncRoute DI3 MI2");
  Dt100WriteMaster(_board, "setSyncRoute DI3 MI3");
