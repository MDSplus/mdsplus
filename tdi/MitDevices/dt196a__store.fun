public fun dt196a__store(as_is _nid, optional _method)
{
  _DTYPE_RANGE = 201BU;
   _DT200_NODE = 1;
   _DT200_BOARD = 2;
   ...
   _DT200_PRE_TRIG=28;
   _DT200_RANGES = 29;
   _DT200_STATUS_CMDS = 30;
   _DT200_BOARD_STATUS = 31;
   _DT200_AI_CHANS = 32;
  ...
  for (_chan=0; _chan < _num_chans; _chan++)
  {
    ...
    if (DevIsOn(_chan_nid))
    {
      ...
      if (rank(_data) == 1) {   
        ...
        _status = Dt216PutSignal(_chan_nid,_chan, DevNodeRef(_nid, _DT200_RANGES), _data, _dim);
        if(!(_status&1)) 
