public fun L6810__add(in _path, out _nidout)
{
  ...
  DevAddNode(_path//':FREQ', 'NUMERIC', 1000000., '/noshot_write', _nid);
  DevAddNode(_path//':EXT_CLOCK_IN','AXIS',*,'/noshot_write',_nid);
  DevAddNode(_path//':STOP_TRIG','AXIS',0.,'/noshot_write',_nid);
  DevAddNode(_path//':MEMORIES', 'NUMERIC', 1,'/noshot_write', _nid);
  DevAddNode(_path//':SEGMENTS', 'NUMERIC', 1,'/noshot_write', _nid);
  DevAddNode(_path//':ACTIVE_MEM', 'NUMERIC', 128,'/noshot_write', _nid);
  DevAddNode(_path//':ACTIVE_CHANS', 'NUMERIC', 4,'/noshot_write', _nid);
  for (_c=1;_c<=4;_c++)
  {
