public fun dt101__add(in _path, out _nidout)
{
  DevAddStart(_path,'DT101',174,_nidout);
  ...
  DevAddNode(_path//':PRE_TRIGGER', 'NUMERIC', *, '/noshot_write', _nid);  
  DevAddNode(_path//':INT_CLOCK', 'AXIS', 0, '/noshot_write', _nid);
