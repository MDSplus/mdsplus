/*	MIT__DCLOCK.FUN
	Computes clock range for MPB decoder dual speed clock.
        ...
        _frequency_1 is the first frequency in hz.
        _frequency_2 is the second frequency in hz.
...
FUN PUBLIC MIT__DCLOCK(in _tstart, in _frequency_1, in _frequency_2, in _start_low, in _gate, in _rising) {

  _tstart = f_float(_tstart);
  _frequency_1 = f_float(_frequency_1);
  _frequency_2 = f_float(_frequency_2);
