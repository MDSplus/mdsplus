public fun XRAY__init_2(as_is _nid, optional _method)
{
...
write(*, "errors = ", _errors_1);
	...
	{   	
		...
		DevLogErr(_nid, "Cannot connect to VME rack 1 to perform amplifire model initialization");
		abort();		
	}
	...
	_errors_1 = MdsValue(_expr, _chan_id, _errors_1, _reduction, _trig_mode, 0);
