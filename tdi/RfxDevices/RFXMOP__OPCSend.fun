public fun RFXMOP__OPCSend(as_is _nid, optional _method)
{
	...
	_tagPath = "\\S7:\\Supervisore\\aliases\\SS.DB16.";
	...
	for( _i = 0; _i < _N_NUM_TASK; _i++)
	{
	    ...
	    DevNodeCvt(_nid, (_head_task + _N_TASK_FUNCTION), ['OFFLINE', 'ONLINE', 'SLEEP'], [2,4,1], _funct=-1);
        if(_funct < 0 )
        {
