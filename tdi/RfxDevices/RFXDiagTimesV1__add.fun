public fun RFXDiagTimesV1__add(in _path, out _nidout)
{
    DevAddStart(_path, 'RFXDiagTimesV1', 15, _nidout);
	...
	_diag = _path//'.DGPI';
    DevAddNode(_diag , 'STRUCTURE',  *,        *, _nid);
    DevAddNode(_diag // ':TRIG_STATE',	'TEXT', 'ENABLED', *, _nid);
    DevAddAction(_path//':DGPI_INIT',  'INIT',  'DGPI_INIT', 20,'DGPI_SERVER', getnci(_path, 'fullpath'), _nid);
