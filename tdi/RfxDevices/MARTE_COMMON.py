...
#init method will send a SETUP event with the required information to allow MDSInterface service retrieving parameter and signal information
    def init(self):
      ...
      #eventStr = "SETUP " + Data.compile("$EXPT").data() + " "  + self.control.data() + " " + Data.compile("$SHOTNAME").data() + " " + str(self.id.data()) + " "
      eventStr = "--SETUP " + self.getTree().name + " "  + self.control.data() + " " + str(self.getTree().shot) + " " + str(self.id.data()) + " "
