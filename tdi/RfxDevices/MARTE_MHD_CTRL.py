...
class MARTE_MHD_CTRL(MARTE_GENERIC.MARTE_GENERIC):
    ...
    'horFieldControlEnable_1', 'kpAmplitudes_1','kpPhases_1','ki_1','kd_1','tStart_1','tEnd_1','cutoffFreq_1',
    'horFieldControlEnable_2', 'kpAmplitudes_2','kpPhases_2','ki_2','kd_2','tStart_2','tEnd_2','cutoffFreq_2',
    'horFieldControlEnable_3', 'kpAmplitudes_3','kpPhases_3','ki_3','kd_3','tStart_3','tEnd_3','cutoffFreq_3',
    'horFieldControlEnable_4', 'kpAmplitudes_4','kpPhases_4','ki_4','kd_4','tStart_4','tEnd_4','cutoffFreq_4',
    'horFieldControlEnable_5', 'kpAmplitudes_5','kpPhases_5','ki_5','kd_5','tStart_5','tEnd_5','cutoffFreq_5',
