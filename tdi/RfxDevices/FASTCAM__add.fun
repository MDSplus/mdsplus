...
{
    DevAddStart(_path, 'FASTCAM', 28, _nidout);
    ...
    DevAddNode(_path // ':END_TIME',  'NUMERIC', 0, *, _nid);

    DevAddNode(_path // ':V_RES',  'NUMERIC', 0, *, _nid);
    DevAddNode(_path // ':H_RES',  'NUMERIC', 0, *, _nid);
