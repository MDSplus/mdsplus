...
/* Rotating perturmation */
    ...
    DevAddNode(_path // ':PAR100_NAME', 'TEXT', "RotPertStart1", *, _nid);
    DevAddNode(_path // ':PAR100_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR101_NAME', 'TEXT', "RotPertEnd1", *, _nid);
    ...
    DevAddNode(_path // ':PAR107_NAME', 'TEXT', "RotPertStart2", *, _nid);
    DevAddNode(_path // ':PAR107_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR108_NAME', 'TEXT', "RotPertEnd2", *, _nid);
    ...
    DevAddNode(_path // ':PAR114_NAME', 'TEXT', "RotPertStart3", *, _nid);
    DevAddNode(_path // ':PAR114_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR115_NAME', 'TEXT', "RotPertEnd3", *, _nid);
    ...
    DevAddNode(_path // ':PAR121_NAME', 'TEXT', "RotPertStart4", *, _nid);
    DevAddNode(_path // ':PAR121_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR122_NAME', 'TEXT', "RotPertEnd4", *, _nid);
