...
/* Individual perturbations */
    ...
    DevAddNode(_path // '.PARAMETERS:PAR1_VAL', 'NUMERIC', zero(192), *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR5_VAL', 'NUMERIC', zero(192), *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR9_VAL', 'NUMERIC', zero(192), *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR13_VAL', 'NUMERIC', zero(192), *, _nid);
...
/* Rotating perturmation */
 ...
 /* Mode Control */
    ...
    DevAddNode(_path // '.PARAMETERS:PAR125_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // '.PARAMETERS:PAR126_NAME', 'TEXT', "ModeControlKi", *, _nid);
    DevAddNode(_path // '.PARAMETERS:PAR126_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // '.PARAMETERS:PAR127_NAME', 'TEXT', "ModeControlKd", *, _nid);
    DevAddNode(_path // '.PARAMETERS:PAR127_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // '.PARAMETERS:PAR128_NAME', 'TEXT', "K4", *, _nid);
    DevAddNode(_path // '.PARAMETERS:PAR128_VAL', 'NUMERIC', 0., *, _nid);
