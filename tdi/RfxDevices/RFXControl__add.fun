...
/* Mode Control Parameters */
    ...
    DevAddNode(_path // '.PARAMETERS:PAR206_NAME', 'TEXT', "ModeControlDerivativeCutOff", *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR211_NAME', 'TEXT', "ModeControlMeasureRadius", *, _nid);
