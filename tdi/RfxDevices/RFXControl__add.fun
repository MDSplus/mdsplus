...
/* Individual perturbations */
    ...
    DevAddNode(_path // '.PARAMETERS:PAR1_VAL', 'NUMERIC', 1, *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR5_VAL', 'NUMERIC', 1., *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR9_VAL', 'NUMERIC', 1., *, _nid);
    ...
    DevAddNode(_path // '.PARAMETERS:PAR13_VAL', 'NUMERIC', 1., *, _nid);
