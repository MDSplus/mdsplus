public fun RFXPulse__add(in _path, out _nidout)
{
    ...
    DevAddNode(_path // ':TRIGGER_1', 'NUMERIC', compile(_path // ':EXT_TRIGGER +(' //_path //':EFF_DELAY - ' // _path // ':CORRECTION)'), *, _nid);
    DevAddNode(_path // ':TRIGGER_2', 'NUMERIC', compile(_path // ':TRIGGER_1 +' //_path //':EFF_DURATION'), *, _nid);
