public fun EM_GAIN__add(in _path, out _nidout)
{
	...
	for (_c = 1; _c <=16; _c++)
	{
	    ...
	    DevAddNode(_cn // ':LIN_INPUT',  'NUMERIC', compile('('//_cn//':LIN_OUTPUT * 8) / ( ('//_cn//':LIN_GAIN ) * ( '//_cn//':LIN_CALIB) )'), *, _nid);
	    ...
	    DevAddNode(_cn // ':INT_CALIB',  'NUMERIC', 1., *, _nid);   	    
  	    ...
  	    DevAddNode(_cn // ':INT_INPUT',  'NUMERIC', compile('('//_cn//':INT_OUTPUT * 8) / ( ('//_cn//':INT_GAIN ) * ( '//_cn//':INT_CALIB) )'), *, _nid);
