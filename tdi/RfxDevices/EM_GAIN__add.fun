public fun EM_GAIN__add(in _path, out _nidout)
{
 ...
 /*  	    DevAddNode(_cn // ':LIN_INPUT', 'NUMERIC', compile('('//_cn//':LIN_OUTPUT * 39) / ('//_cn//':LIN_GAIN * 8 + 7)'), *, _nid);
*/		
	    DevAddNode(_cn // ':LIN_INPUT', 'NUMERIC', compile('('//_cn//':LIN_OUTPUT * 8) / ('//_cn//':LIN_GAIN)'), *, _nid);

	    DevAddNode(_cn // ':INT_NAME',   'TEXT', *, *, _nid);
   	    DevAddNode(_cn // ':INT_GAIN',   'NUMERIC', 0., *, _nid);
   	    DevAddNode(_cn // ':INT_OUTPUT',  'NUMERIC', 0., *, _nid);
/*   	    DevAddNode(_cn // ':INT_INPUT', 'NUMERIC', compile('('//_cn//':LIN_OUTPUT * 39) / ('//_cn//':INT_GAIN * 8 + 7)'), *, _nid);
*/
  	    DevAddNode(_cn // ':INT_INPUT', 'NUMERIC', compile('('//_cn//':LIN_OUTPUT * 8) / ('//_cn//':INT_GAIN)'), *, _nid);
	}
