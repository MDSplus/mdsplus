public fun EQU_GAIN__add(in _path, out _nidout)
{
    DevAddStart(_path, 'EQU_GAIN', 182, _nidout);
    DevAddNode(_path // ':COMMENT', 'TEXT', *, *, _nid);
    DevAddNode(_path // ':INT_ADC', 'TEXT', *, *, _nid);
    DevAddNode(_path // ':LIN_ADC', 'TEXT', *, *, _nid);
