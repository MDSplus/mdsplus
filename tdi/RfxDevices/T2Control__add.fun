...
write(*,'T2Control__add'); 
    DevAddStart(_path, 'T2Control', 257, _nidout);
    ...
    DevAddNode(_path // ':PAR6_NAME', 'TEXT', "AngVelocity1", *, _nid);
    DevAddNode(_path // ':PAR6_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR7_NAME', 'TEXT', "InitPhase1", *, _nid);
    DevAddNode(_path // ':PAR7_VAL', 'NUMERIC', 0., *, _nid);

    DevAddNode(_path // ':PAR8_NAME', 'TEXT', "N2", *, _nid);
    DevAddNode(_path // ':PAR8_VAL', 'NUMERIC', 1., *, _nid);
    DevAddNode(_path // ':PAR9_NAME', 'TEXT', "Amplitude2", *, _nid);
    DevAddNode(_path // ':PAR9_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR10_NAME', 'TEXT', "AngVelocity2", *, _nid);
    DevAddNode(_path // ':PAR10_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR11_NAME', 'TEXT', "InitPhase2", *, _nid);
    DevAddNode(_path // ':PAR11_VAL', 'NUMERIC', 0., *, _nid);

    DevAddNode(_path // ':PAR12_NAME', 'TEXT', "N3", *, _nid);
    DevAddNode(_path // ':PAR12_VAL', 'NUMERIC', 1., *, _nid);
    DevAddNode(_path // ':PAR13_NAME', 'TEXT', "Amplitude3", *, _nid);
    DevAddNode(_path // ':PAR13_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR14_NAME', 'TEXT', "AngVelocity3", *, _nid);
    DevAddNode(_path // ':PAR14_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR15_NAME', 'TEXT', "InitPhase3", *, _nid);
    DevAddNode(_path // ':PAR15_VAL', 'NUMERIC', 0., *, _nid);

    DevAddNode(_path // ':PAR16_NAME', 'TEXT', "N4", *, _nid);
    DevAddNode(_path // ':PAR16_VAL', 'NUMERIC', 1., *, _nid);
    DevAddNode(_path // ':PAR17_NAME', 'TEXT', "Amplitude4", *, _nid);
    DevAddNode(_path // ':PAR17_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR18_NAME', 'TEXT', "AngVelocity4", *, _nid);
    DevAddNode(_path // ':PAR18_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR19_NAME', 'TEXT', "InitPhase4", *, _nid);
    DevAddNode(_path // ':PAR19_VAL', 'NUMERIC', 0., *, _nid);


    DevAddNode(_path // ':PAR20_NAME', 'TEXT', "K1", *, _nid);
    DevAddNode(_path // ':PAR20_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR21_NAME', 'TEXT', "K2", *, _nid);
    DevAddNode(_path // ':PAR21_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR22_NAME', 'TEXT', "K3", *, _nid);
    DevAddNode(_path // ':PAR22_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR23_NAME', 'TEXT', "K4", *, _nid);
    DevAddNode(_path // ':PAR23_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR24_NAME', 'TEXT', "K5", *, _nid);
    DevAddNode(_path // ':PAR24_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR25_NAME', 'TEXT', "PertIdx1", *, _nid);
    DevAddNode(_path // ':PAR25_VAL', 'NUMERIC', 1, *, _nid);
    DevAddNode(_path // ':PAR26_NAME', 'TEXT', "PertAmp1", *, _nid);
    DevAddNode(_path // ':PAR26_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR27_NAME', 'TEXT', "PertOmega1", *, _nid);
    DevAddNode(_path // ':PAR27_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR28_NAME', 'TEXT', "PertPhi1", *, _nid);
    DevAddNode(_path // ':PAR28_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR29_NAME', 'TEXT', "PertIdx2", *, _nid);
    DevAddNode(_path // ':PAR29_VAL', 'NUMERIC', 1., *, _nid);
    DevAddNode(_path // ':PAR30_NAME', 'TEXT', "PertAmp2", *, _nid);
    DevAddNode(_path // ':PAR30_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR31_NAME', 'TEXT', "PertOmega2", *, _nid);
    DevAddNode(_path // ':PAR31_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR32_NAME', 'TEXT', "PertPhi2", *, _nid);
    DevAddNode(_path // ':PAR32_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR33_NAME', 'TEXT', "PertIdx3", *, _nid);
    DevAddNode(_path // ':PAR33_VAL', 'NUMERIC', 1., *, _nid);
    DevAddNode(_path // ':PAR34_NAME', 'TEXT', "PertAmp3", *, _nid);
    DevAddNode(_path // ':PAR34_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR35_NAME', 'TEXT', "PertOmega3", *, _nid);
    DevAddNode(_path // ':PAR35_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR36_NAME', 'TEXT', "PertPhi3", *, _nid);
    DevAddNode(_path // ':PAR36_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR37_NAME', 'TEXT', "PertIdx4", *, _nid);
    DevAddNode(_path // ':PAR37_VAL', 'NUMERIC', 1., *, _nid);
    DevAddNode(_path // ':PAR38_NAME', 'TEXT', "PertAmp4", *, _nid);
    DevAddNode(_path // ':PAR38_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR39_NAME', 'TEXT', "PertOmega4", *, _nid);
    DevAddNode(_path // ':PAR39_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR40_NAME', 'TEXT', "PertPhi4", *, _nid);
    DevAddNode(_path // ':PAR40_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR41_NAME', 'TEXT', "xx", *, _nid);
    DevAddNode(_path // ':PAR41_VAL', 'NUMERIC', 0., *, _nid);
    DevAddNode(_path // ':PAR42_NAME', 'TEXT', "yy", *, _nid);
