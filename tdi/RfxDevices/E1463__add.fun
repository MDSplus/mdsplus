public fun E1463__add(in _path, out _nidout)
{
    ...
    DevAddAction(_path// ':INIT_ACTION', 'INIT', 'INIT', 50,'GPIB_SERVER',_path, _nid);
    DevAddAction(_path// ':ARM_ACTION', 'ARM', 'INIT', 60,'GPIB_SERVER',_path, _nid);
    DevAddAction(_path// ':STORE_ACTION', 'STORE','STORE', 50,'GPIB_SERVER',_path, _nid);
    DevAddEnd();
}
