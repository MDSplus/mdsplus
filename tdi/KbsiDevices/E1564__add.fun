public fun E1564__add(in _path, out _nidout)
{
    DevAddStart(_path, 'E1564', 47, _nidout);
    ...
    DevAddNode(_path // '.SAMPLE:SOURCE', 'NUMERIC', 1, *, _nid);
	...
	DevAddNode(_nodeName//':FILTER', 'NUMERIC', 0d0, *, _nid);
