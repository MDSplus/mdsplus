public fun VX4244__open(as_is _nid, optional _method)
{
    ...
    _id = 0u;
    if_error(Tkvx4244_32->tkvx4244_init(_address, VAL(1), VAL(1), REF(_id)),(DevLogErr(_nid, "Error in Initialization"); abort();));
