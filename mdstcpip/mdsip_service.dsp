...
!MESSAGE 
!MESSAGE "mdsip_service - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "mdsip_service - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../include" /I "'../../PROGRAM_FILES/PLATFORM SDK/INCLUDE'" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_NT_SERVICE" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../include" /I "'../../PROGRAM_FILES/PLATFORM SDK/INCLUDE'" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_NT_SERVICE" /YX /FD /c
...
# ADD LINK32 ../mdsshr/debug/mdsshr.lib ../treeshr/debug/treeshr.lib ../tdishr/debug/tdishr.lib debug/mdsipshr.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../Debug/mdsip_service.exe" /pdbtype:sept
# SUBTRACT LINK32 /map
