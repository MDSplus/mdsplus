...
*/
  int status;
  BlockSig(SIGALRM);
  status = MdsOpen((int)((char *)lpvArgv[0] - (char *)0),(char *)lpvArgv[1],(int)((char *)lpvArgv[2] - (char *)0));
  UnBlockSig(SIGALRM);
  return status;
}
...
*/
  int status;
  BlockSig(SIGALRM);
  status = GetAnswerInfo((int)((char *)lpvArgv[0] - (char *)0), (char *)lpvArgv[1], (short *)lpvArgv[2], (char *)lpvArgv[3],
...
*/
  ...
  int status;
  BlockSig(SIGALRM);
  status = SendArg((int)((char *)lpvArgv[0] - (char *)0), idx, dtype, nargs, length, ndims, (int *)lpvArgv[6], (char *)lpvArgv[7]);
  UnBlockSig(SIGALRM);
  return status;
}
