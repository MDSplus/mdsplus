...
// sizeof(CCCFactory<CUDPBlast>)); UDT::setsockopt(client, 0, UDT_MSS, new
// int(9000), sizeof(int)); UDT::setsockopt(client, 0, UDT_SNDBUF, new
// int(10000000), sizeof(int)); UDT::setsockopt(client, 0, UDP_SNDBUF, new
// int(10000000), sizeof(int)); UDT::setsockopt(client, 0, UDT_MAXBW, new
// int64_t(12500000), sizeof(int));

// Windows UDP issue
// For better performance, modify
...
#endif
{
  ...
  cout << "SendRate(Mb/s)\tRTT(ms)\tCWnd\tPktSndPeriod(us)\tRecvACK\tRecvNAK"
       << endl;
