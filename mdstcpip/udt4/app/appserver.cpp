...
int main(int argc, char *argv[]) {
  ...
  // sizeof(CCCFactory<CUDPBlast>)); UDT::setsockopt(serv, 0, UDT_MSS, new
  // int(9000), sizeof(int)); UDT::setsockopt(serv, 0, UDT_RCVBUF, new
  // int(10000000), sizeof(int)); UDT::setsockopt(serv, 0, UDP_RCVBUF, new
  // int(10000000), sizeof(int));
