...
EXPORT int l6810c__add(struct descriptor *name_d_ptr, struct descriptor *dummy_d_ptr, int *nid_ptr)
{
...
EXPORT int l6810c__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr,
...
EXPORT int l6810c__init(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
EXPORT int l6810c__trigger(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
EXPORT int l6810c__store(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
