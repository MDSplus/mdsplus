...
struct _f0a0 { unsigned pretrigger : 3;
...
static int Store(InStoreStruct *setup, int partial)
{
  ...
  pio(0,0,(short *)&f0a0);
  dimension.axis = f0a0.external ? (struct descriptor *)(&ext_clock_d) : (struct descriptor *)(&int_clock_d);
  pio(1,1,(short *)&f1a1);
  ...
  {
    int data_nid = setup->head_nid + JOERGER_TR812_N_CHANNEL_1 + (JOERGER_TR812_N_CHANNEL_2 - JOERGER_TR812_N_CHANNEL_1) * chan;
