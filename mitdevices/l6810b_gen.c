...
int l6810b__add(struct descriptor *name_d_ptr, struct descriptor *dummy_d_ptr, int *nid_ptr)
{
...
int l6810b__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(L6810B_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(L6810B_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(L6810B_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(L6810B_N_FREQ + 1) : COPY_PART_NAME(:FREQ) break;
		case(L6810B_N_EXT_CLOCK_IN + 1) : COPY_PART_NAME(:EXT_CLOCK_IN) break;
		case(L6810B_N_STOP_TRIG + 1) : COPY_PART_NAME(:STOP_TRIG) break;
		case(L6810B_N_MEMORIES + 1) : COPY_PART_NAME(:MEMORIES) break;
		case(L6810B_N_SEGMENTS + 1) : COPY_PART_NAME(:SEGMENTS) break;
		case(L6810B_N_ACTIVE_MEM + 1) : COPY_PART_NAME(:ACTIVE_MEM) break;
		case(L6810B_N_ACTIVE_CHANS + 1) : COPY_PART_NAME(:ACTIVE_CHANS) break;
		case(L6810B_N_INPUT_01 + 1) : COPY_PART_NAME(:INPUT_01) break;
		case(L6810B_N_INPUT_01_STARTIDX + 1) : COPY_PART_NAME(:INPUT_01:STARTIDX) break;
		case(L6810B_N_INPUT_01_ENDIDX + 1) : COPY_PART_NAME(:INPUT_01:ENDIDX) break;
		case(L6810B_N_INPUT_01_FULL_SCALE + 1) : COPY_PART_NAME(:INPUT_01:FULL_SCALE) break;
		case(L6810B_N_INPUT_01_SRC_CPLING + 1) : COPY_PART_NAME(:INPUT_01:SRC_CPLING) break;
		case(L6810B_N_INPUT_01_OFFSET + 1) : COPY_PART_NAME(:INPUT_01:OFFSET) break;
		case(L6810B_N_INPUT_02 + 1) : COPY_PART_NAME(:INPUT_02) break;
		case(L6810B_N_INPUT_02_STARTIDX + 1) : COPY_PART_NAME(:INPUT_02:STARTIDX) break;
		case(L6810B_N_INPUT_02_ENDIDX + 1) : COPY_PART_NAME(:INPUT_02:ENDIDX) break;
		case(L6810B_N_INPUT_02_FULL_SCALE + 1) : COPY_PART_NAME(:INPUT_02:FULL_SCALE) break;
		case(L6810B_N_INPUT_02_SRC_CPLING + 1) : COPY_PART_NAME(:INPUT_02:SRC_CPLING) break;
		case(L6810B_N_INPUT_02_OFFSET + 1) : COPY_PART_NAME(:INPUT_02:OFFSET) break;
		case(L6810B_N_INPUT_03 + 1) : COPY_PART_NAME(:INPUT_03) break;
		case(L6810B_N_INPUT_03_STARTIDX + 1) : COPY_PART_NAME(:INPUT_03:STARTIDX) break;
		case(L6810B_N_INPUT_03_ENDIDX + 1) : COPY_PART_NAME(:INPUT_03:ENDIDX) break;
		case(L6810B_N_INPUT_03_FULL_SCALE + 1) : COPY_PART_NAME(:INPUT_03:FULL_SCALE) break;
		case(L6810B_N_INPUT_03_SRC_CPLING + 1) : COPY_PART_NAME(:INPUT_03:SRC_CPLING) break;
		case(L6810B_N_INPUT_03_OFFSET + 1) : COPY_PART_NAME(:INPUT_03:OFFSET) break;
		case(L6810B_N_INPUT_04 + 1) : COPY_PART_NAME(:INPUT_04) break;
		case(L6810B_N_INPUT_04_STARTIDX + 1) : COPY_PART_NAME(:INPUT_04:STARTIDX) break;
		case(L6810B_N_INPUT_04_ENDIDX + 1) : COPY_PART_NAME(:INPUT_04:ENDIDX) break;
		case(L6810B_N_INPUT_04_FULL_SCALE + 1) : COPY_PART_NAME(:INPUT_04:FULL_SCALE) break;
		case(L6810B_N_INPUT_04_SRC_CPLING + 1) : COPY_PART_NAME(:INPUT_04:SRC_CPLING) break;
		case(L6810B_N_INPUT_04_OFFSET + 1) : COPY_PART_NAME(:INPUT_04:OFFSET) break;
		case(L6810B_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(L6810B_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
...
int l6810b__init(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int l6810b__trigger(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int l6810b__store(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
