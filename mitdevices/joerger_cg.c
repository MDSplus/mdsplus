...
static float slopes[] = {1E9,1,1E-1,1E-2,1E-3,1E-4,2E-5,1E-5,4E-6,2E-6,1E-6,4E-7,2E-7,1E-7,5E-8,2.5E-8};
...
static int SetChannel(InInitStruct *setup,struct descriptor *channel_value, int channel, int *polarities)
{
  static EMPTYXD(xd);
  int status;
  int p = *polarities;
