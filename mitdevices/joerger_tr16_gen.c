...
int joerger_tr16__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(JOERGER_TR16_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(JOERGER_TR16_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(JOERGER_TR16_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(JOERGER_TR16_N_FREQ + 1) : COPY_PART_NAME(:FREQ) break;
		case(JOERGER_TR16_N_EXT_CLOCK_IN + 1) : COPY_PART_NAME(:EXT_CLOCK_IN) break;
		case(JOERGER_TR16_N_STOP_TRIG + 1) : COPY_PART_NAME(:STOP_TRIG) break;
		case(JOERGER_TR16_N_MEM_SIZE + 1) : COPY_PART_NAME(:MEM_SIZE) break;
		case(JOERGER_TR16_N_ACTIVE_MEM + 1) : COPY_PART_NAME(:ACTIVE_MEM) break;
		case(JOERGER_TR16_N_ACTIVE_CHANS + 1) : COPY_PART_NAME(:ACTIVE_CHANS) break;
		case(JOERGER_TR16_N_POST_TRIG + 1) : COPY_PART_NAME(:POST_TRIG) break;
		case(JOERGER_TR16_N_MASTER + 1) : COPY_PART_NAME(:MASTER) break;
		case(JOERGER_TR16_N_INPUT_01 + 1) : COPY_PART_NAME(:INPUT_01) break;
		case(JOERGER_TR16_N_INPUT_01_STARTIDX + 1) : COPY_PART_NAME(:INPUT_01:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_01_ENDIDX + 1) : COPY_PART_NAME(:INPUT_01:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_01_GAIN + 1) : COPY_PART_NAME(:INPUT_01:GAIN) break;
		case(JOERGER_TR16_N_INPUT_02 + 1) : COPY_PART_NAME(:INPUT_02) break;
		case(JOERGER_TR16_N_INPUT_02_STARTIDX + 1) : COPY_PART_NAME(:INPUT_02:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_02_ENDIDX + 1) : COPY_PART_NAME(:INPUT_02:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_02_GAIN + 1) : COPY_PART_NAME(:INPUT_02:GAIN) break;
		case(JOERGER_TR16_N_INPUT_03 + 1) : COPY_PART_NAME(:INPUT_03) break;
		case(JOERGER_TR16_N_INPUT_03_STARTIDX + 1) : COPY_PART_NAME(:INPUT_03:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_03_ENDIDX + 1) : COPY_PART_NAME(:INPUT_03:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_03_GAIN + 1) : COPY_PART_NAME(:INPUT_03:GAIN) break;
		case(JOERGER_TR16_N_INPUT_04 + 1) : COPY_PART_NAME(:INPUT_04) break;
		case(JOERGER_TR16_N_INPUT_04_STARTIDX + 1) : COPY_PART_NAME(:INPUT_04:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_04_ENDIDX + 1) : COPY_PART_NAME(:INPUT_04:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_04_GAIN + 1) : COPY_PART_NAME(:INPUT_04:GAIN) break;
		case(JOERGER_TR16_N_INPUT_05 + 1) : COPY_PART_NAME(:INPUT_05) break;
		case(JOERGER_TR16_N_INPUT_05_STARTIDX + 1) : COPY_PART_NAME(:INPUT_05:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_05_ENDIDX + 1) : COPY_PART_NAME(:INPUT_05:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_05_GAIN + 1) : COPY_PART_NAME(:INPUT_05:GAIN) break;
		case(JOERGER_TR16_N_INPUT_06 + 1) : COPY_PART_NAME(:INPUT_06) break;
		case(JOERGER_TR16_N_INPUT_06_STARTIDX + 1) : COPY_PART_NAME(:INPUT_06:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_06_ENDIDX + 1) : COPY_PART_NAME(:INPUT_06:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_06_GAIN + 1) : COPY_PART_NAME(:INPUT_06:GAIN) break;
		case(JOERGER_TR16_N_INPUT_07 + 1) : COPY_PART_NAME(:INPUT_07) break;
		case(JOERGER_TR16_N_INPUT_07_STARTIDX + 1) : COPY_PART_NAME(:INPUT_07:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_07_ENDIDX + 1) : COPY_PART_NAME(:INPUT_07:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_07_GAIN + 1) : COPY_PART_NAME(:INPUT_07:GAIN) break;
		case(JOERGER_TR16_N_INPUT_08 + 1) : COPY_PART_NAME(:INPUT_08) break;
		case(JOERGER_TR16_N_INPUT_08_STARTIDX + 1) : COPY_PART_NAME(:INPUT_08:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_08_ENDIDX + 1) : COPY_PART_NAME(:INPUT_08:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_08_GAIN + 1) : COPY_PART_NAME(:INPUT_08:GAIN) break;
		case(JOERGER_TR16_N_INPUT_09 + 1) : COPY_PART_NAME(:INPUT_09) break;
		case(JOERGER_TR16_N_INPUT_09_STARTIDX + 1) : COPY_PART_NAME(:INPUT_09:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_09_ENDIDX + 1) : COPY_PART_NAME(:INPUT_09:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_09_GAIN + 1) : COPY_PART_NAME(:INPUT_09:GAIN) break;
		case(JOERGER_TR16_N_INPUT_10 + 1) : COPY_PART_NAME(:INPUT_10) break;
		case(JOERGER_TR16_N_INPUT_10_STARTIDX + 1) : COPY_PART_NAME(:INPUT_10:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_10_ENDIDX + 1) : COPY_PART_NAME(:INPUT_10:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_10_GAIN + 1) : COPY_PART_NAME(:INPUT_10:GAIN) break;
		case(JOERGER_TR16_N_INPUT_11 + 1) : COPY_PART_NAME(:INPUT_11) break;
		case(JOERGER_TR16_N_INPUT_11_STARTIDX + 1) : COPY_PART_NAME(:INPUT_11:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_11_ENDIDX + 1) : COPY_PART_NAME(:INPUT_11:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_11_GAIN + 1) : COPY_PART_NAME(:INPUT_11:GAIN) break;
		case(JOERGER_TR16_N_INPUT_12 + 1) : COPY_PART_NAME(:INPUT_12) break;
		case(JOERGER_TR16_N_INPUT_12_STARTIDX + 1) : COPY_PART_NAME(:INPUT_12:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_12_ENDIDX + 1) : COPY_PART_NAME(:INPUT_12:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_12_GAIN + 1) : COPY_PART_NAME(:INPUT_12:GAIN) break;
		case(JOERGER_TR16_N_INPUT_13 + 1) : COPY_PART_NAME(:INPUT_13) break;
		case(JOERGER_TR16_N_INPUT_13_STARTIDX + 1) : COPY_PART_NAME(:INPUT_13:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_13_ENDIDX + 1) : COPY_PART_NAME(:INPUT_13:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_13_GAIN + 1) : COPY_PART_NAME(:INPUT_13:GAIN) break;
		case(JOERGER_TR16_N_INPUT_14 + 1) : COPY_PART_NAME(:INPUT_14) break;
		case(JOERGER_TR16_N_INPUT_14_STARTIDX + 1) : COPY_PART_NAME(:INPUT_14:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_14_ENDIDX + 1) : COPY_PART_NAME(:INPUT_14:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_14_GAIN + 1) : COPY_PART_NAME(:INPUT_14:GAIN) break;
		case(JOERGER_TR16_N_INPUT_15 + 1) : COPY_PART_NAME(:INPUT_15) break;
		case(JOERGER_TR16_N_INPUT_15_STARTIDX + 1) : COPY_PART_NAME(:INPUT_15:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_15_ENDIDX + 1) : COPY_PART_NAME(:INPUT_15:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_15_GAIN + 1) : COPY_PART_NAME(:INPUT_15:GAIN) break;
		case(JOERGER_TR16_N_INPUT_16 + 1) : COPY_PART_NAME(:INPUT_16) break;
		case(JOERGER_TR16_N_INPUT_16_STARTIDX + 1) : COPY_PART_NAME(:INPUT_16:STARTIDX) break;
		case(JOERGER_TR16_N_INPUT_16_ENDIDX + 1) : COPY_PART_NAME(:INPUT_16:ENDIDX) break;
		case(JOERGER_TR16_N_INPUT_16_GAIN + 1) : COPY_PART_NAME(:INPUT_16:GAIN) break;
		case(JOERGER_TR16_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(JOERGER_TR16_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
...
int joerger_tr16__init(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
	declare_variables(InInitStruct)
static struct {
	short code;
	int value;} mem_size_t[] = {
	0, 128,
	1, 256,
	2, 512,
	3, 1024,
...
static struct {
	...
	check_integer_conv_set(active_chans, active_chans_convert, active_chans_t, 5, TR16$_BAD_ACTIVECHAN);
...
int joerger_tr16__trigger(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int joerger_tr16__store(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
