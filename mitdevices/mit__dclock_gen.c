...
EXPORT int mit__dclock__add(struct descriptor *name_d_ptr, struct descriptor *dummy_d_ptr, int *nid_ptr)
{
...
EXPORT int mit__dclock__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr,
...
EXPORT int mit__dclock___get_setup(struct descriptor *nid_d_ptr, InGet_setupStruct * in_ptr)
{
