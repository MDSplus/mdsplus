...
int reticon120__add(struct descriptor *name_d_ptr, struct descriptor *dummy_d_ptr, int *nid_ptr)
{
...
int reticon120__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(RETICON120_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(RETICON120_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(RETICON120_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(RETICON120_N_MEMORY_NAME + 1) : COPY_PART_NAME(:MEMORY_NAME) break;
		case(RETICON120_N_START_TRIG + 1) : COPY_PART_NAME(:START_TRIG) break;
		case(RETICON120_N_PIXEL_SELECT + 1) : COPY_PART_NAME(:PIXEL_SELECT) break;
		case(RETICON120_N_PIXEL_AXIS + 1) : COPY_PART_NAME(:PIXEL_AXIS) break;
		case(RETICON120_N_DATA + 1) : COPY_PART_NAME(:DATA) break;
		case(RETICON120_N_EVENT_LATCH + 1) : COPY_PART_NAME(:EVENT_LATCH) break;
		case(RETICON120_N_NUM_STATES + 1) : COPY_PART_NAME(:NUM_STATES) break;
		case(RETICON120_N_FRAME_INDEX + 1) : COPY_PART_NAME(:FRAME_INDEX) break;
		case(RETICON120_N_STATE_0 + 1) : COPY_PART_NAME(.STATE_0) break;
		case(RETICON120_N_STATE_0_PERIOD + 1) : COPY_PART_NAME(.STATE_0:PERIOD) break;
		case(RETICON120_N_STATE_0_FRAMES + 1) : COPY_PART_NAME(.STATE_0:FRAMES) break;
		case(RETICON120_N_STATE_0_FRAME_SELECT + 1) : COPY_PART_NAME(.STATE_0:FRAME_SELECT) break;
		case(RETICON120_N_STATE_1 + 1) : COPY_PART_NAME(.STATE_1) break;
		case(RETICON120_N_STATE_1_PERIOD + 1) : COPY_PART_NAME(.STATE_1:PERIOD) break;
		case(RETICON120_N_STATE_1_FRAMES + 1) : COPY_PART_NAME(.STATE_1:FRAMES) break;
		case(RETICON120_N_STATE_1_FRAME_SELECT + 1) : COPY_PART_NAME(.STATE_1:FRAME_SELECT) break;
		case(RETICON120_N_STATE_2 + 1) : COPY_PART_NAME(.STATE_2) break;
		case(RETICON120_N_STATE_2_PERIOD + 1) : COPY_PART_NAME(.STATE_2:PERIOD) break;
		case(RETICON120_N_STATE_2_FRAMES + 1) : COPY_PART_NAME(.STATE_2:FRAMES) break;
		case(RETICON120_N_STATE_2_FRAME_SELECT + 1) : COPY_PART_NAME(.STATE_2:FRAME_SELECT) break;
		case(RETICON120_N_STATE_3 + 1) : COPY_PART_NAME(.STATE_3) break;
		case(RETICON120_N_STATE_3_PERIOD + 1) : COPY_PART_NAME(.STATE_3:PERIOD) break;
		case(RETICON120_N_STATE_3_FRAMES + 1) : COPY_PART_NAME(.STATE_3:FRAMES) break;
		case(RETICON120_N_STATE_3_FRAME_SELECT + 1) : COPY_PART_NAME(.STATE_3:FRAME_SELECT) break;
		case(RETICON120_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(RETICON120_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
...
int reticon120__init(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int reticon120__store(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int reticon120__trigger(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
