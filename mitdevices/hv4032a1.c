...
int hv4032a1__get_settings(struct descriptor *niddsc_ptr, struct descriptor *meth, int max_chans, int *settings)
{
  int status = 1;
  static InGet_settingsStruct setup;
  if (max_chans != HV4032A1_K_CHANS) return HV4032$_WRONG_POD_TYPE;
