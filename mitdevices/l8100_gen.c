...
#include "l8100_gen.h"
int l8100__add(struct descriptor *name_d_ptr, struct descriptor *dummy_d_ptr, int *nid_ptr)
{
...
int l8100__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(L8100_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(L8100_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(L8100_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(L8100_N_INPUT_1 + 1) : COPY_PART_NAME(:INPUT_1) break;
		case(L8100_N_INPUT_1_GAIN + 1) : COPY_PART_NAME(:INPUT_1:GAIN) break;
		case(L8100_N_INPUT_1_MULT + 1) : COPY_PART_NAME(:INPUT_1:MULT) break;
		case(L8100_N_INPUT_1_GROUND + 1) : COPY_PART_NAME(:INPUT_1:GROUND) break;
		case(L8100_N_INPUT_1_OFFSET + 1) : COPY_PART_NAME(:INPUT_1:OFFSET) break;
		case(L8100_N_INPUT_1_FILTER + 1) : COPY_PART_NAME(:INPUT_1:FILTER) break;
		case(L8100_N_INPUT_1_OUTPUT + 1) : COPY_PART_NAME(:INPUT_1:OUTPUT) break;
		case(L8100_N_INPUT_1_FILTER_ON + 1) : COPY_PART_NAME(:INPUT_1:FILTER_ON) break;
		case(L8100_N_INPUT_2 + 1) : COPY_PART_NAME(:INPUT_2) break;
		case(L8100_N_INPUT_2_GAIN + 1) : COPY_PART_NAME(:INPUT_2:GAIN) break;
		case(L8100_N_INPUT_2_MULT + 1) : COPY_PART_NAME(:INPUT_2:MULT) break;
		case(L8100_N_INPUT_2_GROUND + 1) : COPY_PART_NAME(:INPUT_2:GROUND) break;
		case(L8100_N_INPUT_2_OFFSET + 1) : COPY_PART_NAME(:INPUT_2:OFFSET) break;
		case(L8100_N_INPUT_2_FILTER + 1) : COPY_PART_NAME(:INPUT_2:FILTER) break;
		case(L8100_N_INPUT_2_OUTPUT + 1) : COPY_PART_NAME(:INPUT_2:OUTPUT) break;
		case(L8100_N_INPUT_2_FILTER_ON + 1) : COPY_PART_NAME(:INPUT_2:FILTER_ON) break;
		case(L8100_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(L8100_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
...
int l8100__init(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int l8100__store(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
