...
int a3204__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(A3204_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(A3204_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(A3204_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(A3204_N_INPUT_1 + 1) : COPY_PART_NAME(:INPUT_1) break;
		case(A3204_N_INPUT_1_GAIN + 1) : COPY_PART_NAME(:INPUT_1:GAIN) break;
		case(A3204_N_INPUT_1_OFFSET + 1) : COPY_PART_NAME(:INPUT_1:OFFSET) break;
		case(A3204_N_INPUT_1_FILTER + 1) : COPY_PART_NAME(:INPUT_1.FILTER) break;
		case(A3204_N_INPUT_1_OUTPUT + 1) : COPY_PART_NAME(:INPUT_1:OUTPUT) break;
		case(A3204_N_INPUT_1_FILTER_ON + 1) : COPY_PART_NAME(:INPUT_1:FILTER_ON) break;
		case(A3204_N_INPUT_2 + 1) : COPY_PART_NAME(:INPUT_2) break;
		case(A3204_N_INPUT_2_GAIN + 1) : COPY_PART_NAME(:INPUT_2:GAIN) break;
		case(A3204_N_INPUT_2_OFFSET + 1) : COPY_PART_NAME(:INPUT_2:OFFSET) break;
		case(A3204_N_INPUT_2_FILTER + 1) : COPY_PART_NAME(:INPUT_2.FILTER) break;
		case(A3204_N_INPUT_2_OUTPUT + 1) : COPY_PART_NAME(:INPUT_2:OUTPUT) break;
		case(A3204_N_INPUT_2_FILTER_ON + 1) : COPY_PART_NAME(:INPUT_2:FILTER_ON) break;
		case(A3204_N_INPUT_3 + 1) : COPY_PART_NAME(:INPUT_3) break;
		case(A3204_N_INPUT_3_GAIN + 1) : COPY_PART_NAME(:INPUT_3:GAIN) break;
		case(A3204_N_INPUT_3_OFFSET + 1) : COPY_PART_NAME(:INPUT_3:OFFSET) break;
		case(A3204_N_INPUT_3_FILTER + 1) : COPY_PART_NAME(:INPUT_3.FILTER) break;
		case(A3204_N_INPUT_3_OUTPUT + 1) : COPY_PART_NAME(:INPUT_3:OUTPUT) break;
		case(A3204_N_INPUT_3_FILTER_ON + 1) : COPY_PART_NAME(:INPUT_3:FILTER_ON) break;
		case(A3204_N_INPUT_4 + 1) : COPY_PART_NAME(:INPUT_4) break;
		case(A3204_N_INPUT_4_GAIN + 1) : COPY_PART_NAME(:INPUT_4:GAIN) break;
		case(A3204_N_INPUT_4_OFFSET + 1) : COPY_PART_NAME(:INPUT_4:OFFSET) break;
		case(A3204_N_INPUT_4_FILTER + 1) : COPY_PART_NAME(:INPUT_4.FILTER) break;
		case(A3204_N_INPUT_4_OUTPUT + 1) : COPY_PART_NAME(:INPUT_4:OUTPUT) break;
		case(A3204_N_INPUT_4_FILTER_ON + 1) : COPY_PART_NAME(:INPUT_4:FILTER_ON) break;
		case(A3204_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(A3204_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
