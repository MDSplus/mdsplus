...
int l8212_08__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(L8212_08_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(L8212_08_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(L8212_08_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(L8212_08_N_FREQ + 1) : COPY_PART_NAME(:FREQ) break;
		case(L8212_08_N_EXT_CLOCK_IN + 1) : COPY_PART_NAME(:EXT_CLOCK_IN) break;
		case(L8212_08_N_STOP_TRIG + 1) : COPY_PART_NAME(:STOP_TRIG) break;
		case(L8212_08_N_MEMORIES + 1) : COPY_PART_NAME(:MEMORIES) break;
		case(L8212_08_N_HEADER + 1) : COPY_PART_NAME(:HEADER) break;
		case(L8212_08_N_PTS + 1) : COPY_PART_NAME(:PTS) break;
		case(L8212_08_N_NOC + 1) : COPY_PART_NAME(:NOC) break;
		case(L8212_08_N_OFFSET + 1) : COPY_PART_NAME(:OFFSET) break;
		case(L8212_08_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(L8212_08_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
		case(L8212_08_N_INPUT_01 + 1) : COPY_PART_NAME(:INPUT_01) break;
		case(L8212_08_N_INPUT_01_STARTIDX + 1) : COPY_PART_NAME(:INPUT_01:STARTIDX) break;
		case(L8212_08_N_INPUT_01_ENDIDX + 1) : COPY_PART_NAME(:INPUT_01:ENDIDX) break;
		case(L8212_08_N_INPUT_02 + 1) : COPY_PART_NAME(:INPUT_02) break;
		case(L8212_08_N_INPUT_02_STARTIDX + 1) : COPY_PART_NAME(:INPUT_02:STARTIDX) break;
		case(L8212_08_N_INPUT_02_ENDIDX + 1) : COPY_PART_NAME(:INPUT_02:ENDIDX) break;
		case(L8212_08_N_INPUT_03 + 1) : COPY_PART_NAME(:INPUT_03) break;
		case(L8212_08_N_INPUT_03_STARTIDX + 1) : COPY_PART_NAME(:INPUT_03:STARTIDX) break;
		case(L8212_08_N_INPUT_03_ENDIDX + 1) : COPY_PART_NAME(:INPUT_03:ENDIDX) break;
		case(L8212_08_N_INPUT_04 + 1) : COPY_PART_NAME(:INPUT_04) break;
		case(L8212_08_N_INPUT_04_STARTIDX + 1) : COPY_PART_NAME(:INPUT_04:STARTIDX) break;
		case(L8212_08_N_INPUT_04_ENDIDX + 1) : COPY_PART_NAME(:INPUT_04:ENDIDX) break;
		case(L8212_08_N_INPUT_05 + 1) : COPY_PART_NAME(:INPUT_05) break;
		case(L8212_08_N_INPUT_05_STARTIDX + 1) : COPY_PART_NAME(:INPUT_05:STARTIDX) break;
		case(L8212_08_N_INPUT_05_ENDIDX + 1) : COPY_PART_NAME(:INPUT_05:ENDIDX) break;
		case(L8212_08_N_INPUT_06 + 1) : COPY_PART_NAME(:INPUT_06) break;
		case(L8212_08_N_INPUT_06_STARTIDX + 1) : COPY_PART_NAME(:INPUT_06:STARTIDX) break;
		case(L8212_08_N_INPUT_06_ENDIDX + 1) : COPY_PART_NAME(:INPUT_06:ENDIDX) break;
		case(L8212_08_N_INPUT_07 + 1) : COPY_PART_NAME(:INPUT_07) break;
		case(L8212_08_N_INPUT_07_STARTIDX + 1) : COPY_PART_NAME(:INPUT_07:STARTIDX) break;
		case(L8212_08_N_INPUT_07_ENDIDX + 1) : COPY_PART_NAME(:INPUT_07:ENDIDX) break;
		case(L8212_08_N_INPUT_08 + 1) : COPY_PART_NAME(:INPUT_08) break;
		case(L8212_08_N_INPUT_08_STARTIDX + 1) : COPY_PART_NAME(:INPUT_08:STARTIDX) break;
		case(L8212_08_N_INPUT_08_ENDIDX + 1) : COPY_PART_NAME(:INPUT_08:ENDIDX) break;
