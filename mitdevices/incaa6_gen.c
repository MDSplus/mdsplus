...
int incaa6__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(INCAA6_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(INCAA6_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(INCAA6_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(INCAA6_N_INT_CLK_FRQ + 1) : COPY_PART_NAME(:INT_CLK_FRQ) break;
		case(INCAA6_N_CLOCK_IN + 1) : COPY_PART_NAME(:CLOCK_IN) break;
		case(INCAA6_N_CLOCK_OUT + 1) : COPY_PART_NAME(:CLOCK_OUT) break;
		case(INCAA6_N_TRIG_IN + 1) : COPY_PART_NAME(:TRIG_IN) break;
		case(INCAA6_N_TRIG_OUT + 1) : COPY_PART_NAME(:TRIG_OUT) break;
		case(INCAA6_N_MASTER + 1) : COPY_PART_NAME(:MASTER) break;
		case(INCAA6_N_EXT_1MHZ + 1) : COPY_PART_NAME(:EXT_1MHZ) break;
		case(INCAA6_N_PTSC + 1) : COPY_PART_NAME(:PTSC) break;
		case(INCAA6_N_ACTIVE_CHANS + 1) : COPY_PART_NAME(:ACTIVE_CHANS) break;
		case(INCAA6_N_INPUT_1 + 1) : COPY_PART_NAME(:INPUT_1) break;
		case(INCAA6_N_INPUT_1_STARTIDX + 1) : COPY_PART_NAME(:INPUT_1:STARTIDX) break;
		case(INCAA6_N_INPUT_1_ENDIDX + 1) : COPY_PART_NAME(:INPUT_1:ENDIDX) break;
		case(INCAA6_N_INPUT_2 + 1) : COPY_PART_NAME(:INPUT_2) break;
		case(INCAA6_N_INPUT_2_STARTIDX + 1) : COPY_PART_NAME(:INPUT_2:STARTIDX) break;
		case(INCAA6_N_INPUT_2_ENDIDX + 1) : COPY_PART_NAME(:INPUT_2:ENDIDX) break;
		case(INCAA6_N_INPUT_3 + 1) : COPY_PART_NAME(:INPUT_3) break;
		case(INCAA6_N_INPUT_3_STARTIDX + 1) : COPY_PART_NAME(:INPUT_3:STARTIDX) break;
		case(INCAA6_N_INPUT_3_ENDIDX + 1) : COPY_PART_NAME(:INPUT_3:ENDIDX) break;
		case(INCAA6_N_INPUT_4 + 1) : COPY_PART_NAME(:INPUT_4) break;
		case(INCAA6_N_INPUT_4_STARTIDX + 1) : COPY_PART_NAME(:INPUT_4:STARTIDX) break;
		case(INCAA6_N_INPUT_4_ENDIDX + 1) : COPY_PART_NAME(:INPUT_4:ENDIDX) break;
		case(INCAA6_N_INPUT_5 + 1) : COPY_PART_NAME(:INPUT_5) break;
		case(INCAA6_N_INPUT_5_STARTIDX + 1) : COPY_PART_NAME(:INPUT_5:STARTIDX) break;
		case(INCAA6_N_INPUT_5_ENDIDX + 1) : COPY_PART_NAME(:INPUT_5:ENDIDX) break;
		case(INCAA6_N_INPUT_6 + 1) : COPY_PART_NAME(:INPUT_6) break;
		case(INCAA6_N_INPUT_6_STARTIDX + 1) : COPY_PART_NAME(:INPUT_6:STARTIDX) break;
		case(INCAA6_N_INPUT_6_ENDIDX + 1) : COPY_PART_NAME(:INPUT_6:ENDIDX) break;
		case(INCAA6_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
		case(INCAA6_N_STORE_ACTION + 1) : COPY_PART_NAME(:STORE_ACTION) break;
