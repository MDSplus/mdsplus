...
int b5910a__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(B5910A_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(B5910A_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(B5910A_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(B5910A_N_INT_CLOCK + 1) : COPY_PART_NAME(:INT_CLOCK) break;
		case(B5910A_N_EXT_CLOCK + 1) : COPY_PART_NAME(:EXT_CLOCK) break;
		case(B5910A_N_START_TRIG + 1) : COPY_PART_NAME(:START_TRIG) break;
		case(B5910A_N_SAMPLES + 1) : COPY_PART_NAME(:SAMPLES) break;
		case(B5910A_N_ITERATIONS + 1) : COPY_PART_NAME(:ITERATIONS) break;
		case(B5910A_N_NOC + 1) : COPY_PART_NAME(:NOC) break;
		case(B5910A_N_CHANNEL_1 + 1) : COPY_PART_NAME(:CHANNEL_1) break;
		case(B5910A_N_CHANNEL_1_PROGRAMMING + 1) : COPY_PART_NAME(:CHANNEL_1:PROGRAMMING) break;
		case(B5910A_N_CHANNEL_2 + 1) : COPY_PART_NAME(:CHANNEL_2) break;
		case(B5910A_N_CHANNEL_2_PROGRAMMING + 1) : COPY_PART_NAME(:CHANNEL_2:PROGRAMMING) break;
		case(B5910A_N_CHANNEL_3 + 1) : COPY_PART_NAME(:CHANNEL_3) break;
		case(B5910A_N_CHANNEL_3_PROGRAMMING + 1) : COPY_PART_NAME(:CHANNEL_3:PROGRAMMING) break;
		case(B5910A_N_CHANNEL_4 + 1) : COPY_PART_NAME(:CHANNEL_4) break;
		case(B5910A_N_CHANNEL_4_PROGRAMMING + 1) : COPY_PART_NAME(:CHANNEL_4:PROGRAMMING) break;
		case(B5910A_N_CLOCK_OUT + 1) : COPY_PART_NAME(:CLOCK_OUT) break;
		case(B5910A_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
