...
{ 
  ...
  float freq;
  static float freqs[] = {5000,2000,1000,500,200,100,50,20,10,5,2,1,.5,.2,.1,.05,.02,.01};
...
static float setupfreqs[] = {5000,2000,1000,500,200,100,50,20,10,5,2,1,.5,.2,.1,.05,.02,.01};
static float freqs[] = {2E-7,5E-7,1E-6,2E-6,5E-6,1E-5,2E-5,5E-5,1E-4,2E-4,5E-4,1E-3,2E-3,5E-3,1E-2,2E-2,5E-2,1E-1};
