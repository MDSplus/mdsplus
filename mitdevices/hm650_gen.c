...
int hm650__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(HM650_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(HM650_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(HM650_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(HM650_N_THRESHOLD + 1) : COPY_PART_NAME(:THRESHOLD) break;
		case(HM650_N_TRIG_IN_0 + 1) : COPY_PART_NAME(:TRIG_IN_0) break;
		case(HM650_N_TRIG_IN_1 + 1) : COPY_PART_NAME(:TRIG_IN_1) break;
		case(HM650_N_TRIG_IN_2 + 1) : COPY_PART_NAME(:TRIG_IN_2) break;
		case(HM650_N_TRIG_IN_3 + 1) : COPY_PART_NAME(:TRIG_IN_3) break;
		case(HM650_N_TRIG_IN_4 + 1) : COPY_PART_NAME(:TRIG_IN_4) break;
		case(HM650_N_TRIG_IN_5 + 1) : COPY_PART_NAME(:TRIG_IN_5) break;
		case(HM650_N_TRIG_IN_6 + 1) : COPY_PART_NAME(:TRIG_IN_6) break;
		case(HM650_N_TRIG_IN_7 + 1) : COPY_PART_NAME(:TRIG_IN_7) break;
		case(HM650_N_DELAY_0 + 1) : COPY_PART_NAME(:DELAY_0) break;
		case(HM650_N_DELAY_1 + 1) : COPY_PART_NAME(:DELAY_1) break;
		case(HM650_N_DELAY_2 + 1) : COPY_PART_NAME(:DELAY_2) break;
		case(HM650_N_DELAY_3 + 1) : COPY_PART_NAME(:DELAY_3) break;
		case(HM650_N_DELAY_4 + 1) : COPY_PART_NAME(:DELAY_4) break;
		case(HM650_N_DELAY_5 + 1) : COPY_PART_NAME(:DELAY_5) break;
		case(HM650_N_DELAY_6 + 1) : COPY_PART_NAME(:DELAY_6) break;
		case(HM650_N_DELAY_7 + 1) : COPY_PART_NAME(:DELAY_7) break;
		case(HM650_N_TRIG_OUT_0 + 1) : COPY_PART_NAME(:TRIG_OUT_0) break;
		case(HM650_N_TRIG_OUT_1 + 1) : COPY_PART_NAME(:TRIG_OUT_1) break;
		case(HM650_N_TRIG_OUT_2 + 1) : COPY_PART_NAME(:TRIG_OUT_2) break;
		case(HM650_N_TRIG_OUT_3 + 1) : COPY_PART_NAME(:TRIG_OUT_3) break;
		case(HM650_N_TRIG_OUT_4 + 1) : COPY_PART_NAME(:TRIG_OUT_4) break;
		case(HM650_N_TRIG_OUT_5 + 1) : COPY_PART_NAME(:TRIG_OUT_5) break;
		case(HM650_N_TRIG_OUT_6 + 1) : COPY_PART_NAME(:TRIG_OUT_6) break;
		case(HM650_N_TRIG_OUT_7 + 1) : COPY_PART_NAME(:TRIG_OUT_7) break;
		case(HM650_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
...
int hm650__init(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
...
int hm650__trigger(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr)
{
