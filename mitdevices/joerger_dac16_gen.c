...
int joerger_dac16__part_name(struct descriptor *nid_d_ptr, struct descriptor *method_d_ptr, struct descriptor *out_d)
{
	...
	status = TreeGetNci(*(int *)nid_d_ptr->pointer, nci_list);
		if (!(status & 1)) return status;
	switch(element)  {
		case(JOERGER_DAC16_N_HEAD + 1) : StrFree1Dx(out_d); break;
		case(JOERGER_DAC16_N_NAME + 1) : COPY_PART_NAME(:NAME) break;
		case(JOERGER_DAC16_N_COMMENT + 1) : COPY_PART_NAME(:COMMENT) break;
		case(JOERGER_DAC16_N_OUTPUT_01 + 1) : COPY_PART_NAME(:OUTPUT_01) break;
		case(JOERGER_DAC16_N_OUTPUT_02 + 1) : COPY_PART_NAME(:OUTPUT_02) break;
		case(JOERGER_DAC16_N_OUTPUT_03 + 1) : COPY_PART_NAME(:OUTPUT_03) break;
		case(JOERGER_DAC16_N_OUTPUT_04 + 1) : COPY_PART_NAME(:OUTPUT_04) break;
		case(JOERGER_DAC16_N_OUTPUT_05 + 1) : COPY_PART_NAME(:OUTPUT_05) break;
		case(JOERGER_DAC16_N_OUTPUT_06 + 1) : COPY_PART_NAME(:OUTPUT_06) break;
		case(JOERGER_DAC16_N_OUTPUT_07 + 1) : COPY_PART_NAME(:OUTPUT_07) break;
		case(JOERGER_DAC16_N_OUTPUT_08 + 1) : COPY_PART_NAME(:OUTPUT_08) break;
		case(JOERGER_DAC16_N_OUTPUT_09 + 1) : COPY_PART_NAME(:OUTPUT_09) break;
		case(JOERGER_DAC16_N_OUTPUT_10 + 1) : COPY_PART_NAME(:OUTPUT_10) break;
		case(JOERGER_DAC16_N_OUTPUT_11 + 1) : COPY_PART_NAME(:OUTPUT_11) break;
		case(JOERGER_DAC16_N_OUTPUT_12 + 1) : COPY_PART_NAME(:OUTPUT_12) break;
		case(JOERGER_DAC16_N_OUTPUT_13 + 1) : COPY_PART_NAME(:OUTPUT_13) break;
		case(JOERGER_DAC16_N_OUTPUT_14 + 1) : COPY_PART_NAME(:OUTPUT_14) break;
		case(JOERGER_DAC16_N_OUTPUT_15 + 1) : COPY_PART_NAME(:OUTPUT_15) break;
		case(JOERGER_DAC16_N_OUTPUT_16 + 1) : COPY_PART_NAME(:OUTPUT_16) break;
		case(JOERGER_DAC16_N_INIT_ACTION + 1) : COPY_PART_NAME(:INIT_ACTION) break;
