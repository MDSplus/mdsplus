...
extern struct	dsc$descriptor *XmdsXdBoxGetXd();
...
extern struct	dsc$descriptor *XmdsXdBoxGetXd(Widget w);
...
extern void	XmdsXdBoxSetXd(Widget w,struct dsc$descriptor *dsc);
