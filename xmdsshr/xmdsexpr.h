...
extern struct dsc$descriptor *XmdsExprGetXd ();
...
extern struct dsc$descriptor *XmdsExprGetXd (Widget w);
...
extern void XmdsExprSetXd(Widget w, struct dsc$descriptor *dsc);
