...
{
  {XmdsNshowMode, "ShowMode", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.show_mode), XmRImmediate, (XtPointer)NULL},
  {XmdsNshowSelections, "ShowSelections", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.show_selections),
													 XmRImmediate, (XtPointer)NULL},
  {XmdsNstepPlot, "StepPlot", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.step_plot), XmRImmediate, (XtPointer)NULL},
  {XmdsNdisabled, "Disabled", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.disabled), XmRImmediate, (XtPointer)NULL},
  {XmdsNclosed, "Closed", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.closed), XmRImmediate, (XtPointer)NULL},
  ...
  {XmdsNtitle,      "Title",          XmRString,  sizeof(String), XtOffset(XmdsWaveformWidget, waveform.title), XmRImmediate, (XtPointer)NULL},
  {XmdsNpanWith,     "PanWith",       XmRPointer,  sizeof(Widget), XtOffset(XmdsWaveformWidget, waveform.pan_with), XmRImmediate, (XtPointer)NULL},
  {XmdsNcount,       "Count",         XmRInt,     sizeof(int),    XtOffset(XmdsWaveformWidget, waveform.count), XmRImmediate, (XtPointer)NULL},
  ...
  {XmdsNpenDown, "PenDown",  XmRPointer, sizeof(Boolean *), XtOffset(XmdsWaveformWidget, waveform.pen_down_val_ptr), XmRImmediate, (XtPointer)NULL},
  ...
  {XmdsNxValue,     "XValue",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.x.val_ptr), XmRImmediate, (XtPointer)NULL},
  ...
  {XmdsNxMin,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.x.minval), XmRImmediate, (XtPointer)NULL},
  {XmdsNxMax,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.x.maxval), XmRImmediate, (XtPointer)NULL},
  {XmdsNxCrosshair, "Crosshairs",     "Double",  sizeof(double *), XtOffset(XmdsWaveformWidget, waveform.x.crosshair), XmRImmediate, (XtPointer)NULL},
  ...
  {XmdsNyValue,     "YValue",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.y.val_ptr), XmRImmediate, (XtPointer)NULL},
  ...
  {XmdsNyMin,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.y.minval), XmRImmediate, (XtPointer)NULL},
  {XmdsNyMax,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.y.maxval), XmRImmediate, (XtPointer)NULL},
  {XmdsNyCrosshair, "Crosshairs",     "Double",   sizeof(double *), XtOffset(XmdsWaveformWidget, waveform.y.crosshair), XmRImmediate, (XtPointer)NULL},
