...
{
  {XmdsNshowMode, "ShowMode", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.show_mode), XmRImmediate, (XtPointer)0},
  {XmdsNshowSelections, "ShowSelections", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.show_selections),
													 XmRImmediate, (XtPointer)0},
  {XmdsNstepPlot, "StepPlot", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.step_plot), XmRImmediate, (XtPointer)0},
  {XmdsNdisabled, "Disabled", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.disabled), XmRImmediate, (XtPointer)0},
  {XmdsNclosed, "Closed", XmRBoolean, sizeof(Boolean), XtOffset(XmdsWaveformWidget, waveform.closed), XmRImmediate, (XtPointer)0},
  ...
  {XmdsNcrosshairsCallback, "CrosshairsCallback", XmRCallback, sizeof(XtCallbackList),
						   XtOffset(XmdsWaveformWidget, waveform.crosshairs_callback), XmRImmediate, (XtPointer)0},
  ...
  {XmdsNlimitsCallback, "LimitsCallback", XmRCallback, sizeof(XtCallbackList),
					 XtOffset(XmdsWaveformWidget, waveform.limits_callback), XmRImmediate, (XtPointer)0},
  {XmdsNbutton3Callback, "Button3Callback", XmRCallback, sizeof(XtCallbackList),
					 XtOffset(XmdsWaveformWidget, waveform.button3_callback), XmRImmediate, (XtPointer)0},
  {XmdsNunderlayCallback, "UnderlayCallback", XmRCallback, sizeof(XtCallbackList),
					 XtOffset(XmdsWaveformWidget, waveform.underlay_callback), XmRImmediate, (XtPointer)0},
  {XmdsNoverlayCallback, "OverlayCallback", XmRCallback, sizeof(XtCallbackList),
					 XtOffset(XmdsWaveformWidget, waveform.overlay_callback), XmRImmediate, (XtPointer)0},
  {XmdsNtitle,      "Title",          XmRString,  sizeof(String), XtOffset(XmdsWaveformWidget, waveform.title), XmRImmediate, (XtPointer)0},
  {XmdsNpanWith,     "PanWith",       XmRPointer,  sizeof(Widget), XtOffset(XmdsWaveformWidget, waveform.pan_with), XmRImmediate, (XtPointer)0},
  {XmdsNcount,       "Count",         XmRInt,     sizeof(int),    XtOffset(XmdsWaveformWidget, waveform.count), XmRImmediate, (XtPointer)0},
  ...
  {XmdsNselectionsValStruct, "val.struct", XmRPointer, sizeof(XmdsWaveformValStructPtr),
						  XtOffset(XmdsWaveformWidget, waveform.selections_val_struct), XmRImmediate, (XtPointer)0},
  {XmdsNpenDown, "PenDown",  XmRPointer, sizeof(Boolean *), XtOffset(XmdsWaveformWidget, waveform.pen_down_val_ptr), XmRImmediate, (XtPointer)0},
  {XmdsNpenDownValStruct, "val.struct", XmRPointer, sizeof(XmdsWaveformValStructPtr),
						  XtOffset(XmdsWaveformWidget, waveform.pen_down_val_struct), XmRImmediate, (XtPointer)0},
  {XmdsNxValue,     "XValue",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.x.val_ptr), XmRImmediate, (XtPointer)0},
  {XmdsNxValStruct, "val.struct", XmRPointer, sizeof(XmdsWaveformValStructPtr),
						  XtOffset(XmdsWaveformWidget, waveform.x.val_struct), XmRImmediate, (XtPointer)0},
  {XmdsNxMin,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.x.minval), XmRImmediate, (XtPointer)0},
  {XmdsNxMax,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.x.maxval), XmRImmediate, (XtPointer)0},
  {XmdsNxCrosshair, "Crosshairs",     "Double",  sizeof(double *), XtOffset(XmdsWaveformWidget, waveform.x.crosshair), XmRImmediate, (XtPointer)0},
  ...
  {XmdsNyValue,     "YValue",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.y.val_ptr), XmRImmediate, (XtPointer)0},
  {XmdsNyValStruct, "val.struct", XmRPointer, sizeof(XmdsWaveformValStructPtr),
							   XtOffset(XmdsWaveformWidget, waveform.y.val_struct), XmRImmediate, (XtPointer)0},
  {XmdsNyMin,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.y.minval), XmRImmediate, (XtPointer)0},
  {XmdsNyMax,       "Limits",         XmRPointer, sizeof(float *), XtOffset(XmdsWaveformWidget, waveform.y.maxval), XmRImmediate, (XtPointer)0},
  {XmdsNyCrosshair, "Crosshairs",     "Double",   sizeof(double *), XtOffset(XmdsWaveformWidget, waveform.y.crosshair), XmRImmediate, (XtPointer)0},
  ...
  {XmdsNcutCallback, "CutCallback", XmRCallback, sizeof(XtCallbackList),
					 XtOffset(XmdsWaveformWidget, waveform.cut_callback), XmRImmediate, (XtPointer)0},
  {XmdsNpasteCallback, "PasteCallback", XmRCallback, sizeof(XtCallbackList),
					 XtOffset(XmdsWaveformWidget, waveform.paste_callback), XmRImmediate, (XtPointer)0},
};
