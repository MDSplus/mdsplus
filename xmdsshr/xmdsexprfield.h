...
extern struct dsc$descriptor *XmdsExprFieldGetXd ();
...
extern struct dsc$descriptor *XmdsExprFieldGetXd (Widget w);
...
extern void	XmdsExprFieldSetXd(Widget w,struct dsc$descriptor *dsc);
