...
char **charset_xmstring_names_table = charset_xmstring_names_table_vec;
/*
...
externaldef(uil_sym_glbl)
unsigned char *charset_parsing_direction_table = charset_parsdirection_table_vec;
/*
...
externaldef(uil_sym_glbl)
char **charset_lang_names_table = charset_lang_names_table_vec;
/*
...
externaldef(uil_sym_glbl)
unsigned short int *charset_lang_codes_table = charset_lang_codes_table_vec;
/*
 * The number of entries in charset_lang_..._table tables
 */
externaldef(uil_sym_glbl)
unsigned short int charset_lang_table_max = 61;
