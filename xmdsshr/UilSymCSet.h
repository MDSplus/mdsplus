...
static unsigned short int charset_lang_codes_table_vec[] = {
    ...
    sym_k_gb_hanzi_charset,      sym_k_gb_hanzi_charset,
    sym_k_gb_hanzi_gr_charset,   sym_k_gb_hanzi_gr_charset,
    sym_k_iso_arabic_charset,    sym_k_iso_arabic_charset,
    sym_k_iso_arabic_charset,    sym_k_iso_arabic_charset,
    sym_k_iso_arabic_charset,    sym_k_iso_cyrillic_charset,
    sym_k_iso_cyrillic_charset,  sym_k_iso_greek_charset,
    sym_k_iso_greek_charset,     sym_k_iso_greek_charset,
    sym_k_iso_greek_charset,     sym_k_iso_greek_charset,
    sym_k_iso_hebrew_charset,    sym_k_iso_hebrew_charset,
    sym_k_iso_hebrew_charset,    sym_k_iso_hebrew_charset,
    sym_k_iso_hebrew_charset,    sym_k_iso_hebrew_lr_charset,
    sym_k_iso_hebrew_lr_charset, sym_k_iso_hebrew_lr_charset,
    sym_k_iso_latin1_charset,    sym_k_iso_latin1_charset,
    sym_k_iso_latin1_charset,    sym_k_iso_latin1_charset,
    sym_k_iso_latin1_charset,    sym_k_iso_latin2_charset,
    sym_k_iso_latin2_charset,    sym_k_iso_latin2_charset,
    sym_k_iso_latin2_charset,    sym_k_iso_latin3_charset,
    sym_k_iso_latin3_charset,    sym_k_iso_latin3_charset,
    sym_k_iso_latin3_charset,    sym_k_iso_latin4_charset,
    sym_k_iso_latin4_charset,    sym_k_iso_latin4_charset,
    sym_k_iso_latin4_charset,    sym_k_iso_latin5_charset,
    sym_k_iso_latin5_charset,    sym_k_iso_latin5_charset,
    sym_k_iso_latin5_charset,    sym_k_jis_kanji_charset,
    sym_k_jis_kanji_charset,     sym_k_jis_kanji_charset,
    sym_k_jis_kanji_charset,     sym_k_jis_kanji_gr_charset,
    sym_k_jis_kanji_gr_charset,  sym_k_jis_katakana_charset,
    sym_k_jis_katakana_charset,  sym_k_ksc_hangul_charset,
    sym_k_ksc_hangul_charset,    sym_k_ksc_hangul_charset,
    sym_k_ksc_hangul_charset,    sym_k_ksc_hangul_gr_charset,
