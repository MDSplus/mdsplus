...
extern struct dsc$descriptor_xd	*XmdsNidOptionMenuGetXd();
...
struct dsc$descriptor_xd *XmdsNidOptionMenuIdxGetXd();
...
extern struct dsc$descriptor_xd	*XmdsNidOptionMenuGetXd(Widget w);
