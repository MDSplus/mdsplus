...
{
    /**
     * Returns the number of dimensions of the corresponding signal. Currently only unidimensional and bidimensional signals
   ...
   /**
     * Check if absolute or relative times are used. Absolute times are stored as 8 bytes long. The
     * time interpretation in jScope visualization will depend on the jScope.time_format property definition
     * (default is Linux time format, can be EPICS or VMS). Relative times are represented by floating point
     *
