 ...
 * @author manduchi
 */
public class TestWaveData implements WaveData
{
    int type;
    ...
    TestWaveData(float x[], float y[], int numPoints)
    {
        type = Signal.TYPE_1D;
        int len = numPoints;
        if(x.length < len)
    ...
    TestWaveData(double x[], float y[], int numPoints)
    {
        type = Signal.TYPE_1D;
        int len = numPoints;
        if(x.length < len)
    ...
    TestWaveData(float x[], float y[])
    {
        this(x, y, x.length);
    }
    TestWaveData(double x[], float y[])
    {
        this(x, y, x.length);
    }
    TestWaveData(long x[], float y[])
    {
        type = Signal.TYPE_1D;
        int len = x.length;
        if(y.length < len)
    ...
    TestWaveData(float x[], float y[], float z[])
    {
       type = Signal.TYPE_2D;
    ...
    TestWaveData(double x[], float y[], float z[])
    {
       type = Signal.TYPE_2D;
        this.x2D = new float[x.length];
        this.y2D = new float[y.length];
    ...
    TestWaveData(long x[], float y[], float z[])
    {
       type = Signal.TYPE_2D;
        this.x2D = new float[x.length];
        this.y2D = new float[y.length];
