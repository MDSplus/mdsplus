...
EXPORT int __stdcall MdsConnectVB(char *host) { return MdsConnect(host); }

EXPORT void __stdcall MdsDisconnectVB() { MdsDisconnect(); }
...
EXPORT int __stdcall descr4VB(int *dtype, int *n1, int *n2, int *n3,
                              void *value)
{
  if (*dtype == DTYPE_CSTRING)
  {
...
EXPORT int __stdcall descr4VB2(int *dtype, int *n1, int *n2, int *n3,
                               int *len)
{
...
EXPORT int __stdcall MdsValue1VB2(char *expression, int *ansd, void *value,
                                  int *retlen)
{
  return MdsValue2(expression, ansd, value, (int *)&zero, retlen);
}

EXPORT int __stdcall MdsValue2VB(char *expression, int *arg1d, int *ansd,
                                 int *retlen)
{
  return MdsValue(expression, arg1d, ansd, (int *)&zero, retlen);
}

EXPORT int __stdcall MdsValue2VB2(char *expression, int *arg1d, void *arg1v,
                                  int *ansd, void *value, int *retlen)
{
  return MdsValue2(expression, arg1d, arg1v, ansd, value, (int *)&zero, retlen);
}

EXPORT int __stdcall MdsValue3VB(char *expression, int *arg1d, int *arg2d,
                                 int *ansd, int *retlen)
{
  return MdsValue(expression, arg1d, arg2d, ansd, (int *)&zero, retlen);
}

EXPORT int __stdcall MdsValue3VB2(char *expression, int *arg1d, void *arg1v,
                                  int *arg2d, void *arg2v, int *ansd,
                                  void *value, int *retlen)
{
  return MdsValue2(expression, arg1d, arg1v, arg2d, arg2v, ansd, value,
                   (int *)&zero, retlen);
}
...
EXPORT int __stdcall MdsPut1VB2(char *node, char *expression, int *ansd,
                                void *value)
{
  return MdsPut2(node, expression, ansd, value, (int *)&zero);
}

EXPORT int __stdcall MdsPut2VB(char *node, char *expression, int *arg1d,
                               int *ansd)
{
  return MdsPut(node, expression, arg1d, ansd, (int *)&zero);
}

EXPORT int __stdcall MdsPut2VB2(char *node, char *expression, int *arg1d,
                                void *arg1v, int *ansd, void *value)
{
  return MdsPut2(node, expression, arg1d, arg1v, ansd, value, (int *)&zero);
}

EXPORT int __stdcall MdsPut3VB(char *node, char *expression, int *arg1d,
                               int *arg2d, int *ansd)
{
  return MdsPut(node, expression, arg1d, arg2d, ansd, (int *)&zero);
}

EXPORT int __stdcall MdsPut3VB2(char *node, char *expression, int *arg1d,
                                void *arg1v, int *arg2d, void *arg2v, int *ansd,
                                void *value)
{
  return MdsPut2(node, expression, arg1d, arg1v, arg2d, arg2v, ansd, value,
                 (int *)&zero);
}
