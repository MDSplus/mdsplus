...
#define DEV$_BAD_ENDIDX           0x277c800a
#define DEV$_BAD_FILTER           0x277c8012
#define DEV$_BAD_FREQ             0x277c801a
#define DEV$_BAD_GAIN             0x277c8022
#define DEV$_BAD_HEADER           0x277c802a
#define DEV$_BAD_HEADER_IDX       0x277c8032
#define DEV$_BAD_MEMORIES         0x277c803a
#define DEV$_BAD_MODE             0x277c8042
#define DEV$_BAD_NAME             0x277c804a
#define DEV$_BAD_OFFSET           0x277c8052
#define DEV$_BAD_STARTIDX         0x277c805a
#define DEV$_NOT_TRIGGERED        0x277c8062
#define DEV$_FREQ_TO_HIGH         0x277c806a
#define DEV$_INVALID_NOC          0x277c8072
#define DEV$_RANGE_MISMATCH       0x277c807a
#define DEV$_CAMACERR             0x277c8082
#define DEV$_BAD_VERBS            0x277c808a
#define DEV$_BAD_COMMANDS         0x277c8092
#define DEV$_CAM_ADNR             0x277c809a
#define DEV$_CAM_ERR              0x277c80a2
#define DEV$_CAM_LOSYNC           0x277c80aa
#define DEV$_CAM_LPE              0x277c80b2
#define DEV$_CAM_TMO              0x277c80ba
#define DEV$_CAM_TPE              0x277c80c2
#define DEV$_CAM_STE              0x277c80ca
#define DEV$_CAM_DERR             0x277c80d2
#define DEV$_CAM_SQ               0x277c80da
#define DEV$_CAM_NOSQ             0x277c80e2
#define DEV$_CAM_SX               0x277c80ea
#define DEV$_CAM_NOSX             0x277c80f2
#define DEV$_INV_SETUP            0x277c80fa
