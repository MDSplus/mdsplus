...
EXPORT int XTreeGetTimedRecord(int nid, struct descriptor *startD,
                               struct descriptor *endD,
                               struct descriptor *minDeltaD,
                               struct descriptor_xd *outSignal);
EXPORT int XTreeDefaultResample(struct descriptor_signal *currSignal,
                                struct descriptor *startD,
                                struct descriptor *endD,
                                struct descriptor *minDeltaD,
                                struct descriptor_xd *outSignal);
EXPORT int XTreeDefaultSquish(struct descriptor_a *signalApd,
                              struct descriptor *startD,
                              struct descriptor *endD,
                              struct descriptor *minDeltaD,
                              struct descriptor_xd *outSignal);
...
// static int TreeGetXNci(int nid, char *nciname, struct descriptor_xd
// *retValue)
//{
