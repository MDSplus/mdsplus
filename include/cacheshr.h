...
extern int RTreePutSegment(int nid, nt segIdx, struct descriptor_a *dataD, int writeMode);
extern int RTreePutTimestampedSegment(int nid, struct descriptor_a *dataD, _int64 *timestamps, int writeMode);
