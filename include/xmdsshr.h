...
extern int XmdsDeviceSetup(Widget parent, int *nid, String uids[], Cardinal num_uids, String ident,
...
extern int XmdsPutNidValue(int nid, unsigned short length, unsigned char dtype, char *pointer,
			   char *originalValue);
...
extern int XmdsSetSubvalues(void *record, XtResourceList resources, Cardinal num_resources,
