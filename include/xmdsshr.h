...
extern EXPORT int XmdsDeviceSetup(Widget parent, int *nid, String uids[],
...
extern EXPORT int XmdsGetNidFloatOption(int nid, float *options,
                                        int numOptions);
extern EXPORT int XmdsGetNidIntOption(int nid, int *options, int numOptions);
extern EXPORT int XmdsGetNidLongValue(int nid, int minVal, int maxVal,
                                      int defaultVal);
...
extern EXPORT int XmdsPutNidValue(int nid, unsigned short length,
                                  unsigned char dtype, char *pointer,
                                  char *originalValue);
...
extern EXPORT int XmdsSetSubvalues(void *record, XtResourceList resources,
...
extern EXPORT void XmdsWaveformPrint(Widget w, FILE *fid, int width, int height,
                                     int rotate, char *title,
                                     char *window_title, int inp_resolution);
extern EXPORT void XmdsWaveformReverse(Widget w, int reverse);
extern EXPORT void XmdsWaveformSetCrosshairs(Widget w, float *x, float *y,
                                             Boolean attach);
extern EXPORT void XmdsWaveformUpdate(Widget w, XmdsWaveformValStruct *x,
...
extern EXPORT Widget XmdsCreateWaveform(Widget parent, char *name, ArgList args,
                                        Cardinal argcount);
...
extern EXPORT Widget XmdsCreateXdBoxDialog(Widget parent, char *name,
