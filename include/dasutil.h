...
int cmd_lookup(char **s,	/* <m> Ptr within command string        */
		 ...
		 * dasmsg, ipcsmsg, etc.:
		 *=====================================================*/
EXPORT extern int dasmsg(int sts,	/* <r> Status code: 0=nomsg 1=nomsg(vms only)   */
		 ...
		 * order ...
		 *======================================================*/
int order(int (*cmp) (),	/* <r> addr of comparison routine for subj array.
				 *     cmp(i,j) returns:
...
int ordloc(void *subjx,		/* <r> "subject" element:  find its position    */
	   ...
	   int *num		/* <r> number of entries already ordered        */
		 ...
		 * nonblank, etc ...
		 *=====================================================*/
char *nonblank(char *p		/* <r> Addr of start of string          */
    );
char *blank(char *p		/* <r> Addr of start of string          */
    );
int strtrim(char to[]		/* <w/m> Destination string                 */
	    , char from[]	/* <r:opt> Source string                    */
    );
int strntrim(char to[]		/* <w/m> Destination string                 */
	     , char from[]	/* <r:opt> Source string                    */
	     , int fromLen	/* <r> Length of source string                  */
    );
void remove_commas(char str[]	/* <m> string to operate upon               */
    );

char *l2u(char *p		/* <m> string to modify                         */
	  , char *t		/* <r:opt> source string                        */
    );
char *l2un(char to[],		/* <w> destination string                       */
	   char from[],		/* <r> source string                            */
	   int n		/* <r> number of characters in from[]           */
    );
char *u2l(char *p		/* <m> string to modify                         */
	  , char *t		/* <r:opt> source string                        */
    );
char *u2ln(char to[],		/* <w> destination string                       */
	   char from[],		/* <r> source string                            */
	   int n		/* <r> number of characters in from[]           */
    );
int bcd2i(unsigned int bcd	/* <r> bcd val, 4 bits per digit, max 8 digits  */
    );
int i2bcd(			/* bcd val, 4 bits per digit, max 8 digits      */
	   unsigned int ival	/* <r> integer value to convert                 */
    );

int wildcard_match(char *s,	/* <r> input pattern, may contain wildcards     */
...
int wc_match(char *s,		/* <r> input pattern, may contain wildcards     */
	     char *t		/* <r> comparison string                        */
    );
...
EXPORT extern int str_prefix(struct descriptor *dsc_ret	/* <w> Destination string       */
...
EXPORT extern char *str_dupl_char(	/* Returns: dsc_ret->dscA_pointer */
		 ...
		 *======================================================*/
int tknlen(char *s,		/* <r> addr of start of token           */
	   char usrTerminators[]	/* <r:opt> string of "terminator" chars     */
    );
int ascToken(char **s		/* <m> Addr of ptr to input string              */
...
int nextToken(char **s,		/* <m> addr of ptr to char string       */
	      struct descriptor *dsc_token,	/* <w> return token here        */
...
int longToken(char **s,		/* <m> addr of ptr to char string       */
	      struct descriptor *dsc_token,	/* <w> return token here        */
	      int *utknLen,	/* <w:opt> token length <longword>      */
	      int *uval		/* <w:opt> return int  value here       */
    );
int doubleToken(char **s,	/* <m> addr of ptr to char string       */
		struct descriptor *dsc_token,	/* <w> return token here        */
		int *utknLen,	/* <w:opt> token length <longword>      */
		double *uval	/* <w:opt> return double value here     */
    );
int ascFilename(char **s	/* <m> addr from which to start search  */
...
int equalsAscToken(char **s	/* <m> addr from which to start search          */
		   , struct descriptor *dsc	/* <w> return token here        */
		   , int *utknLen	/* <w:opt> length of token (2-byte word)        */
		   , char optAlph[]	/* <r:opt> User-defined alph extensions             */
    );
int equalsLongToken(char **s,	/* <m> addr of ptr to char string       */
		    struct descriptor *dsc_token,	/* <w> return token here        */
		    int *utknLen,	/* <w:opt> token length <longword>      */
		    int *uval	/* <w:opt> return int  value here       */
    );
int equalsDoubleToken(char **s,	/* <m> addr of ptr to char string       */
		      struct descriptor *dsc_token,	/* <w> return token here        */
		      int *utknLen,	/* <w:opt> token length <longword>      */
		      double *uval	/* <w:opt> return double value here     */
    );
int equalsAscFilename(char **s	/* <m> addr from which to start search          */
		      , struct descriptor *dsc	/* <w> return token here        */
		      , int *utknLen	/* <w:opt> length of token                      */
    );
...
void termio_init(int argc, char *argv[]
    );
void clearnext(int showFlag	/* <r> 1:show deleted line  0:no msg    */
    );
void putNext(void *dsc_text	/* <r> string or descr: text to place   */
	     , int flag		/* <r> 0:atEnd 1:clear 2:atStart        */
    );
char *getString_linePtr();
char *getString_startOfLine();
void bumpString_linePtr();
int getString(void *dsc_prompt	/* <r> string or descr: prompt string   */
	      , struct descriptor *dsc_val	/* <m> string returned          */
	      , char alphExtensions[]	/* <r:opt> other legal 1st chars */
    );
int getLine(void *dsc_prompt	/* <r> string or descr: prompt string   */
	    , struct descriptor *dsc_val	/* <m> string returned          */
    );
int getDouble(void *dsc_prompt	/* <r> string or descr: prompt string   */
...
int getLong(void *dsc_prompt	/* <r> string or descr: prompt string   */
	    , int *val		/* <m> data value                       */
	    , int *valMin	/* <opt:r> lower data limit             */
	    , int *valMax	/* <opt:r> upper data limit             */
	    , struct descriptor *dsc_userFlag	/* <opt:w> 1-char "flag"        */
    );
int getFloat(void *dsc_prompt	/* <r> string or descr: prompt string   */
	     , float *val	/* <m> data value                       */
	     , float *valMin	/* <opt:r> lower data limit             */
	     , float *valMax	/* <opt:r> upper data limit             */
	     , struct descriptor *dsc_userFlag	/* <opt:w> 1-char "flag"        */
    );
int getFilename(void *dsc_prompt	/* <r> string or descr: prompt string   */
		, struct descriptor *dsc_val	/* <m> string returned          */
    );
int getEqualsLong(void *dsc_prompt	/* <r> string or descr: prompt string   */
		  , int *val	/* <m> data value                       */
		  , int *valMin	/* <opt:r> lower data limit             */
		  , int *valMax	/* <opt:r> upper data limit             */
		  , struct descriptor *dsc_userFlag	/* <opt:w> 1-char "flag"        */
    );
int getEqualsString(void *dsc_prompt	/* <r> string or descr: prompt string   */
		    , struct descriptor *dsc_val	/* <m> string returned          */
		    , char alphExtensions[]	/* <r:opt> other legal 1st chars */
    );
int getEqualsFilename(void *dsc_prompt	/* <r> string or descr: prompt string   */
		      , struct descriptor *dsc_val	/* <m> string returned          */
    );
int getYesno(void *dsc_prompt	/* <r> string or descr: prompt string   */
	     , int ynDefault	/* <r> default:  1=Y  0=N               */
    );
int getCmd(void *prompt		/* <r> Prompt string (char or dsc)      */
	   ...
	   , int flags		/* <r> Flags: 1=NoMsg                   */
		 ...
		 *=====================================================*/
char *getstr();
int yesno(int v			/* Default response: 0=false  nonZero=true      */
    );
int interactive();
...
EXPORT extern void set_pgmname(char *name);
char *procname(int pid		/* <r:opt> process id                           */
    );
char *procname_dsc(int pid	/* <r:opt> process id                   */
		   , struct descriptor *dsc	/* <w> process name returned here       */
    );

char *trnlnm(char name[],	/* <r> name to translate (environment variable) */
...
char *now();
int asc2time(char ascString[]	/* <r> DateString: dd-mmm-yy[yy] hh:mm:ss */
