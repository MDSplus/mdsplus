...
#include <mdsdescrip.h>
  ...
  extern EXPORT int _TreeAbsPathDsc(void *dbid, char const *in, mdsdsc_t *out_ptr);
  ...
  extern EXPORT int _TreeCompressDatafile(void **dbid, char const* tree, int shot);
  ...
  extern EXPORT int TreeCreateTreeFiles(char const* tree, int shot, int source_shot);
  ...
  extern EXPORT char *_TreeGetPath(void *dbid, int nid);
						       /********** Use TreeFree(result) *****/
  extern EXPORT int TreeGetMinimumPathDsc(int *def_nid, int nid, mdsdsc_xd_t *out_ptr);
  extern EXPORT int _TreeGetMinimumPathDsc(void *dbid, int *def_nid, int nid, mdsdsc_xd_t *out_ptr);
  ...
  extern EXPORT int TreePutRecord(int nid, mdsdsc_t *descriptor_ptr, int utility_update);
  ...
  extern EXPORT int TreeRundownTree(mdsdsc_t *treenam, int *shotid, int single_tree,
				    int force_exit);
...
//Segments
  ...
  extern EXPORT int TreeBeginSegmentResampled(int nid, mdsdsc_t *start, mdsdsc_t *end,
                                     mdsdsc_t *dim, mdsdsc_a_t *initialData,
                                     int idx, int resNid, int resFactor);
  extern EXPORT int _TreeBeginSegmentResampled(void *dbid, int nid, mdsdsc_t *start,
                                      mdsdsc_t *end, mdsdsc_t *dim,
                                      mdsdsc_a_t *initialData, int idx, int resNid, int resFactor);
  extern EXPORT int TreeBeginSegmentMinMax(int nid, mdsdsc_t *start, mdsdsc_t *end,
                                     mdsdsc_t *dim, mdsdsc_a_t *initialData,
                                     int idx, int resNid, int resFactor);
  ...
  extern EXPORT int TreePutSegmentResampled(int nid, const int rowidx, mdsdsc_a_t *data, int resNid, int resFactor);
  extern EXPORT int _TreePutSegmentResampled(void *dbid, int nid, const int rowidx, mdsdsc_a_t *data, int resNid, int resFactor);
  extern EXPORT int TreePutSegmentMinMax(int nid, const int rowidx, mdsdsc_a_t *data, int resNid, int resFactor);
  extern EXPORT int _TreePutSegmentMinMax(void *dbid, int nid, const int rowidx, mdsdsc_a_t *data, int resNid, int resFactor);
  ...
  extern EXPORT int TreeMakeTimestampedSegment(int nid, int64_t * timestamp,
					       mdsdsc_a_t *rowdata, int idx, int filled);
  ...
  extern EXPORT int TreeGetSegment(int nid, int segidx, mdsdsc_xd_t *data,
				   mdsdsc_xd_t *dim);
  extern EXPORT int _TreeGetSegment(void *dbid, int nid, int segidx, mdsdsc_xd_t *data,
				    mdsdsc_xd_t *dim);
  ...
  extern EXPORT int TreeGetSegmentTimesXd(int nid, int *numsegs, mdsdsc_xd_t *start_list,
					  mdsdsc_xd_t *end_list);
  extern EXPORT int _TreeGetSegmentTimesXd(void *dbid, int nid, int *numsegs,
					   mdsdsc_xd_t *start_list,
					   mdsdsc_xd_t *end_list);

  extern EXPORT int TreeGetXNci(int nid, const char *xnciname, mdsdsc_xd_t *value);
  extern EXPORT int _TreeGetXNci(void *dbid, int nid, const char *xnciname, mdsdsc_xd_t *value);
  ...
  extern EXPORT int TreeFindNodeTagsDsc(int nid_in, void **ctx_ptr, mdsdsc_t *tag);
