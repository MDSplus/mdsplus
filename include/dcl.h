...
extern int mdsdcl_do_command_dsc(char const *command, struct descriptor_xd *error_dsc, struct descriptor_xd *output_dsc);
extern int _mdsdcl_do_command_dsc(void* dbid, char const *command, struct descriptor_xd *error_dsc, struct descriptor_xd *output_dsc);
