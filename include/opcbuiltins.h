...
OPC (	Hbar,		$HBAR,		Constant,	undef,	Hbar,		F,HC,	F,HC,	0,0,	CONST	)/*;	2*pi*Planck 		*/
...
OPC (	Pi,		$PI,		Constant,	undef,	Pi,		F,HC,	F,HC,	0,0,	CONST	)/*;	pi			*/
...
OPC (	AsIs,		AS_IS,		AsIs,		undef,	undef,		XX,YY,	XX,YY,	1,1,	MODIFA+N)/*;mds	(any) unevaluated	*/
...
OPC (	In,		IN,		Else,		undef,	undef,		XX,YY,	XX,YY,	1,1,	MODIFA+N)/*;	IN a	read only	*/
...
OPC (	InOut,		INOUT,		Else,		undef,	undef,		XX,YY,	XX,YY,	1,1,	MODIFA+N)/*;	INOUT a	read/write	*/
...
OPC (	Optional,	OPTIONAL,	Else,		undef,	undef,		XX,YY,	XX,YY,	1,1,	MODIFA+N)/*;	OPTIONAL a		*/
...
OPC (	Out,		OUT,		Else,		undef,	undef,		XX,YY,	XX,YY,	1,1,	MODIFA+N)/*;	OUT a	write only	*/
