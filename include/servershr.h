...
EXPORT extern int ServerBuildDispatchTable(char *wildcard, char *monitor_name,
                                           void **table);
...
EXPORT extern int ServerDispatchPhase(int *id, void *vtable, char *phasenam,
                                      char noact_in, int sync,
                                      void (*output_rtn)(),
                                      const char *monitor);
