...
#define DESCRIPTOR_A_BOUNDS(name, len, type, ptr, dimct, arsize)               \
  ...
  name = {(length_t)len,   type,  CLASS_A, (char *)ptr, 0,   0,                \
          {0, 1, 1, 1, 1}, dimct, arsize,  0,           {0}, {{0, 0}}}
...
#define EMPTYXD(name) mdsdsc_xd_t name = {0, DTYPE_DSC, CLASS_XD, 0, 0}
...
#define DESCRIPTOR_CA(name, len, type, ptr, arsize)                            \
  ARRAY(mdsdsc_t)                                                              \
  name = {(length_t)len,   type, CLASS_CA, (mdsdsc_t *)ptr, 0, 0,              \
          {0, 1, 1, 0, 0}, 1,    arsize}
