...
public class TwuProperties
{
	...
	{
		final String ln0str = signalProps.getProperty("Length.dimension.0");
	...
	{
		final String ln1str = signalProps.getProperty("Length.dimension.1");
	...
	{
		final String abscissa = signalProps.getProperty("Abscissa.URL.1");
		return ((abscissa == null) ? false : (!abscissa.equalsIgnoreCase("None")));
	}
	...
	{
		final String abs = signalProps.getProperty("Abscissa.URL.1");
		return ((abs == null || abs.equalsIgnoreCase("None")) ? null : abs);
	}
	/* -------------------------------------------------------------------- */
