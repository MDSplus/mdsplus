 ...
 * register themselves by means of DataProvider.addConnectionListener() method. In order to notify jScope
 * of connection event (current data size increased in read, lost connection ...) method processConnectionEvent()
