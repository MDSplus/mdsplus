...
public final class AnyEditor extends TextEditor{
	...
	protected final boolean addExtraEditor() {
		...
		switch(this.curr_mode_idx - this.mode_idx_usr){
			case 0:
				this.editor.add(this.data_edit = new mds.jtraverser.editor.ActionEditor(this.editable, this.ctx, this.window));
				return true;
			case 1:
				this.editor.add(this.data_edit = new mds.jtraverser.editor.PythonEditor(this.editable, this.ctx));
				return true;
			case 2:
				this.editor.add(this.data_edit = new mds.jtraverser.editor.SignalEditor(this.data, this.editable, this.ctx, this.window));
				return true;
			case 3:
	...
	private final int getUsrMode() {
		if(mds.jtraverser.editor.ActionEditor.checkData(this.data)) return 0;
		if(mds.jtraverser.editor.PythonEditor.checkData(this.data)) return 1;
		if(mds.jtraverser.editor.SignalEditor.checkData(this.data)) return 2;
		if(mds.jtraverser.editor.WindowEditor.checkData(this.data)) return 3;
		if(mds.jtraverser.editor.MethodEditor.checkData(this.data)) return 4;
		if(mds.jtraverser.editor.RoutineEditor.checkData(this.data)) return 5;
		if(mds.jtraverser.editor.ProgramEditor.checkData(this.data)) return 6;
		if(mds.jtraverser.editor.ProcedureEditor.checkData(this.data)) return 7;
		return -1;
	}
}