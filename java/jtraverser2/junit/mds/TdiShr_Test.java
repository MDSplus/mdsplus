...
public class TdiShr_Test{
	...
	Assert.assertEquals(new Int32Array(1, 2), TdiShr_Test.tdishr.tdiIntrinsic(null, OPC.OpcCompile, new StringDsc("[1,2]")).getData());
	Assert.assertEquals(new Int32Array(0, 0), TdiShr_Test.tdishr.tdiExecute(null, "zero(2,1)").getData());
	Assert.assertEquals(new Int32(3), TdiShr_Test.tdishr.tdiEvaluate(null, new Add(new Int32(1), new Int32(2))).getData());
    }
}
