...
/**
 * This interface is not actually implemented by any Tree class. It is meant to
 * be used in conjunction with the new real time events in order to define data
 * pipes
 *
 * @author manduchi
 * @version 1.0
