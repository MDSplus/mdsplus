...
public class MdsDataTest{
	...
	public void testData() throws MDSplus.MdsException {
		...
		data = new MDSplus.Int32(123123, new MDSplus.String("help"), new MDSplus.String("units"), new MDSplus.String("error"), new MDSplus.String("validation"));
		...
		MDSplus.Data data1 = new MDSplus.Int32(5552368);
		MDSplus.Data data2 = new MDSplus.Int32(5552368);
