...
public class MdsExpressionCompileTest{
	...
	public void testData(){
		...
		Assert.assertArrayEquals(new int[]{1,2,3}, retData.getIntArray());
		...
		retData = MDSplus.Data.execute("$1+$2;", new MDSplus.Data[]{new MDSplus.Int32(2), new MDSplus.Int32(4)});
		Assert.assertEquals(6, retData.getInt());
		retData = MDSplus.Data.compile("$1+$2;", new MDSplus.Data[]{new MDSplus.Int32(2), new MDSplus.Int32(4)});
