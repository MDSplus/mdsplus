...
public class MdsTreeNodeTest {
	...
	public static void setUpBeforeClass() throws Exception {
		Data currDir = Data.toData(System.getProperty("user.dir"));
		MDSplus.Data.execute("setenv($//$)", new MDSplus.Data[] { Data.toData("java_test1_path="), currDir });
		MDSplus.Data.execute("setenv($//$)", new MDSplus.Data[] { Data.toData("java_test2_path="), currDir });
	}
	...
	public void testData() throws Exception {
		...
		byte image[] = new byte[] { 0, 0, 0, 0, 9, 9, 0, 0, 0, 0, 0, 0, 9, 9, 9, 0, 0, 0, 0, 0, 0, 9, 9, 9, 0, 0, 0, 1,
				1, 1, 1, 9, 9, 1, 1, 1, 1, 1, 1, 1, 9, 9, 1, 1, 1, 0, 0, 9, 9, 9, 9, 9, 0, 0, 0, 0, 9, 9, 9, 9, 9, 0, 0,
				0, 0, 0, 9, 9, 9, 0, 0, 0, 0, 0, 9, 9, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 9, 0, 0, 1, 1, 1, 1, 9, 9, 9, 1,
				1, 1, 1, 1, 9, 9, 1, 1, 1, 1, 0, 0, 9, 9, 9, 9, 9, 0, 0, 0, 0, 9, 9, 9, 9, 9, 0, 0, 0, 0, 9, 9, 9, 9, 9,
				0, 0, 0, 0, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 0, 9, 9, 0, 0, 0, 1, 1, 1, 9, 9, 9, 1, 1, 1, 1, 1, 1, 1, 1, 9,
				9, 1, 1, 0, 0, 9, 9, 9, 9, 9, 0, 0, 0, 0, 9, 9, 9, 9, 0, 0, 0, 0, 0, 0, 0, 9, 9, 9, 0, 0, 0, 0, 0, 9, 9,
				9, 0, 0, 0, 0, 0, 9, 9, 9, 0, 0, 0, 0, 1, 1, 9, 9, 9, 9, 9, 1, 1, 1, 1, 9, 9, 9, 9, 9, 1, 1, 0, 0, 0, 0,
				0, 9, 9, 0, 0, 0, 0, 0, 0, 0, 9, 9, 0, 0 };
