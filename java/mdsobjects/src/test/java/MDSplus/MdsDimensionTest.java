...
public class MdsDimensionTest {
	...
	public void testData() throws MDSplus.MdsException {
		...
		MDSplus.Window window = new MDSplus.Window(new MDSplus.Float32(-9), new MDSplus.Float32(0),
		...
		dim.setWindow(new MDSplus.Window(new MDSplus.Float32((float) -9), new MDSplus.Float32((float) 0),
