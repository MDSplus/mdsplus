 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_DTT_PROXY_OUTSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_DTT_PROXY_OUTSetup
     */
    public MARTE2_SIMULINK_DTT_PROXY_OUTSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("DTT Plasma Proxy Out");
        setDeviceType("marte2_simulink_dtt_proxy_out");
        setHeight(300);
        setWidth(500);
