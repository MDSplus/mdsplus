 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_TCVSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_TCVSetup
     */
    public MARTE2_SIMULINK_TCVSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("TCV Plasma Simulator");
        setDeviceType("MARTE2_SIMULINK_TCV");
        setHeight(300);
        setUpdateEvent("");
        setWidth(500);
