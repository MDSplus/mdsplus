 ...
 * @author mdsplus
 */
public class MARTE2_GETPOSESetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_GETPOSESetup
     */
    public MARTE2_GETPOSESetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("MARTe2 GetPose");
        setDeviceType("MARTE2_GETPOSE");
        setHeight(400);
        setWidth(500);
        ...
        deviceOutputs1.setOffsetNid(31);
