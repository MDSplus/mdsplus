...
public class MARTE2_NI6259Setup extends DeviceSetup
{
	...
	private void initComponents()
	{
		...
		{ "SI_TC", "PFI0", "PFI1", "PFI2", "PFI3", "PFI4", "PFI5", "PFI6", "PFI7", "PFI8", "PFI9", "PFI10", "PFI11",
				"PFI12", "PFI13", "PFI14", "PFI15", "RTSI0", "RTSI1", "RTSI2", "RTSI3", "RTSI4", "RTSI5", "RTSI6",
				"RTSI7", "RTSI8", "RTSI9", "RTSI10", "RTSI11", "RTSI12", "RTSI13", "RTSI14", "RTSI15", "RTSI16",
				"RTSI17", "PULSE", "GPCRT0_OUT", "STAR_TRIGGER", "GPCTR1_OUT", "SCXI_TRIG1", "ANALOG_TRIGGER", "LOW" });
		...
		{ "ACTIVE_HIGH_OR_RISING_EDGE", "ACTIVE_LOW_OR_FALLING_EDGE" });
		...
		{ "SI2TC", "PFI0", "PFI1", "PFI2", "PFI3", "PFI4", "PFI5", "PFI6", "PFI7", "PFI8", "PFI9", "PFI10", "PFI11",
				"PFI12", "PFI13", "PFI14", "PFI15", "RTSI0", "RTSI1", "RTSI2", "RTSI3", "RTSI4", "RTSI5", "RTSI6",
				"RTSI7", "RTSI8", "RTSI9", "RTSI10", "RTSI11", "RTSI12", "RTSI13", "RTSI14", "RTSI15", "RTSI16",
				"RTSI17", "PULSE", "GPCRT0_OUT", "STAR_TRIGGER", "ANALOG_TRIGGER", "LOW" });
