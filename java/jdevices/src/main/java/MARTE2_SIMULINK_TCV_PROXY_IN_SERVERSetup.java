 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_TCV_PROXY_IN_SERVERSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_TCV_PROXY_IN_SERVERSetup
     */
    public MARTE2_SIMULINK_TCV_PROXY_IN_SERVERSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("");
        setDeviceType("MARTE2_SIMULINK_TCV_PROXY_IN_SERVER");
        setHeight(300);
        setWidth(500);
