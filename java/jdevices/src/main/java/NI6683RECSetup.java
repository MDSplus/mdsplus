...
public class NI6683RECSetup extends DeviceSetup {
    ...
    private void initComponents() {
        ...
        deviceButtons1.setMethods(new String[] {"init start stop"});
        ...
        deviceChoice4.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice2.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        deviceChoice3.setChoiceItems(new String[] {"PXI6682", "PCI1588", "PXI6683 ", "PXI6683H"});
        ...
        deviceChoice6.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice7.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice8.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice9.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice10.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice11.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice12.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice13.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice14.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice15.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice16.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice17.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice18.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice19.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
        ...
        */
        ...
        deviceChoice20.setChoiceItems(new String[] {"PFI0", "PFI1", "PFI2", "TRIG0", "TRIG1", "TRIG2", "TRIG3", "TRIG4", "TRIG5", "TRIG6", "TRIG7"});
        ...
        deviceChoice21.setChoiceItems(new String[] {"RISING", "FALLING", "ANY"});
    ...
    {
        MyTableModel mtbm = (MyTableModel)(tb.getModel());
...
*/
        ...
        //System.out.println("subtree " + subtree + " evt.getPropertyName() "+ evt.getPropertyName());
    ...
    private void jTable8ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jTable8ComponentShown
        // TODO add your handling code here:
    ...
    private void jTable9ComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jTable9ComponentShown
        // TODO add your handling code here:
    }//GEN-LAST:event_jTable9ComponentShown

    private void jTable9PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTable9PropertyChange
        // TODO add your handling code here:
        if( evt.getPropertyName().equals("tableCellEditor") )
           return;
    ...
    class MyTableModel extends javax.swing.table.AbstractTableModel {
        ...
        private String[] columnNames = { "Event n.", "Absolute Time", "Relative Time" };
        
        private Object data[][];
        
        private int TRIGGER_INC = 7;
        private int TRIGGER_1 = 12;
        private int NI6683REC_TIME = 7;
        private int NI6683REC_UTC_NS  = 6;
        ...
        public void initTable(int trigIdx)
        {
            ...
            try { 
                ...
                {
                    String s = (timeStr.substring(1, timeStr.length()-1));
                    StringTokenizer st = new StringTokenizer(s,",");
                    int numTimes = st.countTokens();

                    String s1 = (utcStr.substring(1, utcStr.length()-1)).replace("Q", "");
                    StringTokenizer st1 = new StringTokenizer(s1,",");

                    DateFormat df = new SimpleDateFormat("dd MMM yyyy hh:mm:ss mmm.");
                    long UTCdateInMS;
                    long UTCdateInNS;
                    Date d ;
