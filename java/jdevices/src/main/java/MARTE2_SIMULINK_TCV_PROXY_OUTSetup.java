 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_TCV_PROXY_OUTSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_TCV_PROXY_OUTSetup
     */
    public MARTE2_SIMULINK_TCV_PROXY_OUTSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("SimulinkPeoxyOut");
        setDeviceType("MARTE2_SIMULINK_TCV_PROXY_OUT");
        setHeight(300);
        setWidth(500);
