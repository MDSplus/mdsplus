 ...
 * @author mdsplus
 */
public class MARTE2_ELADSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_ELADSetup
     */
    public MARTE2_ELADSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("MARTE2_ELAD  Setup");
        setDeviceType("MARTE2_ELAD");
        setHeight(500);
        setWidth(900);
