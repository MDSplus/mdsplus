 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_DTT_PROXY_IN_SERVERSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_DTT_PROXY_IN_SERVERSetup
     */
    public MARTE2_SIMULINK_DTT_PROXY_IN_SERVERSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("DTT Plasma Proxy server in");
        setDeviceType("marte2_simulink_dtt_proxy_in_server");
        setHeight(300);
        setWidth(500);
