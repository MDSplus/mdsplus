 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_TCV_VSSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_TCV_VSSetup
     */
    public MARTE2_SIMULINK_TCV_VSSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("TCV VS Controller");
        setDeviceType("MARTE2_SIMULINK_TCV_VS");
        setHeight(300);
        setUpdateEvent("");
        setWidth(500);
