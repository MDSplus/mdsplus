 ...
 * @author mdsplus
 */
public class MARTE2_STMINSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_STMINSetup
     */
    public MARTE2_STMINSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("STM Inputs");
        setDeviceType("MARTE2_STMIN");
        setHeight(300);
        setWidth(500);
