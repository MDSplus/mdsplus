 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_TCV_PROXY_OUT_SERVERSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_TCV_PROXY_OUT_SERVERSetup
     */
    public MARTE2_SIMULINK_TCV_PROXY_OUT_SERVERSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceType("MARTE2_SIMULINK_TCV_PROXY_OUT_SERVER");
        setHeight(300);
        setWidth(500);
