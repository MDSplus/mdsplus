 ...
 * @author mdsplus
 */
public class MARTE2_BASLERCAMERA_ASetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_BASLERCAMERA_ASetup
     */
    public MARTE2_BASLERCAMERA_ASetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("MARTe2 Basler Camera");
        setDeviceType("MARTE2_BASLERCAMERA_A");
        setHeight(500);
        setUpdateEvent("");
        setWidth(700);
        ...
        deviceOutputs1.setOffsetNid(29);
