 ...
 * @author mdsplus
 */
public class MARTE2_EEI_ALARM_RECEIVERSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_EEI_ALARM_RECEIVERSetup
     */
    public MARTE2_EEI_ALARM_RECEIVERSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("EEI Alarms");
        setDeviceType("MARTE2_EEI_ALARM_RECEIVER");
        setHeight(300);
        setWidth(500);
