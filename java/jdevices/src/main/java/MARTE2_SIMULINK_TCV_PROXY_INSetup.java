 ...
 * @author mdsplus
 */
public class MARTE2_SIMULINK_TCV_PROXY_INSetup extends DeviceSetup {

    /**
     * Creates new form MARTE2_SIMULINK_TCV_PROXY_INSetup
     */
    public MARTE2_SIMULINK_TCV_PROXY_INSetup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setDeviceTitle("SimulinkProxyIn");
        setDeviceType("MARTE2_SIMULINK_TCV_PROXY_IN");
        setHeight(300);
        setWidth(500);
