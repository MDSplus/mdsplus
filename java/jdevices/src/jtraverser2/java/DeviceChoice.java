...
public class DeviceChoice extends DeviceComponent
{
	...
	comboB.addActionListener(new ActionListener()
	{
	    public void actionPerformed(ActionEvent e)
	    {
	        ...
	        master.fireUpdate(updateIdentifier, new StringDsc(currItem));
	    }
	});
	initializing = false;
    }
	...
	{
	    if (data instanceof StringDsc)
	    {
	        data_string = ((StringDsc)data).toString();
	...
	{
	    if(choiceIntValues != null)
	        return new Int32(choiceIntValues[curr_idx]);
	...
	else
	{
	    ...
	    if(choiceFloatValues != null)
	        return new Float32(choiceFloatValues[curr_idx]);
	    if(choiceDoubleValues != null)
	        return new Float64(choiceDoubleValues[curr_idx]);
	    return new StringDsc(choiceItems[curr_idx]);
	}
    }
