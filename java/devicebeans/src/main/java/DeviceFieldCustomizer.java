	...
	public void setObject(Object o)
	{
		...
		doneButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				if (bean == null)
					return;
				final String oldLabel = bean.getLabelString();
				bean.setLabelString(labelString.getText());
				listeners.firePropertyChange("labelString", oldLabel, bean.getLabelString());
				final String colStr = numCols.getText();
				final int oldCols = bean.getNumCols();
				...
				final boolean oldDisplayEvaluated = bean.getDisplayEvaluated();
