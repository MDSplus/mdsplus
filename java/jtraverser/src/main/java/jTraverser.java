...
public void actionPerformed(ActionEvent e)
{
    ...
    if(source == (Object)add_action_b) tree.addNode("ACTION");
    if(source == (Object)add_dispatch_b) tree.addNode("DISPATCH");
    if(source == (Object)add_numeric_b) tree.addNode("NUMERIC");
    if(source == (Object)add_signal_b) tree.addNode("SIGNAL");
    if(source == (Object)add_task_b)tree.addNode("TASK");
    if(source == (Object)add_text_b) tree.addNode("TEXT");
    if(source == (Object)add_child_b) tree.addNode("STRUCTURE");
    if(source == (Object)add_window_b) tree.addNode("WINDOW");
    if(source == (Object)add_axis_b)tree.addNode("AXIS");
