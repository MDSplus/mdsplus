...
public class TreeShr_Test{
	...
	public final void testTreeAddNode() throws MdsException {
		...
		try{
			...
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeAddNode(ctx, "B", NODE.USAGE_SUBTREE).status);
	...
	public final void testTreeContext() throws MdsException {
		...
		AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeOpenNew(ctx, TreeShr_Test.expt, TreeShr_Test.model));
		AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeOpen(ctx, TreeShr_Test.expt, TreeShr_Test.model, true));
		...
		try{
			...
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeClose(ctx, TreeShr_Test.expt, TreeShr_Test.shot));
		}finally{
	...
	public final void testTreeDeleteNode() throws MdsException {
		...
		try{
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeAddNode(ctx, "A", NODE.USAGE_ANY).status);
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeAddNode(ctx, "B", NODE.USAGE_ANY).status);
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeAddNode(ctx, "A:C", NODE.USAGE_ANY).status);
	...
	public final void testTreeGetDatafileSize() throws MdsException {
		...
		try{
			...
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeSetNciItm(ctx, 1, false, Flags.COMPRESS_ON_PUT));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeSetNciItm(ctx, 1, true, Flags.COMPRESSIBLE));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeWriteTree(ctx, TreeShr_Test.expt, TreeShr_Test.model));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeClose(ctx, TreeShr_Test.expt, TreeShr_Test.model));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeCleanDatafile(null, TreeShr_Test.expt, TreeShr_Test.model));
			...
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treePutRecord(ctx, 1, new Int32Array(new int[10])));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treePutRecord(ctx, 1, new Int32Array(new int[100])));
			...
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeClose(ctx, TreeShr_Test.expt, TreeShr_Test.model));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeCompressDatafile(null, TreeShr_Test.expt, TreeShr_Test.model));
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeOpen(ctx, TreeShr_Test.expt, TreeShr_Test.model, false));
	...
	public final void testTreeMakeSegment() throws MdsException {
		...
		try{
			...
			for(int i = 0; i < 10; i++)
				dim[i] = t0 + i * 1000000l;
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeMakeTimestampedSegment(ctx, 1, dim, new Float32Array(.0f, .1f, .2f, .3f, .4f, .5f, .6f, .7f, .8f, Float.NaN), -1, 9));
			...
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeMakeTimestampedSegment(ctx, 1, dim, new Float32Array(1.0f, 1.1f, 1.2f, 1.3f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f), -1, 10));
			Assert.assertEquals(2, TreeShr_Test.treeshr.treeGetNumSegments(ctx, 1).getData());
			for(int i = 0; i < 10; i++)
				dim[i] = t0 + i * 1000000l + 20000000l;
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeMakeTimestampedSegment(ctx, 1, dim, new Float32Array(2.0f, 2.1f, 2.2f, 2.3f, 2.4f, 2.5f, 2.6f, 2.7f, 2.8f, 2.9f), -1, 10));
