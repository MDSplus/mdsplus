...
public class TreeShr_Test
{
	...
	public final void testTreeAddNode() throws MdsException
	{
		...
		{
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeAddNode(ctx, "A", NODE.USAGE_ANY).status);
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeAddNode(ctx, "B", NODE.USAGE_SUBTREE).status);
			...
			Assert.assertEquals(NODE.USAGE_SUBTREE,
					TreeShr_Test.mds.getInteger(ctx, "GetNci('\\\\TEST::TOP:B','USAGE')"));
			final int nid = 3;
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeStartConglomerate(ctx, 11));
			...
			Assert.assertEquals(nid + 4,
					TreeShr_Test.treeshr.treeAddNode(ctx, "COMPOUND", NODE.USAGE_COMPOUND_DATA).getData());
			Assert.assertEquals(nid + 5,
					TreeShr_Test.treeshr.treeAddNode(ctx, "DISPATCH", NODE.USAGE_DISPATCH).getData());
			Assert.assertEquals(nid + 6,
					TreeShr_Test.treeshr.treeAddNode(ctx, "NUMERIC", NODE.USAGE_NUMERIC).getData());
			Assert.assertEquals(nid + 7, TreeShr_Test.treeshr.treeAddNode(ctx, "SIGNAL", NODE.USAGE_SIGNAL).getData());
			Assert.assertEquals(nid + 8,
					TreeShr_Test.treeshr.treeAddNode(ctx, "STRUCTURE", NODE.USAGE_STRUCTURE).getData());
			...
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeClose(ctx, TreeShr_Test.expt, TreeShr_Test.model));
		}
		catch (final MdsException e)
		{
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeQuitTree(ctx, TreeShr_Test.expt, TreeShr_Test.model));
			throw e;
		}
		finally
		{}
	...
	public final void testTreeBeginTimestampedSegment() throws MdsException
	{
		...
		try
		{
			...
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeBeginTimestampedSegment(ctx, 1, new Float32Array(new int[]
					{ 3, 1 }, 0.f, 0.f, 0.f), -1));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treePutTimestampedSegment(ctx, 1, 123456789012345l, new Float32Array(new int[]
					{ 3, 1 }, .1f, .2f, .3f)));
	...
	public final void testTreeContext() throws MdsException
	{
		...
		AllTests.testStatus(MdsException.TreeSUCCESS,
				TreeShr_Test.treeshr.treeOpenNew(ctx, TreeShr_Test.expt, TreeShr_Test.model));
		AllTests.testStatus(MdsException.TreeSUCCESS,
				TreeShr_Test.treeshr.treeOpen(ctx, TreeShr_Test.expt, TreeShr_Test.model, true));
		...
		try
		{
			...
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeOpenNew(ctx, AllTests.tree, TreeShr_Test.shot));
			...
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeClose(ctx, TreeShr_Test.expt, TreeShr_Test.shot));
		}
		finally
		{
	...
	public final void testTreeDeleteNode() throws MdsException
	{
		...
		try
		{
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeAddNode(ctx, "A", NODE.USAGE_ANY).status);
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeAddNode(ctx, "B", NODE.USAGE_ANY).status);
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeAddNode(ctx, "A:C", NODE.USAGE_ANY).status);
		...
		try
		{
			...
			try
			{
				Assert.assertEquals("\\" + TreeShr_Test.EXPT + "::MYTAG",
						(tag = TreeShr_Test.treeshr.treeFindTagWild(ctx, "MYTAG", tag)).data);
				...
				Assert.assertEquals("\\" + TreeShr_Test.EXPT + "::TOP",
						(tag = TreeShr_Test.treeshr.treeFindTagWild(ctx, "***", tag)).data);
			}
			finally
			{
	...
	public final void testTreeGetDatafileSize() throws MdsException
	{
		...
		try
		{
			...
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeSetNciItm(ctx, 1, false, Flags.COMPRESS_ON_PUT));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeSetNciItm(ctx, 1, true, Flags.COMPRESSIBLE));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeWriteTree(ctx, TreeShr_Test.expt, TreeShr_Test.model));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeClose(ctx, TreeShr_Test.expt, TreeShr_Test.model));
			...
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeOpen(ctx, TreeShr_Test.expt, TreeShr_Test.model, false));
			Assert.assertEquals(0, TreeShr_Test.treeshr.treeGetDatafileSize(ctx));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treePutRecord(ctx, 1, new Int32Array(new int[10])));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treePutRecord(ctx, 1, new Int32Array(new int[100])));
	...
	{
		AllTests.testStatus(MdsException.TreeSUCCESS,
				TreeShr_Test.treeshr.treeOpenNew(ctx, AllTests.tree, TreeShr_Test.model));
		try
		{
			Assert.assertEquals(1, TreeShr_Test.treeshr.treeAddNode(ctx, "A", NODE.USAGE_SIGNAL).getData());
			...
			for (int i = 0; i < 10; i++)
				dim[i] = t0 + i * 1000000l;
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeMakeTimestampedSegment(ctx, 1, dim,
					new Float32Array(.0f, .1f, .2f, .3f, .4f, .5f, .6f, .7f, .8f, Float.NaN), -1, 9));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treePutRow(ctx, 1, 1 << 10, 1000009000000l, new Float32Array(.9f)));
			Assert.assertEquals(1, TreeShr_Test.treeshr.treeGetNumSegments(ctx, 1).getData());
			for (int i = 0; i < 10; i++)
				dim[i] = t0 + i * 1000000l + 10000000l;
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeMakeTimestampedSegment(ctx, 1, dim,
					new Float32Array(1.0f, 1.1f, 1.2f, 1.3f, 1.4f, 1.5f, 1.6f, 1.7f, 1.8f, 1.9f), -1, 10));
			Assert.assertEquals(2, TreeShr_Test.treeshr.treeGetNumSegments(ctx, 1).getData());
			for (int i = 0; i < 10; i++)
				dim[i] = t0 + i * 1000000l + 20000000l;
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeMakeTimestampedSegment(ctx, 1, dim,
					new Float32Array(2.0f, 2.1f, 2.2f, 2.3f, 2.4f, 2.5f, 2.6f, 2.7f, 2.8f, 2.9f), -1, 10));
			...
			Assert.assertEquals("List(,1000010000000Q,1000019000000Q)",
					TreeShr_Test.treeshr.treeGetSegmentLimits(ctx, 1, 1).getData().decompile());
			Assert.assertEquals("List(,1000000000000Q,1000010000000Q,1000020000000Q)",
					((List) TreeShr_Test.treeshr.treeGetSegmentTimesXd(ctx, 1).getData()).get(1).decompile());
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeUpdateSegment(ctx, 1, Missing.NEW,
					Missing.NEW, new Range(1000010100000l, 1000019100000l, 1000000l).getDataD(), 1));
			Assert.assertEquals(
					...
					TreeShr_Test.treeshr.treeGetSegment(ctx, 1, 1).getDimension().decompile());
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeSetSegmentScale(ctx, 1,
			...
			// TIMECONTEXT
			Assert.assertEquals(1, TreeShr_Test.treeshr.treeSetTimeContext(ctx, new Long(1000001000000l),
					new Long(1000007000000l), new Long(2000000l)));
			// Assert.assertArrayEquals(new float[]{.15f, .25f, .35f, .45f},
			// TreeShr_Test.treeshr.treeGetRecord(ctx, 1).toFloatArray(), 1e-5f);
			...
			Assert.assertArrayEquals(sig.getDimension().toLongArray(),
					TreeShr_Test.treeshr.treeGetSegmentDim(ctx, 1, 0).toLongArray());
			Assert.assertArrayEquals(sig.getValue().toFloatArray(),
					TreeShr_Test.treeshr.treeGetSegmentData(ctx, 1, 0).toFloatArray(), 1e-5f);
	...
	public final void testTreePutRecord() throws MdsException
	{
		...
		try
		{
			...
			Assert.assertEquals(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treePutRecord(ctx, 1,
					new Action(new Path("TSK"), new Path("ANY"), null, null, null)));
			Assert.assertEquals(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treePutRecord(ctx, 3,
					TreeShr_Test.mds.getAPI().tdiCompile(ctx, "_=1,_").getData()));
	...
	public final void testTreeSetNciItm() throws MdsException
	{
		...
		{
			Assert.assertEquals(1, TreeShr_Test.treeshr.treeAddNode(ctx, "A", NODE.USAGE_ANY).getData());
			AllTests.testStatus(MdsException.TreeSUCCESS, TreeShr_Test.treeshr.treeSetNciItm(ctx, 1, true, 0x7FFFFFFF));
			Assert.assertEquals(0x7FFFFFFF, TreeShr_Test.mds.getInteger(ctx, "GetNci(1,'GET_FLAGS')"));
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeSetNciItm(ctx, 1, false, -0x10400 - 1));
	...
	public final void testTreeSetXNci() throws MdsException
	{
		...
		try
		{
			Assert.assertEquals(1, TreeShr_Test.treeshr.treeAddNode(ctx, "A", NODE.USAGE_ANY).getData());
			AllTests.testStatus(MdsException.TreeSUCCESS,
					TreeShr_Test.treeshr.treeSetXNci(ctx, 1, "myattr", CONST.$HBAR));
