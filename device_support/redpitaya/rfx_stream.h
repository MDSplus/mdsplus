...
#define RFX_STREAM_GET_AUX_MODE_REG		_IO(RFX_STREAM_IOCTL_BASE, 20)
#define RFX_STREAM_SET_AUX_MODE_REG		_IO(RFX_STREAM_IOCTL_BASE, 21)
...
#define RFX_STREAM_GET_PACKETIZER		_IO(RFX_STREAM_IOCTL_BASE, 36)
#define RFX_STREAM_SET_PACKETIZER		_IO(RFX_STREAM_IOCTL_BASE, 37)
#define RFX_STREAM_GET_POST_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 38)
#define RFX_STREAM_SET_POST_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 39)
#define RFX_STREAM_GET_PRE_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 40)
#define RFX_STREAM_SET_PRE_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 41)
#define RFX_STREAM_GET_STEP_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 42)
#define RFX_STREAM_SET_STEP_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 43)
#define RFX_STREAM_GET_STEP_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 44)
#define RFX_STREAM_SET_STEP_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 45)
#define RFX_STREAM_GET_TIME_COMMAND_REG		_IO(RFX_STREAM_IOCTL_BASE, 46)
#define RFX_STREAM_SET_TIME_COMMAND_REG		_IO(RFX_STREAM_IOCTL_BASE, 47)
#define RFX_STREAM_GET_TIME_OFFSET_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 48)
#define RFX_STREAM_SET_TIME_OFFSET_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 49)
#define RFX_STREAM_GET_TIME_OFFSET_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 50)
#define RFX_STREAM_SET_TIME_OFFSET_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 51)
...
#define RFX_STREAM_GET_SYNC_FIFO_LEN		_IO(RFX_STREAM_IOCTL_BASE, 56)
#define RFX_STREAM_GET_SYNC_FIFO_VAL		_IO(RFX_STREAM_IOCTL_BASE, 57)
#define RFX_STREAM_SET_SYNC_FIFO_VAL		_IO(RFX_STREAM_IOCTL_BASE, 58)
#define RFX_STREAM_CLEAR_SYNC_FIFO		_IO(RFX_STREAM_IOCTL_BASE, 59)
#define RFX_STREAM_GET_TIME_FIFO_LEN		_IO(RFX_STREAM_IOCTL_BASE, 60)
#define RFX_STREAM_GET_TIME_FIFO_VAL		_IO(RFX_STREAM_IOCTL_BASE, 61)
#define RFX_STREAM_SET_TIME_FIFO_VAL		_IO(RFX_STREAM_IOCTL_BASE, 62)
#define RFX_STREAM_CLEAR_TIME_FIFO		_IO(RFX_STREAM_IOCTL_BASE, 63)
...
{
    	char aux_mode_reg_enable;
	unsigned int aux_mode_reg;
