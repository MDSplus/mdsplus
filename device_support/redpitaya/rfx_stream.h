...
#define RFX_STREAM_GET_AUX_CFG_REG		_IO(RFX_STREAM_IOCTL_BASE, 20)
#define RFX_STREAM_SET_AUX_CFG_REG		_IO(RFX_STREAM_IOCTL_BASE, 21)
...
#define RFX_STREAM_GET_DECIMATOR_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 24)
#define RFX_STREAM_SET_DECIMATOR_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 25)
#define RFX_STREAM_GET_K1_REG		_IO(RFX_STREAM_IOCTL_BASE, 26)
#define RFX_STREAM_SET_K1_REG		_IO(RFX_STREAM_IOCTL_BASE, 27)
#define RFX_STREAM_GET_K2_REG		_IO(RFX_STREAM_IOCTL_BASE, 28)
#define RFX_STREAM_SET_K2_REG		_IO(RFX_STREAM_IOCTL_BASE, 29)
#define RFX_STREAM_GET_LEV_TRIG_COUNT		_IO(RFX_STREAM_IOCTL_BASE, 30)
#define RFX_STREAM_SET_LEV_TRIG_COUNT		_IO(RFX_STREAM_IOCTL_BASE, 31)
#define RFX_STREAM_GET_MODE_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 32)
#define RFX_STREAM_SET_MODE_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 33)
#define RFX_STREAM_GET_PACKETIZER		_IO(RFX_STREAM_IOCTL_BASE, 34)
#define RFX_STREAM_SET_PACKETIZER		_IO(RFX_STREAM_IOCTL_BASE, 35)
#define RFX_STREAM_GET_POST_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 36)
#define RFX_STREAM_SET_POST_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 37)
#define RFX_STREAM_GET_PRE_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 38)
#define RFX_STREAM_SET_PRE_REGISTER		_IO(RFX_STREAM_IOCTL_BASE, 39)
#define RFX_STREAM_GET_STEP_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 40)
#define RFX_STREAM_SET_STEP_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 41)
#define RFX_STREAM_GET_STEP_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 42)
#define RFX_STREAM_SET_STEP_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 43)
#define RFX_STREAM_GET_TIME_COMMAND_REG		_IO(RFX_STREAM_IOCTL_BASE, 44)
#define RFX_STREAM_SET_TIME_COMMAND_REG		_IO(RFX_STREAM_IOCTL_BASE, 45)
#define RFX_STREAM_GET_TIME_OFFSET_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 46)
#define RFX_STREAM_SET_TIME_OFFSET_HI_REG		_IO(RFX_STREAM_IOCTL_BASE, 47)
#define RFX_STREAM_GET_TIME_OFFSET_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 48)
#define RFX_STREAM_SET_TIME_OFFSET_LO_REG		_IO(RFX_STREAM_IOCTL_BASE, 49)
#define RFX_STREAM_GET_DATA_FIFO_LEN		_IO(RFX_STREAM_IOCTL_BASE, 50)
#define RFX_STREAM_GET_DATA_FIFO_VAL		_IO(RFX_STREAM_IOCTL_BASE, 51)
#define RFX_STREAM_CLEAR_DATA_FIFO		_IO(RFX_STREAM_IOCTL_BASE, 52)
#define RFX_STREAM_GET_SYNC_FIFO_LEN		_IO(RFX_STREAM_IOCTL_BASE, 53)
#define RFX_STREAM_GET_SYNC_FIFO_VAL		_IO(RFX_STREAM_IOCTL_BASE, 54)
#define RFX_STREAM_CLEAR_SYNC_FIFO		_IO(RFX_STREAM_IOCTL_BASE, 55)
...
#define RFX_STREAM_CLEAR_TIME_FIFO		_IO(RFX_STREAM_IOCTL_BASE, 58)
...
{
    	char aux_cfg_reg_enable;
	unsigned int aux_cfg_reg;
	...
	char time_command_reg_enable;
	unsigned int time_command_reg;
	char time_offset_hi_reg_enable;
	unsigned int time_offset_hi_reg;
	char time_offset_lo_reg_enable;
	unsigned int time_offset_lo_reg;
