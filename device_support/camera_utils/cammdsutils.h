...
// int camSaveFrame(void *frame, int width, int height, float frameTime, int
// pixelSize, void *treePtr, int dataNid, int timebaseNid, int frameIdx, void
// *frameMetadata, int metaSize, int metaNid);
