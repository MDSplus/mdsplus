...
/*
NiFpga_Status printLedStatus(NiFpga_Session *session)
{
    NiFpga_Bool led1,led2,led3
...
void *acquisitionThreadFPGA(void *args)
{
    ...
    float *streamOffsets = fpgaAcq->streamOffsets;    NiFpga_Bool val;
    NiFpga_MergeStatus(&status, NiFpga_ReadBool(session,
	                                         NiFpga_MainFPGA_9159_ControlBool_Start,
	                                         &val));
