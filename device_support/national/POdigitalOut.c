...
//	int i = 0, k = 0;
	...
	uint32_t dio_output_mask = 0x1A2B3C4D;
...
//	xseries_di_conf_t di_conf = xseries_static_di(dio_input_mask);
	xseries_do_conf_t do_conf = xseries_static_do(dio_output_mask);
