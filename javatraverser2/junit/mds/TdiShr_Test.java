...
public class TdiShr_Test{
    ...
    public final void testTdiCompile() throws MdsException {
        Assert.assertEquals(new Int32Array(1, 2), TdiShr_Test.tdishr.tdiCompile(null, "[1,2]").data);
        Assert.assertEquals(new Int32Array(0, 0), TdiShr_Test.tdishr.tdiExecute(null, "zero(2,1)").data);
        Assert.assertEquals(new Int32(3), TdiShr_Test.tdishr.tdiEvaluate(null, new Add(new Int32(1), new Int32(2))).data);
    }
}
