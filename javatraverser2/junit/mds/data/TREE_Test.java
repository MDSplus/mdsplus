...
public class TREE_Test{
    ...
    public void construct() throws Exception {
        ...
        Assert.assertArrayEquals(new Nid[]{new Nid(3), new Nid(2)}, tree.findNodesWild(NODE.USAGE_SIGNAL));
        ...
        // Assert.assertEquals("\\DAT", tree.findTagWild("*A*", TagRefStatus.init).data);
