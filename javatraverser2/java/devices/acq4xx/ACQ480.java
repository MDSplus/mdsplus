...
public class ACQ480 extends ACQ4xx{
	...
	protected Channel(final NODE<?> node){
	    super(node, 5);
	    this.addEnum(0, "GAIN", "gain in db, [0..12]", EnumEditor.MODE.INDEX, "0db", "1db", "2db", "3db", "4db", "5db", "6db", "7db", "8db", "9db", "10db", "11db", "12db");
	    this.addEnum(1, "HPF", "high pass filter mode; 0: off, else K2-K10", EnumEditor.MODE.INDEX, "off", "K2", "K3", "K4", "K5", "K6", "K7", "K8", "K9", "K10");
	...
	protected Master(final NODE<?> node){
	    super(node, 3);
	    this.addEnum(0, "FIR", "adc fir filter mode", EnumEditor.MODE.INDEX, "DISABLE", "LP_ODD_D2", "HP_ODD_D2", "LP_EVEN_D4", "BP1_EVEN_D4", "BP1_EVEN_D4", "HP_ODD_D4", "CUSTOM_D2", "CUSTOM_D4", "CUSTOM_D8", "CUSTOM_D1");
	    this.addEnum(1, "TRIG_MODE", "'RGM', 'RTM', or else 'TRANSIENT'", EnumEditor.MODE.STRING, "TRANSIENT", "RTM", "RGM");
