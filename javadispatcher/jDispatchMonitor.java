    ...
    //The message handler: the expression and arguments are passed as a vector of MdsMessage
        public MdsMessage handleMessage(MdsMessage [] messages)
        {
            ...
            try {
                ...
                System.out.println(message + " nid = " + nid);
            }
            catch(Exception exc)
            {
