...
template <typename FuncT> struct FunctionTypes {};

template <typename R, class O> struct FunctionTypes<R (O::*)()> {
  typedef R ref();
  typedef R(ptr)();
  typedef O obj;
...
template <typename R, class O, typename T0> struct FunctionTypes<R (O::*)(T0)> {
  typedef R ref(T0);
  typedef R(ptr)(T0);
  typedef O obj;
  typedef R ReturnType;
