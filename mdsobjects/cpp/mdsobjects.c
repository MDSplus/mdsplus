...
//printf("DescripToObject dtype = %d class = %d\n", desc->dtype, desc->class);
  ...
  switch(desc->class) {
	...
	case DTYPE_PARAM: cls = (*env)->FindClass(env, "mdsdata/ParamData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break; 
	case DTYPE_SIGNAL: cls = (*env)->FindClass(env, "mdsdata/SignalData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break; 
	case DTYPE_DIMENSION: cls = (*env)->FindClass(env, "mdsdata/DimensionData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_WINDOW: cls = (*env)->FindClass(env, "mdsdata/WindowData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_FUNCTION: cls = (*env)->FindClass(env, "mdsdata/FunctionData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_CONGLOM: cls = (*env)->FindClass(env, "mdsdata/ConglomData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_ACTION: cls = (*env)->FindClass(env, "mdsdata/ActionData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_DISPATCH: cls = (*env)->FindClass(env, "mdsdata/DispatchData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_PROGRAM: cls = (*env)->FindClass(env, "mdsdata/ProgramData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_ROUTINE: cls = (*env)->FindClass(env, "mdsdata/RoutineData");  
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_PROCEDURE: cls = (*env)->FindClass(env, "mdsdata/ProcedureData");   
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_METHOD: cls = (*env)->FindClass(env, "mdsdata/MethodData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
      	case DTYPE_DEPENDENCY: cls = (*env)->FindClass(env, "mdsdata/DependencyData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_CONDITION: cls = (*env)->FindClass(env, "mdsdata/ConditionData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_WITH_UNITS: cls = (*env)->FindClass(env, "mdsdata/WithUnitsData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	case DTYPE_CALL: cls = (*env)->FindClass(env, "mdsdata/CallData");
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
 	case DTYPE_WITH_ERROR: cls = (*env)->FindClass(env, "mdsdata/WithErrorData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
 	case DTYPE_RANGE: cls = (*env)->FindClass(env, "mdsdata/RangeData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
 	case DTYPE_SLOPE: cls = (*env)->FindClass(env, "mdsdata/SlopeData"); 
	                  constr = (*env)->GetStaticMethodID(env, cls, "getData", "()Lmdsdata/Data;");
			  break;   
	}
...
JNIEXPORT jstring JNICALL Java_mdstree_MdsTree_getPath
  (JNIEnv *env, jclass cls, jint nid)
{
  ...
  (JNIEnv *env, jclass cls, jint nid)
{
	...
	struct nci_itm nci_list[] = 
		{{511, NciFULLPATH, fullPath, &fullPathLen},
  ...
  (JNIEnv *env, jclass cls, jint nid, jobject data, jobject start, jobject end, jobject dim)
{
	...
	endD = ObjectToDescrip(env, end);
	dimD = ObjectToDescrip(env, dim);
	status = RTreeBeginSegment(nid, startD, endD, dimD, (struct descriptor_a *)dataD, -1, WRITE_BUFFER);
	freeDescrip(startD);
	freeDescrip(endD);
	freeDescrip(dimD);
	if(!(status & 1))
...
static void callback(int nid, void *obj)
{
	...
	if(!cls) printf("Error getting class for ActiveTreeNode\n");
	mid = (*env)->GetMethodID(env, cls,  "callback", "()V");
	if(!mid) printf("Error getting method callback for ActiveTreeNode\n");
