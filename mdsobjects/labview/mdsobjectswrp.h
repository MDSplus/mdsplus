...
#ifndef __MINGW64__
#pragma pack( \
    1) //!!! Possible origin of memory misalignments in 64 bit architectures?
#endif
...
void fillErrorCluster(MgErr code, const char *source, const char *message,
                      ErrorCluster *error);
...
extern "C"
{
  ...
  /********** ARRAY **********/
  EXPORT void mdsplus_array_constructor(void **lvArrayPtrOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_array_destructor(void **lvArrayPtr);
  EXPORT void mdsplus_array_getByteArray(const void *lvArrayPtr,
                                         LByteArrHdl lvByteArrHdlOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_array_getDoubleArray(const void *lvArrayPtr,
                                           LDblArrHdl lvDblArrHdlOut,
                                           ErrorCluster *error);
  EXPORT void mdsplus_array_getElementAt(const void *lvArrayPtr,
                                         void **lvDataPtrOut, int dimIn,
                                         ErrorCluster *error);
  EXPORT void mdsplus_array_getElementAt_dims(const void *lvArrayPtr,
                                              void **lvDataPtrOut,
                                              const LIntArrHdl lvIntArrHdlIn,
                                              ErrorCluster *error);
  EXPORT void mdsplus_array_getFloatArray(const void *lvArrayPtr,
                                          LFltArrHdl lvFltArrHdlOut,
                                          ErrorCluster *error);
  EXPORT void mdsplus_array_getIntArray(const void *lvArrayPtr,
                                        LIntArrHdl lvIntArrHdlOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_array_getInfo(const void *lvArrayPtr, char *clazzOut,
                                    char *dtypeOut, short *lengthOut,
                                    LIntArrHdl lvIntArrHdlOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_array_getLongArray(const void *lvArrayPtr,
                                         LLngArrHdl lvLngArrHdlOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_array_getShape(const void *lvArrayPtr,
                                     LIntArrHdl lvIntArrHdlOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_array_getShortArray(const void *lvArrayPtr,
                                          LShtArrHdl lvShtArrHdlOut,
                                          ErrorCluster *error);
  EXPORT void mdsplus_array_getSize(const void *lvArrayPtr, int *sizeOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_array_getStringArray(const void *lvArrayPtr,
                                           LStrArrHdl lvStrArrHdlOut,
                                           ErrorCluster *error);
  ...
  /********** COMPOUND **********/
  EXPORT void mdsplus_compound_constructor(void **lvCompoundPtrOut,
                                           ErrorCluster *error);
  ...
  EXPORT void mdsplus_data_compile_tree(void **lvDataPtrOut, const char *exprIn,
                                        const void *lvTreePtrIn,
                                        ErrorCluster *error);
  EXPORT void mdsplus_data_data(const void *lvDataPtr, void **lvDataPtrOut,
                                ErrorCluster *error);
  EXPORT void mdsplus_data_decompile(const void *lvDataPtr,
                                     LStrHandle lvStrHdlOut, ErrorCluster *error);
  EXPORT void mdsplus_data_deserialize(void **lvDataPtrOut,
                                       const char *serializedIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_data_deserialize_data(void **lvDataPtrOut,
                                            const void *lvDataPtrIn,
                                            ErrorCluster *error);
  ...
  EXPORT void mdsplus_data_execute_tree(void **lvDataPtrOut, const char *exprIn,
                                        const void *lvTreePtrIn,
                                        ErrorCluster *error);
  EXPORT void mdsplus_data_getByte(const void *lvDataPtr, char *byteOut,
                                   ErrorCluster *error);
  EXPORT void mdsplus_data_getByteArray(const void *lvDataPtr,
                                        LByteArrHdl lvByteArrHdlOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_data_getDouble(const void *lvDataPtr, double *doubleOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_data_getDoubleArray(const void *lvDataPtr,
                                          LDblArrHdl lvDblArrHdlOut,
                                          ErrorCluster *error);
  ...
  EXPORT void mdsplus_data_getFloat(const void *lvDataPtr, float *floatOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_data_getFloatArray(const void *lvDataPtr,
                                         LFltArrHdl lvFltArrHdlOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_data_getHelp(const void *lvDataPtr, void **lvDataPtrOut,
                                   ErrorCluster *error);
  EXPORT void mdsplus_data_getInfo(const void *lvDataPtr, char *clazzOut,
                                   char *dtypeOut, short *lengthOut,
                                   LIntArrHdl lvIntArrHdlOut,
                                   ErrorCluster *error);
  EXPORT void mdsplus_data_getInt(const void *lvDataPtr, int *intOut,
                                  ErrorCluster *error);
  EXPORT void mdsplus_data_getIntArray(const void *lvDataPtr,
                                       LIntArrHdl lvIntArrHdlOut,
                                       ErrorCluster *error);
  EXPORT void mdsplus_data_getLong(const void *lvDataPtr, int64_t *longOut,
                                   ErrorCluster *error);
  EXPORT void mdsplus_data_getLongArray(const void *lvDataPtr,
                                        LLngArrHdl lvLngArrHdlOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_data_getShape(const void *lvDataPtr,
                                    LIntArrHdl lvIntArrHdlOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_data_getShort(const void *lvDataPtr, short *shortOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_data_getShortArray(const void *lvDataPtr,
                                         LShtArrHdl lvShtArrHdlOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_data_getSize(const void *lvDataPtr, int *sizeOut,
                                   ErrorCluster *error);
  EXPORT void mdsplus_data_getString(const void *lvDataPtr,
                                     LStrHandle lvStrHdlOut, ErrorCluster *error);
  EXPORT void mdsplus_data_getStringArray(const void *lvDataPtr,
                                          LStrArrHdl lvStrArrHdlOut,
                                          ErrorCluster *error);
  EXPORT void mdsplus_data_getUnits(const void *lvDataPtr, void **lvDataPtrOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_data_getValidation(const void *lvDataPtr,
                                         void **lvDataPtrOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_data_plot(const void *lvDataPtr, ErrorCluster *error);
  EXPORT void mdsplus_data_serialize(const void *lvDataPtr,
                                     LByteArrHdl lvByteArrHdlOut,
                                     ErrorCluster *error);
  ...
  EXPORT void mdsplus_event_wait(const void *lvEventPtr, int *timeoutOccurred,
                                 ErrorCluster *error);
  // EXPORT void mdsplus_event_abort(const void *lvEventPtr, ErrorCluster *
  // error);
  ...
  EXPORT void mdsplus_event_setEventRaw(const char *evNameIn,
                                        ...
                                        ErrorCluster *error);
  EXPORT void mdsplus_revent_constructor(void **lvREventPtrOut,
                                         const char *evNameIn,
                                         ErrorCluster *error);
  ...
  EXPORT void mdsplus_revent_getData(const void *lvREventPtr, void **lvDataPtrOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_revent_getName(const void *lvREventPtr,
                                     LStrHandle lvStrHdlOut, ErrorCluster *error);
  EXPORT void mdsplus_revent_getRaw(const void *lvREventPtr,
                                    LByteArrHdl lvByteArrHdlOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_revent_getTime(const void *lvREventPtr,
                                     void **lvUint64PtrOut, ErrorCluster *error);
  EXPORT void mdsplus_revent_run(const void *lvREventPtr, ErrorCluster *error);
  EXPORT void mdsplus_revent_setEvent(const char *evNameIn,
                                      const void *lvDataPtrIn,
                                      ErrorCluster *error);
  EXPORT void mdsplus_revent_setEventAndWait(const char *evNameIn,
                                             const void *lvDataPtrIn,
                                             ErrorCluster *error);
  EXPORT void mdsplus_revent_setEventRaw(const char *evNameIn,
                                         LByteArrHdl lvByteArrHdlIn,
                                         ErrorCluster *error);
  EXPORT void mdsplus_revent_setEventRawAndWait(const char *evNameIn,
                                                LByteArrHdl lvByteArrHdlIn,
                                                ErrorCluster *error);
  ...
  EXPORT void mdsplus_float32_getByte(const void *lvFloat32Ptr, char *byteOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_float32_getDouble(const void *lvFloat32Ptr,
                                        double *doubleOut, ErrorCluster *error);
  ...
  EXPORT void mdsplus_float32array_constructor(void **lvFloat32ArrayPtrOut,
                                               ...
                                               ErrorCluster *error);
  EXPORT void mdsplus_float32array_constructor_dims(
      void **lvFloat32ArrayPtrOut, const LFltArrHdl lvFltArrHdlIn,
      const LIntArrHdl lvIntArrHdlIn, ErrorCluster *error);
  ...
  EXPORT void mdsplus_float64_getByte(const void *lvFloat64Ptr, char *byteOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_float64_getDouble(const void *lvFloat64Ptr,
                                        double *doubleOut, ErrorCluster *error);
  ...
  EXPORT void mdsplus_float64array_constructor(void **lvFloat64ArrayPtrOut,
                                               ...
                                               ErrorCluster *error);
  EXPORT void mdsplus_float64array_constructor_dims(
      void **lvFloat64ArrayPtrOut, const LDblArrHdl lvDblArrHdlIn,
      const LIntArrHdl lvIntArrHdlIn, ErrorCluster *error);
  EXPORT void mdsplus_float64array_destructor(void **lvFloat64ArrayPtr);

  /********** INT16 **********/
  EXPORT void mdsplus_int16_constructor(void **lvInt16PtrOut, short valIn,
                                        ErrorCluster *error);
  EXPORT void mdsplus_int16_destructor(void **lvInt16Ptr);
  EXPORT void mdsplus_int16_getByte(const void *lvInt16Ptr, char *byteOut,
                                    ErrorCluster *error);
  ...
  /********** INT32 **********/
  EXPORT void mdsplus_int32_constructor(void **lvInt32PtrOut, int valIn,
                                        ErrorCluster *error);
  EXPORT void mdsplus_int32_destructor(void **lvInt32Ptr);
  EXPORT void mdsplus_int32_getByte(const void *lvInt32Ptr, char *byteOut,
                                    ErrorCluster *error);
  ...
  EXPORT void mdsplus_int32array_constructor(void **lvInt32ArrayPtrOut,
                                             const LIntArrHdl lvIntArrHdlIn,
                                             ErrorCluster *error);
  EXPORT void mdsplus_int32array_constructor_dims(
      void **lvInt32ArrayPtrOut, const LIntArrHdl lvIntArrHdlIn,
      const LIntArrHdl lvIntArrHdlDimIn, ErrorCluster *error);
  ...
  EXPORT void mdsplus_int64_getByte(const void *lvInt64Ptr, char *byteOut,
                                    ErrorCluster *error);
  ...
  EXPORT void mdsplus_int64_getFloat(const void *lvInt64Ptr, float *floatOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_int64_getInt(const void *lvInt64Ptr, int *intOut,
                                   ErrorCluster *error);
  ...
  /********** INT8 **********/
  EXPORT void mdsplus_int8_constructor(void **lvInt8PtrOut, char valIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_int8_destructor(void **lvInt8Ptr);
  EXPORT void mdsplus_int8_getByte(const void *lvInt8Ptr, char *byteOut,
                                   ErrorCluster *error);
  ...
  EXPORT void mdsplus_int8_getFloat(const void *lvInt8Ptr, float *floatOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_int8_getInt(const void *lvInt8Ptr, int *intOut,
                                  ErrorCluster *error);
  ...
  /********** RANGE **********/
  EXPORT void mdsplus_range_constructor(void **lvRangePtrOut,
                                        const void *lvBeginDataPtrIn,
                                        const void *lvEndingDataPtrIn,
                                        const void *lvDeltaValDataPtrIn,
                                        ErrorCluster *error);
  ...
  EXPORT void mdsplus_range_getEnding(const void *lvRangePtr, void **lvDataPtrOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_range_getDeltaVal(const void *lvRangePtr,
                                        void **lvDataPtrOut, ErrorCluster *error);
  EXPORT void mdsplus_range_setBegin(const void *lvRangePtr,
                                     const void *lvDataPtrIn,
                                     ErrorCluster *error);
  EXPORT void mdsplus_range_setEnding(const void *lvRangePtr,
                                      const void *lvDataPtrIn,
                                      ErrorCluster *error);
  EXPORT void mdsplus_range_setDeltaVal(const void *lvRangePtr,
                                        const void *lvDataPtrIn,
                                        ErrorCluster *error);

  /********** SIGNAL **********/
  EXPORT void mdsplus_signal_constructor(void **lvSignalPtrOut,
                                         const void *lvDataPtrIn,
                                         const void *lvRawDataPtrIn,
                                         const void *lvDim0DataPtrIn,
                                         ErrorCluster *error);
  ...
  EXPORT void mdsplus_signal_getDim(const void *lvSignalPtr, void **lvDimPtrOut,
                                    ErrorCluster *error);
  EXPORT void mdsplus_signal_setData(const void *lvSignalPtr,
                                     const void *lvDataPtrIn,
                                     ErrorCluster *error);
  EXPORT void mdsplus_signal_setRaw(const void *lvSignalPtr,
                                    const void *lvRawPtrIn, ErrorCluster *error);
  EXPORT void mdsplus_signal_setDim(const void *lvSignalPtr,
                                    const void *lvDimPtrIn, ErrorCluster *error);
  ...
  /********** SCALAR **********/
  EXPORT void mdsplus_scalar_constructor(void **lvScalarPtrOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_scalar_destructor(void **lvScalarPtr);
  EXPORT void mdsplus_scalar_getInfo(const void *lvScalarPtr, char *clazzOut,
                                     char *dtypeOut, short *lengthOut,
                                     LIntArrHdl lvIntArrHdlOut,
                                     ErrorCluster *error);
  ...
  EXPORT void mdsplus_string_getString(const void *lvStringPtr,
                                       LStrHandle lvStrHdlOut,
                                       ErrorCluster *error);
  ...
  EXPORT void mdsplus_stringarray_constructor(void **lvStringArrayPtrOut,
                                              ...
                                              ErrorCluster *error);
  EXPORT void
  mdsplus_stringarray_constructor_stringLen(void **lvStringArrayPtrOut,
  ...
  /********** TREE **********/
  EXPORT void mdsplus_tree_addDevice(const void *lvTreePtr,
                                     void **lvTreeNodePtrOut, const char *nameIn,
                                     const char *typeIn, ErrorCluster *error);
  EXPORT void mdsplus_tree_addNode(const void *lvTreePtr, void **lvTreeNodePtrOut,
                                   const char *nameIn, const char *usageIn,
                                   ErrorCluster *error);
  EXPORT void mdsplus_tree_constructor(void **lvTreePtrOut, const char *nameIn,
                                       int shotIn, ErrorCluster *error);
  EXPORT void mdsplus_tree_constructor_mode(void **lvTreePtrOut,
                                            const char *nameIn, int shotIn,
                                            const char *modeIn,
                                            ErrorCluster *error);
  EXPORT void mdsplus_tree_createPulse(const void *lvTreePtr, int shotIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_tree_deletePulse(const void *lvTreePtr, int shotIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_tree_destructor(void **lvTreePtr);
  EXPORT void mdsplus_tree_edit(const void *lvTreePtr, ErrorCluster *error);
  EXPORT void mdsplus_tree_findTags(const void *lvTreePtr,
                                    void **lvStringArrayPtrOut,
                                    const char *wildIn, ErrorCluster *error);
  EXPORT void mdsplus_tree_getActiveTree(void **lvTreePtrOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_tree_getCurrent(int *currentOut, const char *treeNameIn,
                                      ErrorCluster *error);
  EXPORT void mdsplus_tree_getDatafileSize(const void *lvTreePtr,
                                           int64_t *sizeOut, ErrorCluster *error);
  EXPORT void mdsplus_tree_getDefault(const void *lvTreePtr,
  ...
  EXPORT void mdsplus_tree_hasNode(const void *lvTreePtr, LVBoolean *lvhasNodeOut,
                                   const char *pathIn, ErrorCluster *error);
  EXPORT void mdsplus_tree_getNode_string(const void *lvTreePtr,
                                          void **lvTreeNodePtrOut,
                                          const void *lvStringPtrIn,
                                          ErrorCluster *error);
  EXPORT void mdsplus_tree_getNode_treepath(const void *lvTreePtr,
                                            void **lvTreeNodePtrOut,
                                            const void *lvTreePathPtrIn,
                                            ErrorCluster *error);
  EXPORT void mdsplus_tree_getNodeWild(const void *lvTreePtr,
  ...
  EXPORT void mdsplus_tree_getNodeWild_usageMask(const void *lvTreePtr,
                                                 ...
                                                 int usageMaskIn,
                                                 ErrorCluster *error);
  EXPORT void mdsplus_tree_isModified(const void *lvTreePtr,
                                      LVBoolean *lvIsModifiedOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_tree_isOpenForEdit(const void *lvTreePtr,
                                         LVBoolean *lvIsOpenForEditOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_tree_isReadOnly(const void *lvTreePtr,
                                      LVBoolean *lvIsReadOnlyOut,
                                      ErrorCluster *error);
  ...
  EXPORT void mdsplus_tree_removeTag(const void *lvTreePtr, const char *tagNameIn,
                                     ErrorCluster *error);
  EXPORT void mdsplus_tree_setActiveTree(const void *lvTreePtrIn,
                                         ErrorCluster *error);
  EXPORT void mdsplus_tree_setCurrent(const char *treeNameIn, int shotIn,
                                      ErrorCluster *error);
  EXPORT void mdsplus_tree_setDefault(const void *lvTreePtr,
                                      const void *lvTreeNodePtrIn,
                                      ErrorCluster *error);
  EXPORT void mdsplus_tree_setTimeContext(const void *lvTreePtr,
                                          const void *lvStartDataPtrIn,
                                          const void *lvEndDataPtrIn,
                                          const void *lvDeltaDataPtrIn,
                                          ErrorCluster *error);
  EXPORT void mdsplus_tree_setVersionsInModel(const void *lvTreePtr,
                                              LVBoolean *lvVerEnabledIn,
                                              ErrorCluster *error);
  EXPORT void mdsplus_tree_setVersionsInPulse(const void *lvTreePtr,
                                              LVBoolean *lvVerEnabledIn,
                                              ErrorCluster *error);
  ...
  /********** TREENODE **********/
  EXPORT void mdsplus_treenode_addDevice(const void *lvTreeNodePtr,
                                         void **lvTreeNodePtrOut,
                                         const char *nameIn, const char *typeIn,
                                         ErrorCluster *error);
  EXPORT void mdsplus_treenode_addNode(const void *lvTreeNodePtr,
                                       void **lvTreeNodePtrOut,
                                       const char *nameIn, const char *usageIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_treenode_addTag(const void *lvTreeNodePtr,
                                      const char *tagNameIn, ErrorCluster *error);
  ...
  EXPORT void mdsplus_treenode_containsVersions(const void *lvTreeNodePtr,
                                                ...
                                                ErrorCluster *error);
  EXPORT void mdsplus_treenode_deleteData(const void *lvTreeNodePtr,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_doMethod(const void *lvTreeNodePtr,
                                        const char *methodIn,
                                        ErrorCluster *error);
  EXPORT void mdsplus_treenode_destructor(void **lvTreeNodePtr);
  EXPORT void mdsplus_treenode_findTags(const void *lvTreeNodePtr,
                                        void **lvStringArrayPtrOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_treenode_getBrother(const void *lvTreeNodePtr,
                                          void **lvTreeNodePtrOut,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_getChild(const void *lvTreeNodePtr,
                                        void **lvTreeNodePtrOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_treenode_getChildren(const void *lvTreeNodePtr,
                                           LPtrArrHdl lvPtrArrHdlOut,
                                           ErrorCluster *error);
  EXPORT void mdsplus_treenode_getClass(const void *lvTreeNodePtr,
                                        LStrHandle lvStrHdlOut,
                                        ErrorCluster *error);
  ...
  EXPORT void mdsplus_treenode_getDepth(const void *lvTreeNodePtr, int *depthOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_treenode_getData(const void *lvTreeNodePtr,
                                       void **lvDataPtrOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_getDescendants(const void *lvTreeNodePtr,
                                              LPtrArrHdl lvPtrArrHdlOut,
                                              ErrorCluster *error);
  EXPORT void mdsplus_treenode_getDType(const void *lvTreeNodePtr,
                                        LStrHandle lvStrHdlOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_treenode_getFullPath(const void *lvTreeNodePtr,
                                           LStrHandle lvStrHdlOut,
                                           ErrorCluster *error);
  EXPORT void mdsplus_treenode_getLength(const void *lvTreeNodePtr,
                                         int *lengthOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_getMember(const void *lvTreeNodePtr,
                                         void **lvTreeNodePtrOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_treenode_getMembers(const void *lvTreeNodePtr,
                                          LPtrArrHdl lvPtrArrHdlOut,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_getMinPath(const void *lvTreeNodePtr,
                                          LStrHandle lvStrHdlOut,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNid(const void *lvTreeNodePtr, int *nidOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNode(const void *lvTreeNodePtr,
                                       void **lvTreeNodePtrOut,
                                       const char *relPathIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNode_string(const void *lvTreeNodePtr,
                                              void **lvTreeNodePtrOut,
                                              const void *lvStringPtrIn,
                                              ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNodeName(const void *lvTreeNodePtr,
                                           LStrHandle lvStrHdlOut,
                                           ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNumChildren(const void *lvTreeNodePtr,
                                              int *numChildrenOut,
                                              ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNumDescendants(const void *lvTreeNodePtr,
                                                 int *numDescendantsOut,
                                                 ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNumElts(const void *lvTreeNodePtr,
                                          int *numEltsOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNumMembers(const void *lvTreeNodePtr,
                                             int *numMembersOut,
                                             ErrorCluster *error);
  EXPORT void mdsplus_treenode_getNumSegments(const void *lvTreeNodePtr,
                                              int *numSegmentsOut,
                                              ErrorCluster *error);
  EXPORT void mdsplus_treenode_getOriginalPartName(const void *lvTreeNodePtr,
                                                   LStrHandle lvStrHdlOut,
                                                   ErrorCluster *error);
  EXPORT void mdsplus_treenode_getOwnerId(const void *lvTreeNodePtr,
                                          int *ownerIdOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_getParent(const void *lvTreeNodePtr,
                                         void **lvTreeNodePtrOut,
                                         ErrorCluster *error);
  EXPORT void mdsplus_treenode_getPath(const void *lvTreeNodePtr,
                                       LStrHandle lvStrHdlOut,
                                       ErrorCluster *error);
  EXPORT void mdsplus_treenode_getSegment(const void *lvTreeNodePtr,
                                          void **lvArrayPtrOut, int segIdxIn,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_getSegmentLimits(const void *lvTreeNodePtr,
                                                int segmentIdxIn,
                                                void **lvStartDataPtrOut,
                                                void **lvEndDataPtrOut,
                                                ErrorCluster *error);
  EXPORT void mdsplus_treenode_getStatus(const void *lvTreeNodePtr,
                                         int *statusOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_getTimeInserted(const void *lvTreeNodePtr,
                                               int64_t *timeInsertedOut,
                                               LStrHandle lvStrHdlOut,
                                               ErrorCluster *error);
  EXPORT void mdsplus_treenode_getTree(const void *lvTreeNodePtr,
                                       void **lvTreePtrOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_getUsage(const void *lvTreeNodePtr,
                                        LStrHandle lvStrHdlOut,
                                        ErrorCluster *error);
  EXPORT void mdsplus_treenode_isChild(const void *lvTreeNodePtr,
                                       LVBoolean *lvIsChildOut,
                                       ErrorCluster *error);
  ...
  EXPORT void mdsplus_treenode_isEssential(const void *lvTreeNodePtr,
                                           LVBoolean *lvIsEssentialOut,
                                           ErrorCluster *error);
  EXPORT void mdsplus_treenode_isIncludeInPulse(const void *lvTreeNodePtr,
                                                LVBoolean *lvisIncludeInPulseOut,
                                                ErrorCluster *error);
  EXPORT void
  mdsplus_treenode_isIncludedInPulse(const void *lvTreeNodePtr,
                                     LVBoolean *lvIsIncludedInPulseOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_treenode_isMember(const void *lvTreeNodePtr,
                                        LVBoolean *lvIsMemberOut,
                                        ErrorCluster *error);
  ...
  EXPORT void mdsplus_treenode_isNoWriteShot(const void *lvTreeNodePtr,
                                             ...
                                             ErrorCluster *error);
  EXPORT void mdsplus_treenode_isOn(const void *lvTreeNodePtr,
                                    LVBoolean *lvIsOnOut, ErrorCluster *error);
  EXPORT void mdsplus_treenode_isSetup(const void *lvTreeNodePtr,
                                       LVBoolean *lvIsSetupOut,
                                       ErrorCluster *error);
  EXPORT void mdsplus_treenode_isWriteOnce(const void *lvTreeNodePtr,
                                           LVBoolean *lvIsWriteOnceOut,
                                           ErrorCluster *error);
  EXPORT void mdsplus_treenode_makeSegment(const void *lvTreeNodePtr,
                                           ...
                                           const void *lvArrayPtrIn,
                                           ErrorCluster *error);
  EXPORT void mdsplus_treenode_makeTimestampedSegment(
      const void *lvTreeNodePtr, const void *lvArrayPtrIn,
      const LLngArrHdl lvLngArrHdlIn, ErrorCluster *error);
  EXPORT void mdsplus_treenode_move(const void *lvTreeNodePtr,
                                    const void *lvTreeNodePtrIn,
                                    ErrorCluster *error);
  EXPORT void mdsplus_treenode_move_newName(const void *lvTreeNodePtr,
                                            const void *lvTreeNodePtrIn,
                                            const char *newNameIn,
                                            ErrorCluster *error);
  EXPORT void mdsplus_treenode_putData(const void *lvTreeNodePtr,
                                       const void *lvDataPtrIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_treenode_putRow(const void *lvTreeNodePtr,
                                      const void *lvDataPtrIn, int64_t *timeIn,
                                      int sizeIn, ErrorCluster *error);
  EXPORT void mdsplus_treenode_putSegment(const void *lvTreeNodePtr,
                                          const void *lvArrayPtrIn, int ofsIn,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_putTimestampedSegment(
      const void *lvTreeNodePtr, const void *lvArrayPtrIn,
      const LLngArrHdl lvLngArrHdlIn, ErrorCluster *error);
  EXPORT void mdsplus_treenode_remove(const void *lvTreeNodePtr,
                                      const char *nameIn, ErrorCluster *error);
  EXPORT void mdsplus_treenode_removeTag(const void *lvTreeNodePtr,
                                         const char *tagNameIn,
                                         ErrorCluster *error);
  EXPORT void mdsplus_treenode_rename(const void *lvTreeNodePtr,
                                      const char *newNameIn, ErrorCluster *error);
  EXPORT void mdsplus_treenode_setCompressOnPut(const void *lvTreeNodePtr,
                                                LVBoolean *lvCompressOnPutIn,
                                                ErrorCluster *error);
  EXPORT void mdsplus_treenode_setEssential(const void *lvTreeNodePtr,
                                            LVBoolean *lvEssentialIn,
                                            ErrorCluster *error);
  ...
  EXPORT void mdsplus_treenode_setNoWriteShot(const void *lvTreeNodePtr,
                                              LVBoolean *lvNoWriteShotIn,
                                              ErrorCluster *error);
  EXPORT void mdsplus_treenode_setOn(const void *lvTreeNodePtr, LVBoolean *lvOnIn,
                                     ErrorCluster *error);
  EXPORT void mdsplus_treenode_setSubTree(const void *lvTreeNodePtr,
                                          LVBoolean *lvSubTreeIn,
                                          ErrorCluster *error);
  EXPORT void mdsplus_treenode_setTree(const void *lvTreeNodePtr,
                                       const void *lvTreePtrIn,
                                       ErrorCluster *error);
  EXPORT void mdsplus_treenode_setWriteOnce(const void *lvTreeNodePtr,
                                            LVBoolean *lvWriteOnceIn,
                                            ErrorCluster *error);
  ...
  /********** UINT16 **********/
  EXPORT void mdsplus_uint16_constructor(void **lvUint16PtrOut,
  ...
  EXPORT void mdsplus_uint16_getFloat(const void *lvUint16Ptr, float *floatOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_uint16_getInt(const void *lvUint16Ptr, int *intOut,
                                    ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint16array_constructor(void **lvUint16ArrayPtrOut,
                                              ...
                                              ErrorCluster *error);
  EXPORT void mdsplus_uint16array_constructor_dims(
      void **lvUint16ArrayPtrOut, const LUShtArrHdl lvUShtArrHdlIn,
      const LIntArrHdl lvIntArrHdlIn, ErrorCluster *error);
  EXPORT void mdsplus_uint16array_destructor(void **lvUint16ArrayPtr);

  /********** UINT32 **********/
  EXPORT void mdsplus_uint32_constructor(void **lvUint32PtrOut,
                                         unsigned int valIn, ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint32_getFloat(const void *lvUint32Ptr, float *floatOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_uint32_getInt(const void *lvUint32Ptr, int *intOut,
                                    ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint32array_constructor(void **lvUint32ArrayPtrOut,
                                              ...
                                              ErrorCluster *error);
  EXPORT void mdsplus_uint32array_constructor_dims(
      void **lvUint32ArrayPtrOut, const LUIntArrHdl lvUIntArrHdlIn,
      const LIntArrHdl lvIntArrHdlDimIn, ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint64_getByte(const void *lvUint64Ptr, char *byteOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_uint64_getDate(const void *lvUint64Ptr,
                                     LStrHandle lvStrHdlOut, ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint64_getFloat(const void *lvUint64Ptr, float *floatOut,
                                      ErrorCluster *error);
  EXPORT void mdsplus_uint64_getInt(const void *lvUint64Ptr, int *intOut,
                                    ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint64array_constructor(void **lvUint64ArrayPtrOut,
                                              ...
                                              ErrorCluster *error);
  EXPORT void mdsplus_uint64array_constructor_dims(
      void **lvUint64ArrayPtrOut, const LULngArrHdl lvULngArrHdlIn,
      const LIntArrHdl lvIntArrHdlIn, ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint8_getByte(const void *lvUint8Ptr, char *byteOut,
                                    ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint8_getFloat(const void *lvUint8Ptr, float *floatOut,
                                     ErrorCluster *error);
  EXPORT void mdsplus_uint8_getInt(const void *lvUint8Ptr, int *intOut,
                                   ErrorCluster *error);
  ...
  EXPORT void mdsplus_uint8array_constructor(void **lvUint8ArrayPtrOut,
                                             const LUByteArrHdl lvUByteArrHdlIn,
                                             ErrorCluster *error);
  EXPORT void mdsplus_uint8array_constructor_dims(
      void **lvUint8ArrayPtrOut, const LUByteArrHdl lvUByteArrHdlIn,
      const LIntArrHdl lvIntArrHdlIn, ErrorCluster *error);
  EXPORT void mdsplus_uint8array_deserialize(const void *lvUint8ArrayPtr,
                                             void **lvDataPtrOut,
                                             ErrorCluster *error);
