...
/********** SIGNAL **********/
DLLEXPORT void mdsplus_signal_constructor(void **lvSignalPtrOut, const void *lvDataPtrIn, const void *lvRawDataPtrIn, const void *lvDim0DataPtrIn, ErrorCluster *error);
...
DLLEXPORT void mdsplus_signal_getDim(const void *lvSignalPtr, void **lvDimPtrOut, ErrorCluster *error);
...
DLLEXPORT void mdsplus_signal_setDim(const void *lvSignalPtr, const void *lvDimPtrIn, ErrorCluster *error);
