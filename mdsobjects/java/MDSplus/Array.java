...
public abstract class Array extends Data
{
     ...
     * dimension of dims field. Otherwise it returns the reshaped array corresponding
     * to the passed dimension array. For example, if the array is bi-dimensional, a
	...
	int []rowDims = new int[dims.length];
	...
	{
	    int []newDims = new int[dims.length - getDims.length];
