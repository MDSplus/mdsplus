...
{
	public Aurora14Setup(Frame parent)
	{
		super(parent);
		...
		deviceChoice3.setChoiceFloatValues(new float[] {(float)1000000.0,(float)500000.0,(float)250000.0,(float)100000.0,(float)50000.0,(float)25000.0,(float)10000.0});
