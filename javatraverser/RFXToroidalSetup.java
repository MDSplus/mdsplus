...
public class RFXToroidalSetup extends DeviceSetup {
  ...
  private void jbInit() throws Exception {
    ...
    deviceChoice2.setLabelString("Tipo Prova CPU1:");
    deviceChoice2.setChoiceItems(new String[] {"AVANZATA", "CLASSICA", "CB PASSIVO", "TOKAMAK"});
    deviceChoice2.setUpdateIdentifier("");
    deviceChoice2.setIdentifier("");
    deviceChoice1.setChoiceIntValues(null);
    deviceChoice1.setChoiceFloatValues(null);
    deviceChoice1.setOffsetNid(6);
    deviceChoice1.setLabelString("Tipo Prova CPU2:");
    deviceChoice1.setChoiceItems(new String[] {"AVANZATA", "CLASSICA", "CB PASSIVO", "TOKAMAK"});
    deviceChoice1.setUpdateIdentifier("");
    deviceChoice1.setIdentifier("");
    deviceChoice4.setChoiceIntValues(null);
    deviceChoice4.setChoiceFloatValues(null);
    deviceChoice4.setOffsetNid(2);
    deviceChoice4.setLabelString("Regolazione CPU1:");
    deviceChoice4.setChoiceItems(new String[] {"CORRENTE", "TENSIONE", "CATENA APERTA"});
    deviceChoice4.setUpdateIdentifier("");
    deviceChoice4.setIdentifier("");
    deviceChoice3.setChoiceIntValues(null);
    deviceChoice3.setChoiceFloatValues(null);
    deviceChoice3.setOffsetNid(5);
    deviceChoice3.setLabelString("Regolazione CPU2:");
    deviceChoice3.setChoiceItems(new String[] {"CORRENTE", "TENSIONE", "CATENA APERTA"});
    deviceChoice3.setUpdateIdentifier("");
    deviceChoice3.setIdentifier("");
    deviceChoice6.setChoiceIntValues(null);
    deviceChoice6.setChoiceFloatValues(null);
    deviceChoice6.setOffsetNid(4);
    deviceChoice6.setLabelString("Selezione Banco CPU1:");
    ...
    deviceChoice5.setLabelString("Selezione Banco CPU2:");
    ...
    deviceTable5.setLabelString("Selezione banco condensatori CPU1");
    deviceTable5.setOffsetNid(12);
    deviceField3.setOffsetNid(10);
    deviceField3.setTextOnly(true);
    deviceField3.setLabelString("Commutatore CPU1: ");
    ...
    deviceTable6.setLabelString("Parametri letti CPU1");
    deviceTable6.setOffsetNid(14);
    jPanel12.setLayout(borderLayout6);
    deviceTable7.setOffsetNid(13);
    deviceTable7.setLabelString("Selezione banco condensatori CPU2");
    ...
    deviceField4.setLabelString("Commutatore CPU2: ");
    deviceField4.setTextOnly(true);
    deviceField4.setOffsetNid(11);
    deviceTable8.setOffsetNid(15);
    deviceTable8.setLabelString("Parametri letti CPU2");
