...
public class DeviceFieldCustomizer extends DeviceCustomizer implements Customizer
{
    ...
    public void setObject(Object o)
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            firePropertyChange("labelString", oldLabel, bean.getLabelString());
            ...
            firePropertyChange("numCols", oldCols, bean.getNumCols());
            ...
            firePropertyChange("textOnly", oldTextOnly, bean.getTextOnly());
            ...
            firePropertyChange("editable", oldEditable, bean.getEditable());
            ...
            firePropertyChange("showState", oldShowState, bean.getShowState());
            ...
            firePropertyChange("displayEvaluated", oldDisplayEvaluated, bean.getDisplayEvaluated());
            ...
            firePropertyChange("offsetNid", oldOffsetNid, bean.getOffsetNid());
            ...
            firePropertyChange("identifier", oldIdentifier, bean.getIdentifier());
