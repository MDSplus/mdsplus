...
public class RFXTimesSetup extends DeviceSetup {
  ...
  private void jbInit() throws Exception {
    ...
    deviceField11114.setLabelString("T_OPEN_PTSO_2");
    ...
    deviceField11115.setLabelString("T_OPEN_PTSO_1");
    ...
    jPanel9.add(jPanel22, BorderLayout.SOUTH);
    ...
    jPanel10.add(jPanel2, BorderLayout.CENTER);
    ...
    jPanel1.add(jPanel19,  BorderLayout.NORTH);
    jPanel19.add(deviceField1113, null);
    jPanel1.add(jPanel18,  BorderLayout.SOUTH);
    ...
    jPanel10.add(jPanel24,  BorderLayout.SOUTH);
