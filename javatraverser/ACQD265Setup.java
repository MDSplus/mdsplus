...
public class ACQD265Setup extends DeviceSetup
{
	public ACQD265Setup(Frame parent)
	{
 	  super(parent);
		...
		JLabel7.setToolTipText("Externa clock source reference (External clock source not implemented)");
		...
		JPanel10.setBounds(22,0,465,15);
